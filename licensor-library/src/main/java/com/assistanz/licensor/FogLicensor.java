...
public class FogLicensor implements Licensor {
    ...
    public FogLicensor(final String initialVersion, 
         ...
         String[] intialVersionSplit = initialVersion.split("-");
        
        key = buildKey(intialVersionSplit[0], requestID, licenseeEmail);
        try {
    ...
    private String decrypt(final String data) {
        ...
        try {
            ...
            byte[] original = cipher.doFinal(decoder.decodeBuffer(data));
    ...
    private String encrypt(final String data) {
        ...
        try {
            ...
            plainText = encoder.encode(result); //new Base64().encodeAsString(result);
