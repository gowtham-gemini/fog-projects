    ...
    'vpcTopology' : function() {  
        ...
        accountResourceLimitStore.query().then(function(data) {
            dojo.forEach(data, function(limitData) {                
                if(limitData.networkLimit !== "-1") {                  
                    if((limitData.networkUsed >= limitData.networkLimit)) {                       
                        dojo.query("#vpcInfoAddTierRachedLimitMsg").removeClass("hide_text", true); 
                        dojo.query("#vpnInfoAddWebTier").toggleClass("hide_text", true);    
                        dojo.query("#vpnInfoAddAppTier").toggleClass("hide_text", true);    
                        dojo.query("#vpnInfoAddDBTier").toggleClass("hide_text", true);                            
                    } else {
                        dojo.query("#vpcInfoAddTierRachedLimitMsg").toggleClass("hide_text", true);                         
                        dojo.query("#vpnInfoAddWebTier").removeClass("hide_text", true);
                        dojo.query("#vpnInfoAddAppTier").removeClass("hide_text", true);
                        dojo.query("#vpnInfoAddDBTier").removeClass("hide_text", true);                        
                    }
                } 
            });
        });
