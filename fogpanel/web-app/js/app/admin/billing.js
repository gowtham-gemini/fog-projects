        ...
        configRestStore.query().then(function (currencyResult) {
            histortGridLayout = [
                [
                    ...
                    {'name': translator.common.oldCost + " ("+ currencyResult[0].currency +")", 'field': 'oldCost', 'width': '100px', 'datatype':'string',  'autoComplete': 'true','formatter': function(data) {                         

                                        return  "<span class='greenColor'>" + data + "</span>";
                    }},
                    {'name': translator.common.newCost + " ("+ currencyResult[0].currency +")", 'field': 'newCost', 'width': '120px', 'datatype':'string',  'autoComplete': 'true','formatter': function(data) {                         
        ...
        configRestStore.query().then(function (currencyResult) {
            gridLayout = [
                [
                    ...
                    {'name': translator.common.amount + " ("+ currencyResult[0].currency +")", 'field': 'amount', 'width': '100px', 'datatype':'string',  'autoComplete': 'true'},
                    ...
                    {'name': translator.common.taxAmount + " ("+ currencyResult[0].currency +")", 'field': 'taxAmount', 'width': '100px', 'datatype':'string',  'autoComplete': 'true'},
                    {'name': translator.common.billing.grid.layout.totalAmount + " ("+ currencyResult[0].currency    +")", 'field': 'totalAmount', 'width': '100px', 'datatype':'string',  'autoComplete': 'true', 'formatter': function(data) {                         
   ...
   _customRestStore:"",
    ...
    configRestStore.query().then(function (currencyData) {
         customDataLayout = [[
            ...
            {'name': translator.common.amount + " ("+ currencyData[0].currency+")", 'field': 'amount', 'width': '200px', 'datatype':'string',  'autoComplete': 'true'},
            {'name': translator.common.taxAmount + " ("+ currencyData[0].currency +")", 'field': 'taxAmount', 'width': '100px', 'datatype':'string',  'autoComplete': 'true'},
            {'name': translator.common.billing.grid.layout.totalAmount + " ("+ currencyData[0].currency +")", 'field': 'totalAmount', 'width': '100%', 'datatype':'string',  'autoComplete': 'true', 'formatter': function(data) {                         
            ...
            dojo.forEach(data, function(account) {
                if(account.status.name == "ACTIVE" || account.status.name == "DISABLED" || account.status.name == "SUSPENDED") {
                    if(account.invoice == "yes") {
                        ...
                        opt.innerHTML = account.accountIdentifier;
        ...
        configRestStore.query().then(function (currencyResult) {            
            taxDataLayout = [
                [
                    ...
                    {'name': translator.common.billing.grid.layout.currentUsage + " ("+ currencyResult[0].currency +")", 'field': 'currentDue', 'width': '100px', 'datatype':'string',  'autoComplete': 'true'},
                    {'name': translator.common.billing.grid.layout.totalPayable + " ("+ currencyResult[0].currency +")", 'field': 'totalAmount', 'width': '100px', 'datatype':'string',  'autoComplete': 'true', 'formatter': function(data) {                         
    ...
    configRestStore.query().then(function (currencyResult) {
        paymentDataLayout = [
            [
                ...
                {'name': translator.common.amount + " ("+ currencyResult[0].currency +")", 'field': 'amount', 'width': '100px', 'datatype':'string',  'autoComplete': 'true'},
                {'name': translator.common.billing.grid.layout.processingFee + " ("+ currencyResult[0].currency +")", 'field': 'processingFee', 'width': '100px', 'datatype':'string',  'autoComplete': 'true'},
                {'name': translator.common.billing.grid.layout.totalAmount + " ("+ currencyResult[0].currency +")", 'field': 'totalAmount', 'width': '100px', 'datatype':'string',  'autoComplete': 'true', 'formatter': function(data) {                                                                      
                        return  "<span class='orangeColor'>" + data + "</span>";
                    }
                },
