...
ItemFileWriteStore, Memory, DataGrid, ContentPane, Source, MultiSelect, dom, win, localeCurrency) {
    ...
    },
    {
        ...
        "importData": action(function() {            
            ...
            if (dijit.byId("pullDomainButton")) {
                dijit.byId("pullDomainButton").destroyRecursive();
            }
            ...
            if (dijit.byId("pullStorageButton")) {
                dijit.byId("pullStorageButton").destroyRecursive();
            }
            if (dijit.byId("pullTemplateButton")) {
                dijit.byId("pullTemplateButton").destroyRecursive();
            }
            if (dijit.byId("pullVPCOfferingButton")) {
                dijit.byId("pullVPCOfferingButton").destroyRecursive();
            }

            if (dijit.byId("pullNetworkOfferingButton")) {
                dijit.byId("pullNetworkOfferingButton").destroyRecursive();
            }
            ...
            if (dijit.byId("pullVPCButton")) {
                dijit.byId("pullVPCButton").destroyRecursive();
            }
            ...
            if (dijit.byId("pullDomainConform")) {
                dijit.byId("pullDomainConform").destroyRecursive();
            }
            ...
            if (dijit.byId("pullStorageConfirm")) {
                dijit.byId("pullStorageConfirm").destroyRecursive();
            }
            if (dijit.byId("pullTemplateConfirm")) {
                dijit.byId("pullTemplateConfirm").destroyRecursive();
            }
            if (dijit.byId("pullVPCOfferingConfirm")) {
                dijit.byId("pullVPCOfferingConfirm").destroyRecursive();
            }
            if (dijit.byId("pullVPCConform")) {
                dijit.byId("pullVPCConform").destroyRecursive();
            }
            if (dijit.byId("pullNetworkOfferingConfirm")) {
                dijit.byId("pullNetworkOfferingConfirm").destroyRecursive();
            }
            if (dijit.byId("pullNetworkConfirm")) {
                dijit.byId("pullNetworkConfirm").destroyRecursive();
            }
            if (dijit.byId("pullVPCConform")) {
                dijit.byId("pullVPCConform").destroyRecursive();
            }
            ...
            core.ui.loadTemplate("importDataFromCloudstackPage", core.ui.getContentId());
            CloudstackConfig.testInResourcesImportPage();
        })
    });
});
var CloudstackConfig = {
    'testInResourcesImportPage' : function() {
        ...
        var cloudStackConfigCheck = new JsonRest({
            target: core.getContextPath() + "/api/config/isCloudStackConfigured"
        });
        ...
        cloudStackConfigCheck.query().then(function(data) {
            
            if(data === false) {
                dojo.byId("openStackNotConfiguredMsgImport").style.display = "block";
                dojo.byId("importDataFromCloudstack").style.display = "none";
            } else{
                dojo.byId("openStackNotConfiguredMsgImport").style.display = "none";
                dojo.byId("importDataFromCloudstack").style.display = "block";
            }
        });
    }        
};
        ...
        configRestStore.query().then(function (currencyResult) {
            gridLayout = [
                [
                    ...
                    {'name': translator.common.procFeeAmount+ " ("+ currencyResult[0].currency +")", 'field': 'procFeeAmount', 'width': '100%', datatype: "number", autoComplete: true}
                ]
            ];
        });
