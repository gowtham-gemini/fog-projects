...
//                      alert(this.getValue())
          ...
          showOnlyRunningCost : function () {
              this.instanceRunningCostPerHour.setAttribute("style", 'display: none');
              this.instanceStopageCostContainer.setAttribute("style", 'display: none');
              this.instanceStopageCostPerHour.setAttribute("style", 'display: none');
              this.setupCostContainer.setAttribute("style", 'display: none');              
          },
