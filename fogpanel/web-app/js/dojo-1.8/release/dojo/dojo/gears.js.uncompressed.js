...
//>>built
define("dojo/gears",["./_base/lang","./sniff"],function(c,d){var b={};c.setObject("dojo.gears",b);b._gearsObject=function(){var a,b=c.getObject("google.gears");if(b)return b;if("undefined"!=typeof GearsFactory)a=new GearsFactory;else if(d("ie"))try{a=new ActiveXObject("Gears.Factory")}catch(e){}else if(navigator.mimeTypes["application/x-googlegears"])a=document.createElement("object"),a.setAttribute("type","application/x-googlegears"),a.setAttribute("width",0),a.setAttribute("height",0),a.style.display=
