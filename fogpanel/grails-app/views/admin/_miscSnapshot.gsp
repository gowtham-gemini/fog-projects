...
<div class="row-fluid">
  ...
  <div class="row-fluid" id="snapUpdateActionButton">
      ...
      <div class="span4">
          <div class="offset1">
            <button type="button" id="miscSnapButton" class="defaultbtn" data-dojo-type="dijit.form.Button" onclick="MiscSnapshotInfo.updateShow()"><g:message code="default.button.update.common" /></button>
    ...
    <div class="row-fluid">
      ...
      <div class="alert alert-info hide" id="noMiscSnapshotMessageBox" style="display: none">
            ...
            <g:message code="common.noSnapshotInfo" />
          </div>
    </div> 
</form>  
</div>
