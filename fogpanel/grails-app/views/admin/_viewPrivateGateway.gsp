<div class="row-fluid">
    <div class="span12 breadcrumbs">
      <ul>
        <li><a href="#/admin/vpc/dashboard"><i class="icon-home"></i></a></li> 
        <li>/</li>
        <li><a href="#/admin/vpc/list"><g:message code="common.vpc"/></a></li>
        <li>/</li>
        <li><a id="currentVpcNameLink" href=""><span id="currentVpcName"></span></a></li>
        <li>/</li>
        <li><a id="currentVpcPrivateGatewayLink" onclick="AdminVPCPrivateGateway.showPrivateGatweayTab()"><g:message code="common.privateGateway"/></a></li> 
        <li>/</li>
...
<!--                    <div class="row-fluid header">
        ...
        <div data-dojo-type="dijit/layout/ContentPane" title="<g:message code="common.staticRoute"/>" onshow="AdminVPCPrivateGateway.populateStaticRoutList()" selected="true" id="">
            <div class="row-fluid">
                <div class="row-fluid header">
                     <!--<h3><g:message code="common.technicalInfo"/></h3>   <div class="span2 value_dollar pull-right"><g:message code="default.valueIn"/>  <span id="currencyValue"></span></div>-->
                </div>
                ...
                <form id="staticRouteAddForm" data-dojo-type="dijit.form.Form" accept-charset="" class="form-horizontal">	
                    <div id="staticRouteAddFormAddPage">           
                        <div class="span12">
                            ...
                            <div class="span3">
                                 <button type="button" data-dojo-type="dijit.form.Button" id="" class="defaultbtn overflowLabel" onclick="AdminVPCPrivateGateway.addStaticRoute()" id=""><g:message code="common.add"/></button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="row-fluid" id="">
                ...
                <div class="alert alert-info hide" id="noStaticRouteMessageBox" style="display: none">
                  ...
                  <g:message code="common.user.noAdminStaticRoute"/>
                </div>
            </div> 
        </div>
    </div>
...
<div data-dojo-type="dijit.Dialog" id="deleteStaticRouteDialog"  class="span4">
    ...
    <div class="row-fluid">
        <button  type="button" class="primarybtn" data-dojo-type="dijit.form.Button" onclick="AdminVPCPrivateGateway.deleteStaticRoute()"><g:message code="common.ok"/></button>
        <button  type="button" class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="AdminVPCPrivateGateway.closeDeleteStaticRoute()"><g:message code="common.cancel"/></button>
    </div>
</div>