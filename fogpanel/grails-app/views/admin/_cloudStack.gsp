<div class="row-fluid">
    <div class="span12 breadcrumbs">
        <ul>
            ...
            <li>/<li>
            <li><g:message code="menu.admin.configuration.cloudStack"/></li>
        </ul>
    </div>
</div>
<div class="row-fluid">
...
<div class="row-fluid form-wrapper"> 
    <ul class="span12 configList">
        <li>
            <a class="item" href="#/admin/dashboard/cloudConfig">
                <i class="icon-envelope-alt"></i>
                <g:message code="common.systemConfig"/>
            </a>
            <a class="time" href="#/admin/dashboard/cloudConfig">
                <i class="icon-cog"></i>
            </a>
        ...
        <li>
            <a class="item" href="#/admin/zone">
                <i class="icon-group"></i>
                <g:message code="common.zoneDesc"/>
            </a>
            <a class="time" href="#/admin/zone">
                <i class="icon-cog"></i>
            </a>
        </li>
        <li>
        ...
        <li>
            <a class="item" href="#/admin/settings/importData">
                <i class="icon-envelope-alt"></i>
                <g:message code="common.importDataFromCloudstack" />
            </a>
