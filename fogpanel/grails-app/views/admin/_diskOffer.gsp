            ...
            <div class="row-fluid" id="diskOfferContent">
                <form id="diskOfferContentForm" data-dojo-type="dijit.form.Form" class="form-horizontal"> 
                    ...
                    <div class="row-fluid" id="secondRowWidgets">    
                        <div class="control-group span3 horizontalcontent" id="diskSizeHide">
                        ...
                        <div class="control-group span3 horizontalcontent diskCustomSize">
                        ...
                        <div class="control-group span3 customDisk" id="diskDomainDiv" style="display: none">
