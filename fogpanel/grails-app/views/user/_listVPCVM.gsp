...
<div class="row-fluid filter-block">
    <div class="row-fluid">
        <div class="alert alert-danger" style="display: none;" id="vpcvmListRachedLimitMsg"><i class="icon-exclamation-sign"></i><g:message code="common.reachedLimit"/></div> 
    </div>
    <div class="pull-right" id="vmListActionButtonCollection">
        ...
        <a class="btn-flat success new-product" id="vpcVMListAddButton" onclick="ListAllVPCVMInfo.showLaunchVMDialog()"><g:message code="user.cloud.launchVM"/></a>         
    </div>
