...
<div class="row-fluid filter-block">
    <div class="row-fluid">
        <div class="alert alert-danger" style="display: none;" id="nwInfoIPLimitReachedMsg"><i class="icon-exclamation-sign"></i><g:message code="common.reachedLimit"/></div> 
    </div>
    <div class="pull-right" id="nwInfoIPAddButton">
        <button data-dojo-type="dijit.form.Button" onclick="ViewNetworkIP.acquireIPShow()" class="okbtn">
