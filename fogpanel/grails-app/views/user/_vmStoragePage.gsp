...
<div class="row-fluid">
    <div class="span6">
        <div class="alert alert-danger errorMessage overflowLabel" id="vmDetailDiskLimitReached" style="display: none">        
            <i class="icon-exclamation-sign"></i><g:message code="common.reachedLimit"/>
        </div> 
    </div>
    <div class="span6">
        <div class="span12">
