...
<div class="row-fluid">
    <div data-dojo-type="dijit/layout/TabContainer" id="ipVpcTabCointainer" class="span12" style="overflow: visible;" tabStrip="true">
        <div data-dojo-type="dijit/layout/ContentPane" onshow="ViewVpc.vpcTopology()" title="<g:message code="common.configure"/>" selected="true" id="vpcDetailContainer">
            <div class="row-fluid">
                <div class="alert alert-danger hide_text" id="vpcInfoAddTierRachedLimitMsg"><i class="icon-exclamation-sign"></i><g:message code="common.reachedNetworkLimit"/></div> 
            </div>
            <div class="row-fluid">
                        ...
                        <div class="web-app-db-cont span12">
                            <div class="web-tier-cont span4">
                                ...
                                <h2 class="webtier-title">
                                     ...
                                     <a onclick="ViewVpc.addTierShow()" id="vpnInfoAddWebTier" title="<g:message code="common.addTier"/>" style="color: #FFFFFF; float: right; margin-right: 14px; text-decoration: none">+</a>                                     
                                </h2>
                            ...
                            <div class="app-tier-cont span4">                                
                                <h2 class="apptier-title">
                                     ...
                                     <a onclick="ViewVpc.addTierShow()" id="vpnInfoAddAppTier"  title="<g:message code="common.addTier"/>" style="color: #FFFFFF; float: right; margin-right: 14px; text-decoration: none">+</a>  
                                </h2>
                            ...
                            <div class="db-tier-cont span4">
                                <h2 class="dbtier-title">
                                     ...
                                     <a onclick="ViewVpc.addTierShow()" id="vpnInfoAddDBTier" title="<g:message code="common.addTier"/>" style="color: #FFFFFF; float: right; margin-right: 14px; text-decoration: none">+</a>  
                                </h2>
