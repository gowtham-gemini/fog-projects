...
<div data-dojo-type="dijit.Dialog" class="full_loader" id="ipLoader" class="span6">
    ...
    <div class="row-fluid">
        ...
        <div data-dojo-type="dijit.Dialog" id="acquireIpDialog" title="<g:message code='common.acquireNewIP' />" class="span4">
            <div class="row-fluid">
                <div class="alert alert-danger" style="display: none;" id="vmInfoAddIPLimitMsg"><i class="icon-exclamation-sign"></i><g:message code="common.reachedLimit"/></div> 
            </div>
            <div class="row-fluid">                
                ...
                <div class="row-fluid" id="vmInfoAddIPActionContainer">
                <div class="span8">               
