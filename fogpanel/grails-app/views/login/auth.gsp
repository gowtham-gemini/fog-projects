    ...
    <div style="float: right; display: none;">
      ...
      <div class="box span4">
        <div class="content-wrap">
          <form action='${postUrl}' method='POST' onsubmit="AccountLogin.csRequest(); return false" id='loginForm' class='' autocomplete='off'>
...
<!--                   		<input  type='checkbox' name='${rememberMeParameter}' id='remember_me'  <g:if test='${hasCookie}'>checked='checked'</g:if>/>
              ...
              <div class="span12"><input type='submit' id="submitBtn" value='<g:message code="common.login"/>' class="btn-flat primary login"/></div>
                <!---->
