...
import com.assistanz.fogpanel.DomainService
...
class BootStrap { 
    ...
    def init = { servletContext ->
         Domain domain;
        if(!Domain.findByReferenceId("dummy")) {
            
            domain = new Domain()       
            domain.hasChild = false
            domain.level = 1000
            domain.referenceId = "dummy"
            domain.name = "dummy"
            domain.parentDomainId = "dummy"
            domain.networkDomain = "dummy"
            domain.parentDomainName = "dummy"
            domain.path = "dummy"
        ...
        if (admin && admin.password == "passw0rd") {
            ...
            admin.email = "admin@fogpanel.com"
            admin.save();
