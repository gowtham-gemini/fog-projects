...
//        Date createdDate
	...
	static constraints = {
		...
		accountIdentifier (nullable: false, blank: false, unique: 'domain')
		...
		billingCountry (maxSize: 100, nullable: false, blank: false)
                ...
                isCompleted(nullable: true, blank: true)
...
//                createdDate nullable:true,display:false,editable:false
            ...
            static hasMany = [invoices: Invoice, offeringUsages: OfferingUsage, discounts: Discount, sshKeys: SSHKeys, users:User]
