...
class FogPanelSpringSecurityOAuthServiceSpec extends Specification {
  
    FogPanelSpringSecurityOAuthService service
    
    def oauthService
    
    def setup() {
        service = new FogPanelSpringSecurityOAuthService()
        oauthService = [:]
    }
    ...
    def "should throw OAuthLoginException for unexpected response"() {
        given:
            ...
            oauthService.getFogPanelResource = { accessToken, url ->
                return response
            }
...
"name":"My Name","first_name":"My","last_name":"Name","link":"http:\\/\\/www.fogpanel.com\\/my.name","username":"my.name","birthday":"01\\/12\\/1972",
