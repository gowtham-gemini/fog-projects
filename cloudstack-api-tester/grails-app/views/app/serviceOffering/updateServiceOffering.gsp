...
<html>
    <head>
        ...
        <title>updateServiceOffering</title> 
<!--        <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js">
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                <h4>updateServiceOffering</h4>
            </div>
            <div class="row col-xs-12 col-md-8">
                <g:formRemote name="subForm" class="form-horizontal" url="[controller:'App', action:'updateOffering']" update="root">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="response">Response:</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="19" id="root" disabled="true"> </textarea>
                            </div>
                     </div>
                </div>
            </div>
