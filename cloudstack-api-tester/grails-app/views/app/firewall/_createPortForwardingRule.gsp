    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td>9</td>
                <td>privateendport</td>
                <td>Optional</td>
                <td><input class="send" type="checkbox" id="cpunumberc"  value="cpunumber" 
                    onclick="performChange(this);"></td><td><input type="text" id="textt" 
                    name="privateendport" disabled="true" required="" class="form-control"  ></td>
                <td>8080</td>
            </tr>
            <tr>
                <td>10</td>
                ...
                <td><input class="send" type="checkbox" id="cpunumberc"  value="cpunumber" 
                    onclick="performChange(this);"></td><td><input type="text" id="textt" 
                    name="publicendport" disabled="true" required="" class="form-control"  ></td>
                <td>8080</td>
            </tr>
            <tr>
                <td>11</td>
                ...
                <td><input class="send" type="checkbox" id="cpunumberc"  value="cpunumber" 
                    onclick="performChange(this);"></td><td><input type="text" id="textt" 
                    name="vmguestip" disabled="true" required="" class="form-control"  ></td>
                <td>192.168.1.1</td>
            </tr>
        </tbody>
    </table>
