        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)" ></td><td><input type="text" id="textt" 
                    name="scheme" disabled="true" required="" class="form-control"></td>
                <td>internal</td>
            </tr>
            <tr>
                <td>13</td>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)" ></td><td><input type="text" id="textt" 
                    name="sourceipaddressnetworkid" disabled="true" required="" class="form-control"></td>
