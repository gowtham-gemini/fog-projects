    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)" checked="true"></td><td><input type="text" id="textt" 
                    name="pingdir" required="" class="form-control"></td>
                <td>root directory</td>
            </tr>
            <tr>
                <td>4</td>
                <td>pingstorageserver ip</td>
                <td>Required</td>
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)" checked="true"></td><td><input type="text" id="textt" 
                    name="pingstorageserverip" required="" class="form-control"></td>
                <td>192.168.1.1</td>
            </tr>
            <tr>
                <td>5</td>
            ...
            <tr>
                <td>7</td>
                <td>pingcifs password</td>
                <td>Optional</td>
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)"></td><td><input type="password" id="textt" 
                    name="pingcifspassword" disabled="true" required="" class="form-control"></td>
                <td>Password of PING storage server</td>
            </tr>
            <tr>
                <td>8</td>
                <td>pingcifs username</td>
                <td>Optional</td>
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)"></td><td><input type="password" id="textt" 
                    name="pingcifsusername" disabled="true" required="" class="form-control"></td>
                <td>Username of PING storage server</td>
            </tr>
            <tr>
                <td>7</td>
                <td>pod id</td>
