<!--    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="displaytextc"  value="displaytext" 
                    onclick="performChange(this)" ></td><td><input type="text" id="textt" 
                    name="acltype" disabled="true" required="" class="form-control"></td>
                <td>{account,domain}</td>
            </tr>
            <tr>
                <td>3</td>
                <td>canusefordeploy</td>
                <td>Optional</td>
                <td><input class="send" type="checkbox" id="displaytextc"  value="displaytext" 
                    onclick="performChange(this)" ></td><td><input type="text" id="textt" 
                    name="canusefordeploy" disabled="true" required="" class="form-control"></td>
                <td>{true,false}</td>
            </tr>
            <tr>
                <td>4</td>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="displaytextc"  value="displaytext" 
                    onclick="performChange(this)" ></td><td><input type="text" id="textt" 
                    name="forvpc" disabled="true" required="" class="form-control"></td>
                <td>{true,false}</td>
            </tr>
            <tr>
                <td>6</td>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="displaytextc"  value="displaytext" 
                    onclick="performChange(this)" ></td><td><input type="text" id="textt" 
                    name="networktype" disabled="true" required="" class="form-control"></td>
                <td>{isolated,shared}</td>
            </tr>
            <tr>
                <td>20</td>
                <td>vpcid</td>
