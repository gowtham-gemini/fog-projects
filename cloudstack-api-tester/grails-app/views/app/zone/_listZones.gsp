        ...
        <tbody>
            <tr>
                ...
                <td><input class="send" type="checkbox" id="cpunumberc"  value="cpunumber" 
                    ...
                    name="available" disabled="true" required="" class="form-control"  ></td>
                <td>{true,false}</td>
            </tr>
            <tr>
                <td>2</td>
            ...
            <tr>
                ...
                <td>the network type of the zone</td>
            </tr>
            <tr>
                <td>7</td>
                <td>page</td>
            ...
            <tr>
                <td>9</td>
                <td>show capacities</td>
                <td>Optional</td>
                <td><input class="send" type="checkbox" id="cpunumberc"  value="cpunumber" 
                    onclick="performChange(this);" ></td><td><input type="text" id="textt" 
                    name="showcapacities" disabled="true" required="" class="form-control"  ></td>
                <td>flag to show the 
                    capacity of the zone </td>
            </tr>
        </tbody>
    </table>
