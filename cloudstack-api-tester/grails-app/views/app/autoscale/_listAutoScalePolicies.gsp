    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>the action to be executed </td>
            </tr>
            <tr>
                <td>3</td>
                <td>condition id</td>
                ...
                <td><input class="send" type="checkbox" id="cpunumberc"  value="cpunumber" 
                    onclick="performChange(this);" ></td><td><input type="text" id="textt" 
                    name="conditionid" disabled="true" required="" class="form-control"  ></td>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="cpunumberc"  value="cpunumber" 
                    onclick="performChange(this);" ></td><td><input type="text" id="textt" 
                    name="vmgroupid" disabled="true" required="" class="form-control"  ></td>
                <td>49b00016-7748-463f-88f0-a3e7ca8fc21f</td>
            </tr>
        </tbody>
    </table>
