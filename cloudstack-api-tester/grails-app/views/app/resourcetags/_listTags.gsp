    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)"></td><td><input type="text" id="textt" 
                    name="customer" disabled="true" required="" class="form-control"></td>
                <td>list by customer name</td>
            </tr>
            <tr>
                <td>3</td>
                <td>domainid</td>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)"></td><td><input type="text" id="textt" 
                    name="resourceid" disabled="true" required="" class="form-control"></td>
                <td>cb3d4d7d-85ab-4d1c-9540-0660be9fc8b8</td>
            </tr>
            <tr>
                <td>12</td>
            ...
            <tr>
                ...
                <td><input class="send" type="checkbox" id="memoryc"  value="memory" 
                    onclick="performChange(this)"></td><td><input type="text" id="textt" 
                    name="value" disabled="true" required="" class="form-control"></td>
                <td>list by value</td>
            </tr>
        </tbody>
    </table>
