    ...
    <body>
        ...
        <div class="stack stack-container">
            <div class="container">
                ...
                <div class="row-fluid">
                    <g:form class="form-horizontal" action="changeCurrentUserPassword" controller= "user">
                        <div class="form-group">
                            <label for="oldPassword" class="control-label col-md-2">Current Password</label>
                            <div class="col-md-3">
                                <input type="password" required class="form-control" id="oldPassword"  placeholder="Current Password" name="oldPassword">
                            </div>
                        </div>
                        <div class="form-group">
