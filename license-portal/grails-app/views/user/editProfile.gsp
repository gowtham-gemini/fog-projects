<html>
    ...
    <body>
        <div class="stack stack-section-title">
            <div class="container">
                <h1 id="page-title"><g:message code="user.edit.header"/></h1>
            </div>
        </div>
        <g:if test="${message}">
        ...
        <div class="stack stack-container">
            <div class="container">
                <div class="col col-md-8">
                    <g:form class="form-horizontal" url="[action:'updateProfileUser',controller:'User']">
                        ...
                        <div class="form-group">
                            <label for="address2" class="control-label col-md-4"><g:message code="user.address2.label"/></label>
                            <div class="col-md-8">
