...
class HostResponse {
     ...
     */
    private String hostNetworKbsRead;

    /**
     * the outgoing network traffic on the host
     */
    private String hostNetworKbsWrite;	
    ...
    public String getHostNetworKbsRead() {
        return hostNetworKbsRead;
    }

    public void setHostNetworKbsRead(String hostNetworKbsRead) {
        this.hostNetworKbsRead = hostNetworKbsRead;
    }

    public String getHostNetworKbsWrite() {
        return hostNetworKbsWrite;
    }

    public void setHostNetworKbsWrite(String hostNetworKbsWrite) {
        this.hostNetworKbsWrite = hostNetworKbsWrite;
    }
