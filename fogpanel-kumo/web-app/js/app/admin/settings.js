...
var InvoiceInfo = {
    ...
    populateValues: function() {
        ...
        var ivaPercentage = dijit.byId("ivaPercentage");
        var retentionPercentage = dijit.byId("retentionPercentage");
        ...
        this._configRestStore.query().then(function(resultData) {
            dojo.forEach(resultData, function(config) {
                ...
                } else if (config.name === "invoice.iva.percentage") {
                    ivaPercentage.setValue(config.value);
//                     paymentDueDaysDescription.innerHTML = config.description;
                } else if (config.name === "invoice.retention.percentage") {
                    retentionPercentage.setValue(config.value);
//                     paymentDueDaysDescription.innerHTML = config.description;
                }
            });
        });
    ...
    add: function() {
        ...
        this._billingConfigStore.add({
            ...
            retentionPercentage: retentionPercentage.value
        }).then(function(resultData) {
