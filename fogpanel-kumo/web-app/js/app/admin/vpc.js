        ...
        var dataLayout = [[
                ...
                {'name': translator.common.action, 'field': 'action', 'formatter': function(data) {
                        var vpnStatus = new FogPanel.VPNStatus({                           
                           onConfigVPN : function () {AdminVPCPrivateGateway.replaceACLTierShow(data.referenceId, data.aclId);},
    ...
    populateValues : function () {
        ...
        var vpnLayout = [
            [
                ...
                {'name': translator.common.user, 'field': 'user', 'width': '200px', 'datatype':'string',  'autoComplete': 'true'},
                {'name': translator.common.zone, 'field': 'zone', 'width': '200px', 'datatype':'string',  'autoComplete': 'true'},
