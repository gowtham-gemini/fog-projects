...
require([
    ...
    "dijit/Dialog"
        ...
        function(dojo, i18n, translator, dijit, domClass, domConstruct, JsonRest, query, registry, FilteringSelect, Select, ItemFileWriteStore, DataGrid, ContentPane, Source, MultiSelect, dom, win) {
    ...
    populateValues: function() {
        ...
        var dataLayout = [
            [
                ...
                {'name': translator.common.cost, 'field': 'cost', 'width': '100%'},
...
//        zoneWidget.startup();
        ...
        var dataLayout = [
            [ 
                ...
                {'name': translator.common.cost, 'field': 'cost', 'width': '50px', datatype: "string", autoComplete: true, 'formatter': function(data) {
