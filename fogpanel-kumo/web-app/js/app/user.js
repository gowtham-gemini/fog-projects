        ...
        resourceCountRestStore.query({zoneReferenceId: dojo.byId("selectedANZoneID").value !== "All" ? dojo.byId("selectedANZoneID").value : null }).then(function(data) {
            dojo.forEach(data, function(zoneData) { 
                ...
                if(dojo.byId("selectedANZoneID").value !== "All" && dojo.byId("selectedANZoneID").value !== null && dojo.byId("selectedANZoneID").value !== "") {
                    ...
                    zoneNode.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-vm_icon" ></i>'+zoneData.totalRunningVm+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalRunningVmCost.toFixed(2))+" "+currency+'</div>';
                    dojo.byId("vmStatsBox").appendChild(zoneNode); 
                    
                    var zoneStotage = document.createElement('div');   
                    zoneStotage.className = 'zone-1';
                    zoneStotage.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-storage_icon" ></i>'+zoneData.totalStorage+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalVolumeCost.toFixed(2))+" "+currency+'</div>';
                    dojo.byId("storageStatsBox").appendChild(zoneStotage); 
                    
                    var zoneSnap = document.createElement('div');   
                    zoneSnap.className = 'zone-1';
                    zoneSnap.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-snapshot_icon" ></i>'+zoneData.totalSnapshot+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalSnapCost.toFixed(2))+" "+currency+'</div>';
                    dojo.byId("snapshotStatsBox").appendChild(zoneSnap); 
                    
                    var zoneNetwork = document.createElement('div');   
                    zoneNetwork.className = 'zone-1';
                    zoneNetwork.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneData.totalNetwork+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalNetworkCost.toFixed(2))+" "+currency+'</div>';
                    ...
                    zoneBandWidth.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneData.totalBandwidth + ' ' + translator.common.gb +'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalBandwidthCost.toFixed(2))+" "+currency+'</div>';
                    ...
                    VPCNodeBandwidth.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-vpc_icon" ></i>'+zoneData.totalVpc+'</div><div class="zone-pricing">'+LocaleNumber.format(0.00)+" "+currency+'</div>';
...
//                    });
                    ...
                    dojo.forEach(zoneData.zoneCount, function(zoneItemData) { 
                        ...
                        zoneNode.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-vm_icon" ></i>'+zoneItemData.runningVm+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.runningVmCost.toFixed(2))+" "+currency+'</div>';
                        dojo.byId("vmStatsBox").appendChild(zoneNode); 
                        
                        var zoneNodeSorage = document.createElement('div');      
                        zoneNodeSorage.className = 'zone-'+count;
                        zoneNodeSorage.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-storage_icon" ></i>'+zoneItemData.storage+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.volumeCost.toFixed(2))+" "+currency+'</div>';
                        ...
                        zoneNodeSnap.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-snapshot_icon" ></i>'+zoneItemData.snapshot+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.snapCost.toFixed(2))+" "+currency+'</div>';
                        dojo.byId("snapshotStatsBox").appendChild(zoneNodeSnap);
                                 
                         var zoneNodeNetwork = document.createElement('div');      
                        zoneNodeNetwork.className = 'zone-'+count;
                        zoneNodeNetwork.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneItemData.network+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.networkCost.toFixed(2))+" "+currency+'</div>';
                        dojo.byId("networkStatsBox").appendChild(zoneNodeNetwork);
                        
                        
                        var zoneNodeBandwidth = document.createElement('div');      
                        zoneNodeBandwidth.className = 'zone-'+count;
                        zoneNodeBandwidth.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneItemData.bandwidth + ' ' + translator.common.gb +'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.bandwidthCost.toFixed(2))+" "+currency+'</div>';
                        dojo.byId("bandwidthStatsBox").appendChild(zoneNodeBandwidth);
                        
                        var VPCNodeBandwidth = document.createElement('div');      
                        VPCNodeBandwidth.className = 'zone-'+count;
                        VPCNodeBandwidth.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-vpc_icon" ></i>'+zoneItemData.vpc+'</div><div class="zone-pricing">'+LocaleNumber.format(0.00)+" "+currency+'</div>';
                        dojo.byId("VPCStatsBox").appendChild(VPCNodeBandwidth);
                    ...
                    var zoneNode = document.createElement('div');   
                    zoneNode.className = 'zone-'+count;
                    zoneNode.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-vm_icon" ></i>'+zoneData.totalRunningVm+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalRunningVmCost.toFixed(2))+" "+currency+'</div>';
                    dojo.byId("vmStatsBox").appendChild(zoneNode); 
                    
                    var zoneStotage = document.createElement('div');   
                    zoneStotage.className = 'zone-'+count;
                    zoneStotage.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-storage_icon" ></i>'+zoneData.totalStorage+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalVolumeCost.toFixed(2))+" "+currency+'</div>';
                    dojo.byId("storageStatsBox").appendChild(zoneStotage); 
                    
                    var zoneSnap = document.createElement('div');   
                    zoneSnap.className = 'zone-'+count;
                    zoneSnap.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-snapshot_icon" ></i>'+zoneData.totalSnapshot+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalSnapCost.toFixed(2))+" "+currency+'</div>';
                    dojo.byId("snapshotStatsBox").appendChild(zoneSnap); 
                    
                    var zoneNetwork = document.createElement('div');   
                    zoneNetwork.className = 'zone-'+count;
                    zoneNetwork.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneData.totalNetwork+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalNetworkCost.toFixed(2))+" "+currency+'</div>';
                    dojo.byId("networkStatsBox").appendChild(zoneNetwork); 
                    
                    var zoneBandwidth = document.createElement('div');   
                    zoneBandwidth.className = 'zone-'+count;
                    zoneBandwidth.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneData.totalBandwidth + ' ' + translator.common.gb + '</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalBandwidthCost.toFixed(2))+" "+currency+'</div>';
                    dojo.byId("bandwidthStatsBox").appendChild(zoneBandwidth);
                    
                    var VPCNodeBandwidth = document.createElement('div');   
                    VPCNodeBandwidth.className = 'zone-'+count;
                    VPCNodeBandwidth.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-vpc_icon" ></i>'+zoneData.totalVpc+ '</div><div class="zone-pricing">'+LocaleNumber.format(0.00)+" "+currency+'</div>';
                    dojo.byId("VPCStatsBox").appendChild(VPCNodeBandwidth);
...
//                    });
                    ...
                    dojo.forEach(zoneData.zoneCount, function(zoneItemData) { 
                        ...
                        var VPCNodeBandwidth = document.createElement('div');   
                        VPCNodeBandwidth.className = 'zone-'+count;
                        VPCNodeBandwidth.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-vpc_icon" ></i>'+zoneItemData.vpc+ '</div><div class="zone-pricing">'+LocaleNumber.format(0.00)+" "+currency+'</div>';
                        dojo.byId("VPCStatsBox").appendChild(VPCNodeBandwidth);
...
//                ]
        ...
        zoneListStore.query().then(function(data) {                 
            ...
            if(currentUrl ===  "#/user/vpc" || currentUrl === "#/user/vpc/help" || currentUrl === "#/user/vpc/topology" || currentUrl ===  "#/user/vpc/vpcContainer" || currentUrl === "#/user/vpc/list" || currentUrl ===  "#/user/vpc/vpcContainer" || currentUrl ===  "#/user/tier/list" || currentUrl ===  "#/user/tier/instance" || currentUrl ===  "#/user/tier/publicLB" ||currentUrl  ===   "#/user/tier/internalLB" ||
                    ...
                    (urlList[2] === "vpcSecurity" && urlList[3] === "view" && urlList[4]) || (urlList[3] === "viewVPCPrivateGateway" && urlList[4]) || (urlList[3] === "vmDetail" && vmInfo[0] && vmInfo[1] === "tier")) {
