...
//>>built
define("dojo/rpc/RpcService","../_base/array,../_base/declare,../_base/Deferred,../_base/kernel,../_base/lang,../_base/url,../_base/xhr".split(","),function(f,g,h,i,d,e,j){return g("dojo.rpc.RpcService",null,{constructor:function(a){if(a)if(d.isString(a)||a instanceof e){var b=j.get({url:a instanceof e?a+"":a,handleAs:"json-comment-optional",sync:!0});b.addCallback(this,"processSmd");b.addErrback(function(){throw Error("Unable to load SMD from "+a);})}else if(a.smdStr)this.processSmd(i.eval("("+a.smdStr+
")"));else{if(a.serviceUrl)this.serviceUrl=a.serviceUrl;this.timeout=a.timeout||3E3;if("strictArgChecks"in a)this.strictArgChecks=a.strictArgChecks;this.processSmd(a)}},strictArgChecks:!0,serviceUrl:"",parseResults:function(a){return a},errorCallback:function(a){return function(b){a.errback(b.message)}},resultCallback:function(a){return d.hitch(this,function(b){if(null!=b.error){var c;"object"==typeof b.error?(c=Error(b.error.message),c.code=b.error.code,c.error=b.error.error):c=Error(b.error);c.id=
