...
//                optional.put("virtualmachineid", requestData.virtualMachineReferenceId);
    ...
    def create(String requestBody) {
        try {
            ...
            optional.put("zoneid",  new String(diskOffer.zone.referenceZoneId));
            ...
            Volume.withTransaction {
                ...
                newVolume.zone = Zone.findByReferenceZoneId(diskOffer.zone.referenceZoneId);
...
//                newVolume.createdDate = Calendar.getInstance().getTime()
                ...
                Console.print("newVolume.customDiskSize" + newVolume.customDiskSize)
                ...
                if(diskBillableItem.enabled == true || diskBillableItem.enabled == "true") {
                    ...
                    if(newVolume.billingType == "monthly") {
                        ...
                        double monthlyAmount =  DiskOfferZoneCost.findWhere(diskOffer: newVolume.diskOffer).cost * 720.00 * volsize
                        ...
                        invoiceItem.usageUnitPrice = DiskOfferZoneCost.findWhere(diskOffer: newVolume.diskOffer).cost
                    }
