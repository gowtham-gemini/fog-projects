    ...
    def setBillingConfig(String requestBody) {
        try {   
            ...
            Config ivaPercentage =  Config.findByName(Config.IVA_PERCENTAGE);
                ivaPercentage.value = requestData.ivaPercentage;
                ivaPercentage.save(flush: true);
                
            Config retentionPercentage =  Config.findByName(Config.RETENTION_PERCENTAGE);
                retentionPercentage.value = requestData.retentionPercentage;
                retentionPercentage.save(flush: true);
