...
class BandwidthService {
    ...
    //                 double readGB = virtualMachine.networkRead / 1048576
                    for(def currentVm: currentVmList) {
                        ...
                        if(virtualMachine) {
                            ...
                            if(blnExists.toString() == "false" || blnExists == false) {
                                ...
                                def bandWidthCost = MiscellaneousOfferZoneCost.findWhere(miscellaneousOffer :MiscellaneousOffer.get(1), zone :virtualMachine.computingOffer.zone).cost;
                ...
                for(def vm: vmList) {
                    ...
                    def bandWidthCost = MiscellaneousOfferZoneCost.findWhere(miscellaneousOffer :MiscellaneousOffer.get(1), zone :vm.computingOffer.zone).cost; 
