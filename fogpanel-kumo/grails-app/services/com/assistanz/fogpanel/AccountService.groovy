        ...
        try {               
            ...
            for(int i = 0; i < requestData.invitationInfo.length(); i++) {                
                ...
                if(invitation) {                    
                    ...
                    tempalteMap.put("verifyLink" , verifyLink)   
                    notificationService.send(currentRequistItem.email.toString(), "invitation.subject.flt", tempalteMap, "invitation.flt") 
                }     
            }
            HashMap<String,String> item = new HashMap<String,String>();
            item.put("result", "OK");
...
//            licenseValidationService.authorizeAction(FogPanelService.ACCOUNT_SIGNUP)
            ...
            def cloudPasswordString = requestData.password + date.toString()
...
//            def result = Account.findByUserName(name);
            ...
            HashMap accountItem = new HashMap();
                ...
                accountItem.put("cloudPassword", result.account.cloudPassword);
...
//                 double readGB = virtualMachine.networkRead / 1048576
    ...
    def resendconfirmMail(requestBody) {
        ...
        try {
            ...
            notificationService.send(user.account.email.toString(), "verificationEmail.subject.flt", tempalteMap, "verificationEmail.flt")
        ...
        try {          
            ...
            if(user) {
                if(user.account.status.name() == "ACTIVE") {
                    ...
                    notificationService.send(user.account.email.toString(), "forgotPassword.subject.flt", tempalteMap, "forgotPassword.flt")
        ...
        try {        
            ...
            if(user) {  
                ...
                if(requestData.type == "accountSettingGeneralInfoUpdate") {                    
                    ...
                    templateName = "accountSettingGeneralInfoUpdate.flt"
                    subject = "accountSettingGeneralInfoUpdate.subject.flt"
                    ...
                    templateName = "accountSettingBillingInfoUpdate.flt"
                    subject = "accountSettingBillingInfoUpdate.subject.flt"
                }                                                  
