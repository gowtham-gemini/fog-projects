...
environments {
    development {
         grails.config.locations = [ "classpath:${appName}-config.properties",
                ...
                "file:/etc/fogpanel/config-kumo.groovy"
            ]
    }
    production {
         grails.config.locations = [ "classpath:${appName}-config.properties",
...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'com.assistanz.fogpanel.User'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'com.assistanz.fogpanel.UserRole'
grails.plugins.springsecurity.authority.className = 'com.assistanz.fogpanel.Role'
...
birt {
    reportHome = "/etc/fogpanel/reports" // will be in the webapp directory during development
