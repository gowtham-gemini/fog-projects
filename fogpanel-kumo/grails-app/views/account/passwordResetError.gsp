...
<html lang="${lang}">
  ...
  <div class="navbar navbar-inverse">
    ...
    <div class="hero-unit">
      <h1 style="font-family:Arial,Helvetica,sans-serif;font-size:21px;font-weight:normal;color:#ea5800;margin:0;padding:0;height:auto;width:400px"><g:message code="common.account.passwordResetError"/></h1>
      <p>
        <h2 style="font-family:Arial,Helvetica,sans-serif;font-size:17px;font-weight:bold;color:#666;margin:15px 0 0 0;padding:0;height:auto;width:400px">Error</h2>
      <p style="font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:normal;color:#333;margin:15px 0 0 0;padding:0;height:auto;width:550px">
        <g:message code="common.account.invalidPassword"/>
        <g:link controller="login" class="btn btn-primary"><g:message code="common.tryAgain"/></g:link>
      </p>
      </p>
