	...
	<body>
		...
		<div id="show-config" class="content scaffold-show" role="main">
			...
			<ol class="property-list config">
				...
				<g:if test="${configInstance?.value}">
				<li class="fieldcontain">
					<span id="value-label" class="property-label"><g:message code="config.value.label" default="Value" /></span>
					
						<span class="property-value" aria-labelledby="value-label"><g:fieldValue bean="${configInstance}" field="value"/></span>
