...
<div data-dojo-type="dijit.Dialog" id="tierDeleteDialog" class="span4">
...
<div data-dojo-type="dijit.Dialog" id="tierReplaceACLDialog" class="span4">
    <input id="currentTierId" type="hidden">
    <div class="row-fluid">
...
<div data-dojo-type="dijit.Dialog" id="tierRestartDialog" class="span4">
    <input id="currentTierId" type="hidden">
    <div class="row-fluid">
        <div class="span10">
...
<div data-dojo-type="dijit.Dialog" id="tierEditConformDialog" class="span4">
    <input id="currentTierId" type="hidden">
    <div class="row-fluid">
        <div class="span10">
