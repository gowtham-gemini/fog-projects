            ...
            <div class="network-title-info">
                <div class="row-fluid">
                    <div class="span12" style="margin-left: 5px;">
                        <a class="span3" onclick="TierInfo.replaceACLTierShow();">              
                            <img title="<g:message code="common.changeAcl"/>" src="images/network_acl_icon.png"/>
                        </a>        
                        <a class="span3" onclick="TierInfo.showTierInfoRestart();">
...
<div data-dojo-type="dijit.Dialog"  id="addInternalLbDialog" title="<g:message code="common.addInternalLB"/>" class="customDialog span6">
    <div class="row-fluid">   
        <g:render template="addInternalLB" />
    </div>
    <div class="row-fluid">
...
<div data-dojo-type="dijit.Dialog" id="tierInfoReplaceACLDialog" class="span4">    
    <div class="row-fluid">
...
<div data-dojo-type="dijit.Dialog" id="tierInfoRestartDialog" class="span4">
...
<div data-dojo-type="dijit.Dialog" id="tierInfoDeleteDialog" class="span4">
    <input id="currentTierId" type="hidden">
    <div class="row-fluid">
        <div class="span10">
...
<div data-dojo-type="dijit.Dialog" id="tierInfoEditConformDialog" class="span4">
    <input id="currentTierId" type="hidden">
    <div class="row-fluid">
        <div class="span10">
