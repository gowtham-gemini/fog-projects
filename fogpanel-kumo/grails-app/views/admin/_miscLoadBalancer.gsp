      ...
      <div class="row-fluid">
        <div class="span4 field-box control-group">
          <label for="" class="control-label">
           ...
           <div class="controls">
          <div id="micLoadBalancerZone"></div>
           </div>
        </div>
        
        <div class="span6"  id="loadBalancerZoneCostList">                      
          <div id="micLoadbancerCostInfo"></div>              
        </div>        
        <div class="span1 field-box control-group">            
          <button type="button" class="defaultbtn" id="micLoadBalancerButton" data-dojo-type="dijit.form.Button" data-dojo-props="disabled: true" onclick="MiscLoadBalancerInfo.updateShow()"><g:message code="default.button.update.common" /></button>
