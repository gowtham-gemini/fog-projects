        ...
        <div class="span6 with-sidebar" id="invoiceInfoPage">
            <div class="container">
                <form class="new_user_form form-horizontal" data-dojo-type="dijit.form.Form" id="invoiceForm">
                    ...
                    <div class="span12 field-box control-group">
                        <label for="ivaPercentage" class="control-label settings_lable">                         
                            <g:message code="common.ivaPercentage"/>:
                            <span class="require">*</span>
                        </label>
                        <div class="controls">
                            <input type="text" data-dojo-type="dijit.form.ValidationTextBox" data-dojo-props="invalidMessage: '<g:message code="common.value.invalid"/>',required: 'required', placeHolder: '<g:message code="common.enterIvaPercentage"/>', promptMessage:'<g:message code="common.enterIvaPercentage"/>'," name="ivaPercentage" id="ivaPercentage">  
                        </div>
                    </div>
                    <div class="span12 field-box control-group">
                        <label for="retentionPercentage" class="control-label settings_lable">                         
                            <g:message code="common.retentionPercentage"/>:
                            <span class="require">*</span>
                        </label>
                        <div class="controls">
                            <input type="text" data-dojo-type="dijit.form.ValidationTextBox" data-dojo-props="invalidMessage: '<g:message code="common.value.invalid"/>',required: 'required', placeHolder: '<g:message code="common.enterRetentionPercentage"/>', promptMessage:'<g:message code="common.enterRetentionPercentage"/>'," name="retentionPercentage" id="retentionPercentage">  
                        </div>
                    </div>
