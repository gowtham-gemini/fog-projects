...
class FlavorResource {
    ...
    String getFlavorRepresentation(@QueryParam("referenceId") String referenceId, @QueryParam("imageId") String imageId) {

        flavorService.listFlavor(referenceId, imageId) as JSON
    }
