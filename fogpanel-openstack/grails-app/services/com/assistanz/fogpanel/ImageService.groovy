...
def createImages(requestData) {        
    try {             
        ...
        if(!image) {
            ...
            newImage.minRam = openstackImage.getMinRam()
            newImage.minDisk = openstackImage.getMinDisk()
            ...
            image.minRam = openstackImage.getMinRam()
            image.minDisk = openstackImage.getMinDisk()
