...
//                }
                ...
                alarm.minValue = requestData.thresholdMinValue
                alarm.maxValue = requestData.thresholdMaxValue
            ...
            invoiceService.addInvoiceItem(invoice, BillableItem.get(16), "monthly", alarm.name , alarm.refrenceId , null, price, null, null)                                     
