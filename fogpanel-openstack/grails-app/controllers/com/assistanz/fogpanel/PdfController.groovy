...
import com.assistanz.fogpanel.SSHKeys
        ...
        for(def billableItem : billableItemList) {
            ...
            if(billableItemCost[0] == null || billableItemCost[0] == "null") {
                ...
                if(billableItem.referenceItemName == BillableItem.get(1).referenceItemName) {
                    ...
                    bItem.put("billableItem", messageSource.getMessage('common.billing.monitoringAlarm', null, new Locale(language)));
                } 
...
//                }
                ...
                iItem.put("plan", "-");
                iItem.put("price", df.format(invoiceItem.usageUnitPrice).toDouble());
                iItem.put("hours", invoiceItem.usageUnits);
                iItem.put("priceUnit", "");
                iItem.put("usageUnit", "");
                iItem.put("cost", invoiceItem.totalAmount);
                def alarm = Alarm.findByRefrenceId(invoiceItem.referenceItemId);
                if(alarm?.deleted == true) {
                    iItem.put("vmStatus", "Expunging");
                } else {
                    iItem.put("vmStatus", "");
                }
        ...
        for(def billableItem: billableItemList) {                        
            ...
            if(billableItemCost[0] == null || billableItemCost[0] == "null") {                
                ...
                if(billableItem.referenceItemName == BillableItem.get(1).referenceItemName) {
                    ...
                    bItem.put("billableItem", messageSource.getMessage("common.billableItem.monitoringAlarm", null, new Locale(language)));
                } 
