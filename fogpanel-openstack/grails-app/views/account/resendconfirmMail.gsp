<html lang="${lang}">
    <head>
        <title><g:message code="common.confirmMail" /></title>
    ...
    <body class="fog-classic" style="background: #EEEEEE">        
        <div class="navbar navbar-inverse">
            ...
            <div class="hero-unit">
                <h1 style="font-family:Arial,Helvetica,sans-serif;font-size:21px;font-weight:normal;color:#ea5800;margin:0;padding:0;height:auto;width:400px"><g:message code="common.mail.resend" /></h1>
                <p>
                <h2 style="font-family:Arial,Helvetica,sans-serif;font-size:17px;font-weight:bold;color:#666;margin:15px 0 0 0;padding:0;height:auto;width:400px"><g:message code="common.mail.linkExpired" /></h2>
                <p style="font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:normal;color:#333;margin:15px 0 0 0;padding:0;height:auto;width:550px">
                  <g:message code="common.mail.linkExpired" />
                </p>
                <table>
                    <tr>
                        <td><label for="forgotPasswordEmail"><g:message code="common.userName"/>:</label></td>
                        <td class="span4"><input data-dojo-type="dijit.form.ValidationTextBox" 
                            data-dojo-props="required:true, promptMessage:'<g:message code="common.promptMessage.username"/>', 
                            missingMessage:'<g:message code="common.promptMessage.username"/>',   
                    ...
                    <tr>
                        <td>
                            <button id ="forgotPasswordButton" class="defaultbtn" type="button" data-dojo-type="dijit.form.Button" onclick="forgotPassword.userName.resendconfirmMail()"><g:message code="common.sendMail" /></button>
                        ...
                        <div data-dojo-type="dojox.widget.Toaster" data-dojo-props="positionDirection:'tr-left', duration:8000" id="forgotToaster">
                        </div>
                        <script type="text/javascript">
