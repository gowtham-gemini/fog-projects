...
<!--<div id="uploadError" style="padding-left : 20px; padding-right : 0px; padding-top : 0px; padding-bottom : 0px; display: block;" class="alert alert-danger">
    <g:message code="common.upload.error"/>
    <a onclick="window.parent.ObjectInfo.closeErrorDialog()">
        <i class="icon-remove-sign"></i>
    </a>
</div>-->
<body onload="window.parent.ObjectInfo.fileUploadError()"></body>