                    ...
                    <div class="table-wrapper products-table">                               
                        <div class="row-fluid filter-block" id="adminVolumePullDiv" style="display: block;margin-top: 0px;">
                            <div class="pull-right">
                                <button class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="Instance.init()">
                                    <g:message code='common.refresh' />
                                </button>                                   
                            </div>
                        </div>
                        <div class="row-fluid">
                            <div id="adminInstanceList"></div>
                            <div class="alert alert-info hide text_gray" id="noInstanceAdminMessageBox" style="display: none">
                                <i class="icon-exclamation-sign text_gray"></i> 
                                <g:message code="common.admin.noInstances"/>
                            </div>
                        </div>
                    </div>                    
                </div>                 
