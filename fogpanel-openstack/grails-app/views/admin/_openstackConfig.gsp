        ...
        <div class="span8">
            <form id="openstackConfigForm" data-dojo-type="dijit.form.Form" class="form-horizontal">
                ...
                <div id="openstackConfigWidgets">
                    ...
                    <div class="control-group" id="objectStoreConfigDiv" style="display: block">
                        <label class="control-label"><g:message code="common.objectStore"/>:</label>
                        <div class="controls" id="objectStoreEnabledDiv">
                            <div id="objectStoreSelectionDiv">
                              <input type="radio"data-dojo-type="dijit.form.RadioButton" name="objectStoreConfig" id="objectStoreEnable" value="ENABLE"/> 
                              <label for="objectStoreEnable" style="margin-left: 10px;"><g:message code="common.enable"/></label>
                              <input type="radio" checked="true" data-dojo-type="dijit.form.RadioButton" name="objectStoreConfig" id="objectStoreDisable" value="DISABLE"/>
                              <label for="objectStoreDisable" style="margin-left: 10px;"><g:message code="common.disable"/></label> 
                            </div>
                        </div>
                        <div class="controls" id="objectStoreNotInstalledDiv" style="display: none">
                            <label for="objectStoreNotInstalled" style="margin-left: 10px;"><g:message code="common.notInstalled"/></label>
                         </div> 
                                      
                    </div>
                </div>
                <div class="span4 pull-right" >
                    <div id="openStackConfigButtonDiv" style="display: block">
                    ...
                    <div class="span4" id="openStackConfigLoader" style="display: none"> 
        ...
        <div class="span4">
            <section class="well well-small">
                ...
                <ul>
                    ...
                    <li><g:message code="admin.objectStoreInfo"/></li> 
                </ul>
            </section>
        </div>
    </div>
