...
<!--      <div data-dojo-type="dijit/layout/ContentPane" onshow="VolumeSnapshotInfo.populateValues()" title="<g:message code="common.volumeSnapshot"/>" selected="true">
      ...
      <div data-dojo-type="dijit/layout/ContentPane" title="<g:message code="common.monitoringAlarm"/>" onshow="MonitoringAlarmInfo.populateValues()" >
          <g:render template="moniteringAlarmPage" />
      </div>
<!--      <div data-dojo-type="dijit/layout/ContentPane" title="<g:message code="common.objectStorage"/>" onshow="ObjectStorageInfo.populateValues()" >
         <g:render template="objectStoragePage" />
      </div>-->
    </div>
</div>