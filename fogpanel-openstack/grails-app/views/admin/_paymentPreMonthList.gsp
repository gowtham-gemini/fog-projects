...
<div class="span12 breadcrumbs">
  <ul>
    ...
    <li>/</li>
    <li><g:message code="common.thisYearPayment"/></li>
  </ul>
</div>
</div>
...
<!--        <div class="pull-right">            
    ...
    <div class="row-fluid">
      <div id="adminPreMonthPaymentList">
      </div>
      <div class="alert alert-info hide" id="noprePaymentMessageBox" style="display: none">
