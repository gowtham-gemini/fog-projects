...
<script type="text/javascript" src = "${resource(dir: 'js/app/user')}/storage.js"></script>    
...
<script type="text/javascript" src = "${resource(dir: 'js/app/user')}/vdc.js"></script>
...
<script id="userNetworkListPage" type="text/template">
  <g:render template="listNetwork" />
</script>
...
<script id="stoageMenuContainer" type="text/template">
  <g:render template="storage/menuContainer" />
</script>
<script id="containerList" type="text/template">
  <g:render template="storage/containerList" />
</script>
<script id="viewContainer" type="text/template">
  <g:render template="storage/viewContainer" />
</script>
...
<script id="vdcDashboard" type="text/template"> 
  <g:render template="vdc/dashboard" />
</script>
