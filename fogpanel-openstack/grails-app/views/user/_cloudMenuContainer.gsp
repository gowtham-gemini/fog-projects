        ...
        <div class="row-fluid stats-row">
            <div class="span4 stat-box" id="networkContainer"> 
                <div class="data span12">    
                    ...
                    <div class="span4">
                        <a href="#/user/server/list" class="index_title_icons_cldinstances"><g:message code="menu.user.cloud.instance"/></a>
                    </div>
                    <div class="span3 view"><a  href="#/user/server/list">&#8250; <g:message code="common.view"/></a></div>
                </div> 
            </div> 
