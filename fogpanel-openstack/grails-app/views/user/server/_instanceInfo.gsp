...
<div class="row-fluid" id="currentInstanceInfo">
    ...
    <!--                            <li class="hostname-edit" id="vmNameEditDiv">
                                ...
                                <li class="hostname-snapshot" id="vmSnapDiv">
                                    <button class="hostname-snapshotbtn" title="<g:message code="menu.user.cloud.vmSnapShot"/>" data-dojo-type="dijit.form.Button" onclick ="ViewServer.showCreateVMSnapshotDialog()"><i class="icon-camera"></i></button>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="span4 console-cont">
                ...
                <div class="span7 console-editor-elements-cont" id="console-cont-btn-disable">
                    <div class="span12">
                        ...
                        <div class="row-fluid">	
                            <div class="span3">
                                 <button class="console-elements-startbtn" title="<g:message code="common.start"/>" id="startVMButton" data-dojo-type="dijit.form.Button" onClick="ViewServer.startVMConfirm();"><i class="icon-play"></i></button>
                            </div>
                            <div class="span3">
                                <button class="console-elements-stopbtn"  title="<g:message code="common.stop"/>" id="stop" data-dojo-type="dijit.form.Button" onClick="ViewServer.stopInstanceShow();"><i class="icon-off"></i></button>
                            </div>
                            <div class="span3">
                                <button class="console-elements-rebootbtn" title="<g:message code="common.hardReboot"/>" id="reboot" data-dojo-type="dijit.form.Button" onClick="ViewServer.getHardRebootConformation();"><i class="icon-refresh"></i></button>
                            </div>
                            <div class="span3">
                                <button  class="hostname-deletebtn"  title="<g:message code="common.delete"/>" data-dojo-type="dijit.form.Button" onclick ="ViewServer.getDeleteConformation()"><i class="icon-remove"></i></button>
                            </div>
                        </div>
                    </div>
                </div>                    
...
<div class="row-fluid">
    ...
    <div class="span4">
        <div class="row-fluid vm-instance-infodetail custom">
            <div class="span12">
                <div class="span5"><g:message code="common.network"/></div>
                <div class="span6">
                    <span id="vmDetailNetworks"></span>
                    <!--<input type="hidden" id="locationId">-->
                </div>
            </div>
            <div class="span12">
                <div class="span5"><g:message code="common.privateIPs"/></div>
                <div class="span6">
                    <span id="vmDetailPrivateIPs"></span>
                    <!--<input type="hidden" id="locationId">-->
                </div>
            </div>
            <div class="span12">
                <div class="span5"><g:message code="common.floatingIPs"/></div>
                <div class="span6">
                    <span id="vmDetailFloatingIPs"></span>
                    <!--<input type="hidden" id="locationId">-->
                </div>
            </div>
            <div class="span12">
                <div class="span5"><g:message code="common.monitoringEnabled"/></div>
                <div class="span6">
                    <span id="vmDetailMonitoringEnabledStat"></span>
                    <!--<input type="hidden" id="locationId">-->
                </div>
            </div>
        </div>
    ...
    <div class="span4">
        <div class="row-fluid" id="vmDetailNoMonitoringEnableMsgBox">
            <div class="span12 vm-instance-infodetail">
                <div class="create_item_box custom">
                    <h3><g:message code="common.clickHere"/> <span class="title"><g:message code="common.enableMonitoring"/></span></h3>
                    <p><g:message code="common.gandsOnNowMsg"/></p>
                    <a class="btn-flat new-product" title="Enable Monitoring" onclick="ListServer.gotoMonitorTab()"><g:message code="common.enableMonitoring"/></a>
                </div>
            </div>
        </div> 
        <div class="row-fluid hide_text" id="vmDetailSampleGraphDiv">
            <div class="vm-instance-infodetail span12">
                <h5 class="simple_heading" style="margin: 0;font-size: 12px;font-weight: 600; line-height: 13px;"><g:message code="common.cpuGraphTitle"/></h5>
                <div id="vmDetailSampleGraph" style="height: 100px;"></div>
            </div>            
        </div>
    </div>
</div>
...
<div class="row-fluid">
    <div class="span12" id="userViewNetworkPage">
        <div id="vmInfoTabContainer" data-dojo-type="dijit/layout/TabContainer" class="row-fluid" style="overflow: visible; display: block; min-height: 500px" tabStrip="true">
            <div onshow="GraphInfo.clearSession()" data-dojo-type="dijit/layout/ContentPane" class="span12" title="<g:message code="common.details"/>" selected="true">                
              <div class="row-fluid ">                    
                        <div class="" id="vmInfo">
                            <div class="grd-row-alt1-tbl">
                                <div class="grd-tbl-row">
                                    <div class="grd-tbl-cell clm-first"><g:message code="common.name"/></div>
                                    <div class="grd-tbl-cell clm-second">
                                        <span id="vmDetailName"></span>
                                        <input type="hidden" id="locationId">
                                    </div>
                                </div>                                
                            </div>
                            <div class="grd-row-alt2-tbl">
                                <div class="grd-tbl-row">
                                <div class="grd-tbl-cell clm-first"><g:message code='common.referenceId' /></div>
                                <div class="grd-tbl-cell clm-second">
                                    <span id="vmDetailReferenceId" class=""></span>
                            ...
                            <div class="grd-row-alt1-tbl">
                                ...
                                <div class="grd-tbl-cell clm-second">
                                    <span id="vmDetailCreatedDate"></span>                                     
                                </div>
                                </div>
                            </div>
                            <div class="grd-row-alt2-tbl">
                                <div class="grd-row-alt1-tbl">
                                <div class="grd-tbl-cell clm-first"><g:message code='common.updatedOn' /></div>
                                <div class="grd-tbl-cell clm-second">
                                    <span id="vmDetailUpdated"></span>           
                                </div>
                                </div>
                            </div>            
<!--                            <div class="grd-row-alt1-tbl">
                                <div class="grd-tbl-row">
                                <div class="grd-tbl-cell clm-first"><g:message code='common.securityGroup' /></div>
                                <div class="grd-tbl-cell clm-second">                                   
                                    <span id="vmDetailSecurityGroup"></span>                                    
                                </div>
                                </div>
                            </div>-->
                            <div class="grd-row-alt1-tbl">
                                <div class="grd-tbl-row">
                                <div class="grd-tbl-cell clm-first"><g:message code='common.ram' /></div>
                                <div class="grd-tbl-cell clm-second">                                   
                                    <span id="vmDetailRam" class="" style="overflow: hidden; text-overflow: ellipsis;"></span>                                    
                                </div>
                                </div>
                            </div>
                            <div class="grd-row-alt1-tbl">
                                ...
                                <div class="grd-tbl-cell clm-second">                                   
                                    <span id="vmDetailVcpu" class="" style="overflow: hidden; text-overflow: ellipsis;"></span>                                    
                                </div>
                                </div>
                            </div>
                            <div class="grd-row-alt1-tbl">
                                <div class="grd-tbl-row">
                                <div class="grd-tbl-cell clm-first"><g:message code='common.rootDisk' /></div>
                                <div class="grd-tbl-cell clm-second">                                   
                                    <span id="vmDetailDisk" class="" style="overflow: hidden; text-overflow: ellipsis;"></span>                                    
                                </div>
                                </div>
                            </div>
                        </div>                                         
            ...
            <div data-dojo-type="dijit/layout/ContentPane" class="span12" title="<g:message code="menu.user.vm.volume"/>" onshow="ViewServer.attachedVolumeList(), GraphInfo.clearSession()">
                <div class="row-fluid" style="margin-top: 20px"><div class="span1"></div>
                    <form id="attachVolumeFormList" data-dojo-type="dijit.form.Form">
                        <div class="table-wrapper products-table">
                            <div class="row-fluid">
                                <div class="pull-right" id="volumeTabActionContainer">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="alert alert-info hide overflowLabel text_gray" id="noAttachedVolumeMessageBox" style="display: none">
                                    ...
                                    <g:message code="common.instance.noVolumeAttached"/>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div  data-dojo-type="dijit/layout/ContentPane" class="span12" title="<g:message code="menu.user.vm.nics"/>" onshow="NicInfo.populateValues(), GraphInfo.clearSession()">
                <div class="row-fluid">
...
<!--            <div data-dojo-type="dijit/layout/ContentPane" onshow="GraphInfo.clearGraphSession()" class="span12" title="<g:message code="common.secondaryIp"/>">
            ...
            <div data-dojo-type="dijit/layout/ContentPane" title="<g:message code="common.log"/>" onshow="ViewServer.getSreverLog(), GraphInfo.clearSession()">
                <div class="row-fluid">
    ...
    <!--                                                <div id="imageCancelButtonDiv" class="span2">
                    ...
                    <div class="span9 hide_text" id="instanceMonitoringDiv">
                        ...
                        <div class="row-fluid">
                            <div id="alertTitlePane" data-dojo-type="dijit/TitlePane" data-dojo-props="title: '<g:message code="common.alarm"/>', open: false" >
    ...
    <!--                                                        <label for="drangeSelectBox"  class="control-label">         
                            ...
                            <div class="row-fluid">
                                <div class="span12" id="portIPTitlePane" data-dojo-type="dijit/TitlePane" data-dojo-props="open: false, title: '<g:message code="common.portMonitoring"/>'" onshow="IPServices.populateValues(); IPServices.updateIPService();" >
...
<!--</div>-->    
    ...
    <div data-dojo-type="dijit.Dialog" id="attachVolumeDialog" title="<g:message code="common.instance.volumeAttach"/>"  class="customDialgue">
        <div class="span5 dijitDialogueBackground">
            <div class="row-fluid" id="AttachedVolumesAvailableOptions">
            ...
            <div class="row-fluid">
                <div class="alert alert-info hide text_gray" id="noAvailableAttachedVolumes" style="text-align: center;">
                    <i class="icon-exclamation-sign text_gray"></i> 
                    <g:message code="common.instance.noVolumevalilable"/> <a href="#/user/volume/list" onclick="ViewServer.closeVolumeDialog()"><g:message code="common.instance.volumeSolutions"/> </a>
                </div>
            </div>                                        
            <div id="AttachedVolumesActionPart">
...
<div data-dojo-type="dijit.Dialog" id="graphZoomDialogBox" title="<g:message code="common.graph"/>" class="span10">                   
