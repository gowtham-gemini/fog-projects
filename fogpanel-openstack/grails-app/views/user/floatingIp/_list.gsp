                        ...
                        <div class="control-group">
                            ...
                            <div class="controls updatable elements">
                                ...
                                <div class="form_help_icon" id= "externalNetworksListIPHelp" style="top: -25px; left: -1px;display: block">
                                    <i class="icon-info-sign" id="publicNWListHelpMenu"></i>
                                    <div data-dojo-type="dijit.Tooltip" data-dojo-props="connectId:'publicNWListHelpMenu', showDelay: 1"><g:message code="common.help.message.associateFloatingIp"/></div>
                                </div>
                            </div>
                        </div>
