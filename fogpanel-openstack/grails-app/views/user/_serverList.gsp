...
<div data-dojo-type="dijit.Dialog" id="softRebootDialog" title="<g:message code='user.instance.softRebootInstance.confirmTitle' />" style="color: black; width: 350px; background: #FFFFFF;">
    <div class="row-fluid">
        <div class="span2"><img src='images/popup-icons/vm_reboot_icon.png'/></div>
        <div class="span10">
            <div class="span12"><g:message code='user.instance.softRebootInstance.confirmMessage' /> </div>            
        </div>        
    </div>            
        <div class="row-fluid">
            <button type="button" class="primarybtn" data-dojo-type= "dijit.form.Button" onclick="ListServer.softRebootInstance()" id="instanceRebootButton"> <g:message code='common.softReboot' /> </button>
            <button class="cancelbtn" id="rebootInstanceCancelButton" data-dojo-type="dijit.form.Button" onclick="ListServer.closeSoftRebootDialog()"> <g:message code='common.cancel' /></button> 
        </div>  
</div>
<div data-dojo-type="dijit.Dialog" id="hardRebootDialog" title="<g:message code='user.instance.hardRebootInstance.confirmTitle' />" style="color: black; width: 350px; background: #FFFFFF;">
    <div class="row-fluid">
        <div class="span2"><img src='images/popup-icons/vm_reboot_icon.png'/></div>
        <div class="span10">
        ...
        <div class="row-fluid">
            <button type="button" class="primarybtn" data-dojo-type= "dijit.form.Button" onclick="ListServer.hardRebootInstance()"> <g:message code='common.hardReboot' /> </button>
            <button class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="ListServer.closeHardRebootDialog()"> <g:message code='common.cancel' /></button> 
        </div>  
</div>
<div data-dojo-type="dijit.Dialog" id="deleteDialog" title="<g:message code='user.vm.deleteVm.title' />" class="customDialgue" style="color: black; width: 350px;">
    <div class="row-fluid">
        ...
        <div class="span10">
         ...
         <div class="row-fluid">
            <button type="button" class="primarybtn" data-dojo-type= "dijit.form.Button" onclick="ListServer.deleteInstance()" id="instanceDeleteButton">
                <g:message code='default.button.delete.common' />   
            </button>
            <button id="DeleteInstanceCancelButton" data-dojo-type="dijit.form.Button" onclick="ListServer.closeDeleteDialog()" class="cancelbtn">
                <g:message code='common.cancel' />
            </button> 
         </div>
    </div>                        
                    ...
                    <div id="associateFloatingIpPage"> 
                        <div class="control-group">
                            ...
                            <div class="controls updatable elements">
                                <div id="ipAddressList" class="selectOption" style="display: block">         
                                    <button class="cancelbtn" style="position: absolute; left: 353px" type="button" data-dojo-type="dijit.form.Button" title = "<g:message code="common.user.maangeFloatingIp.createTitle"/>" onclick="InstanceFloatingIpInfo.createFloatingIpDialog()"> + </button>
                                </div>
                                <div id="ipAddressListLoader" style="display: none">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls updatable elements">
                                ...
                                <div class="form_help_icon" id="ipsListHelpDiv" style="top: -25px; left: -1px; display: block">
                                    <i class="icon-info-sign" id="portsDisassociateListHelp"></i>
                                    <div data-dojo-type="dijit.Tooltip" data-dojo-props="connectId:'portsDisassociateListHelp', showDelay: 1"><g:message code="common.help.message.disAssociate"/></div>
                                </div>
                            </div>
                        </div> 
                    </div>
