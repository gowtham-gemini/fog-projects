  ...
  <div id="noCurrentUsage" style="display: none;">
    ...
    <div class="create_item_box span10 offset1">
      ...
      <span><g:message code="common.VM.heading"/> </span>
        ...
        <a title="Launch VM" class="btn-flat new-product" href="#/user/server/add"><img src="${resource(dir: 'images')}/vm_quicklch_icon.png" alt=""></img><g:message code="user.cloud.launchVM"/> </a>  
  </div>
</div>
