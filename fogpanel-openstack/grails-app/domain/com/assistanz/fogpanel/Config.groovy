...
//    Date createdDate
    ...
    public static final String OPENSTACK_ENDPOINT_URL= "openstack.endpoint.url";
    public static final String OPENSTACK_ADMIN_UUID= "openstack.admin.uuid";
    public static final String OPENSTACK_ADMIN_PASSWORD= "openstack.admin.password";
    ...
    public static final String ZENOSS_ENDPOINT_URL= "zenoss.endpoint.url";
    public static final String ZENOSS_USERNAME = "zenoss.username";
    public static final String ZENOSS_PASSWORD = "zenoss.password";
    
    public static final String OBJECT_STORE_ENABLED = "object.store.enabled";
