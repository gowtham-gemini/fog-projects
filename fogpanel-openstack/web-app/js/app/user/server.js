...
//                InstanceFloatingIp.disAssociatePortList();
            ...
            "viewServer" : action(function(id) {
                ...
                if(dijit.byId("alertTitlePane")) {               
                    dijit.byId("alertTitlePane").destroyRecursive();          
                }     
                if(dijit.byId("portIPTitlePane")) {               
                    dijit.byId("portIPTitlePane").destroyRecursive();          
                }                     
...
var IPServices =  {
    updateIPService : function () {
        window.IPUpdateInterval =  setInterval(function () {
            IPServices.populateValues();
        },150000);  
    },
    populateValues : function () {        
        ...
        var gridLayout = [
            [
                {'name': translator.common.events, 'field': 'events', 'hidden': 'true', datatype:"string",  autoComplete: true,'formatter': function(data) {                                                
                        if(data === "clear") {
                ...
                {'name': translator.common.protocol, 'field': 'protocol', 'hidden': 'true', datatype:"string",  autoComplete: true},
                {'name': translator.common.port, 'field': 'port', 'width': '300px', datatype:"string",  autoComplete: true},
                {'name': translator.common.ips, 'field': 'ips', 'hidden': 'true', datatype:"string",  autoComplete: true},
                {'name': translator.common.description, 'field': 'description','hidden': 'true', datatype:"string",  autoComplete: true},
...
var GraphInfo = {
    populateSampleGraph : function () {
        ...
        if(deviceId) { 
            console.log("***1****");
            dojo.query("#vmDetailNoMonitoringEnableMsgBox").toggleClass("hide_text", true); 
            dojo.query("#vmDetailSampleGraphDiv").removeClass("hide_text", true); 
            dojo.byId("vmDetailSampleGraph").innerHTML = "<img src='images/vmload.gif' alt="+translator.common.loader.imageLoadError+" height='36' width='100'/> </br> <p>"+"Loading please wait..."+"</p>";              
            graphRestStore.query({deviceId: deviceId  , size:500, dRange:Number(129600), graphType: "cpu"})
                    .then(function (data) { 
                        if(data[0].imageURL) {
                            dojo.byId("vmDetailSampleGraph").innerHTML.innerHTML = "";                            
                            dojo.byId("vmDetailSampleGraph").innerHTML = "<div class='span12'><img width='100%' class='graph_custom_height' src="+"data:png;base64," + data[0].imageURL+" /> </div>"; 
                            dojo.byId("zoomGraphImage").innerHTML = "<div class='span12'><img width='100%' class='' src="+"data:png;base64," + data[0].imageURL+" /> </div>";            
                            
                            dojo.byId("vmDetailSampleGraph").onclick = function () {
                                GraphInfo.populateSampleGraph();
                                dijit.byId("graphZoomDialogBox").set("title", translator.common.cpuUtilGraph);
                                dijit.byId("graphZoomDialogBox").show();
                            };
                            dojo.byId("vmDetailSampleGraph").style.cursor = "pointer";
                        } else {                    
                            dojo.byId("zoomGraphImage").innerHTML  = "";
                            dojo.byId("vmDetailSampleGraph").innerHTML = "<div class='alert alert-info overflowLabel text_gray'> <i class='icon-exclamation-sign text_gray'></i>"+ translator.common.thereIsNo + "  " +  translator.common.cpuUtilGraph + "  "+ translator.common.noGraphAvailMsg + "</div>"; 
                            dojo.byId("zoomGraphImage").innerHTML = "";
                            dojo.byId("zoomGraphImage").onclick = {};
                            dojo.byId("zoomGraphImage").style.cursor = "text";
                        }                           
                    });
                } else {     
                    console.log("***2****");
                    dojo.query("#vmDetailNoMonitoringEnableMsgBox").removeClass("hide_text", true); 
                    dojo.query("#vmDetailSampleGraphDiv").toggleClass("hide_text", true); 
                }           
        },
    clearSession : function () {
        ...
        if(window.IPUpdateInterval) {
            clearInterval(window.IPUpdateInterval);
        } 
    },
...
//                              monitorTab.destroyRecursive();
        ...
        dojo.byId("location").innerHTML = "<img src='images/preloader_circle.gif' alt='" + translator.common.loader.loading + "' height='3' width='20'/>"; 
        dojo.byId("status").innerHTML = "<img src='images/preloader_circle.gif' alt='" + translator.common.loader.loading + "' height='3' width='20'/>"; 
        dojo.byId("plan").innerHTML = "<img src='images/preloader_circle.gif' alt='" + translator.common.loader.loading + "' height='3' width='20'/>";
        dojo.byId("sshKeyName").innerHTML = "<img src='images/preloader_circle.gif' alt='" + translator.common.loader.loading + "' height='3' width='20'/>";
        
        dojo.byId("vmDetailPrivateIPs").innerHTML = "<img src='images/preloader_circle.gif' alt='" + translator.common.loader.loading + "' height='3' width='20'/>";
        dojo.byId("vmDetailFloatingIPs").innerHTML = "<img src='images/preloader_circle.gif' alt='" + translator.common.loader.loading + "' height='3' width='20'/>";
        dojo.byId("vmDetailMonitoringEnabledStat").innerHTML = "<img src='images/preloader_circle.gif' alt='" + translator.common.loader.loading + "' height='3' width='20'/>";
        ...
        serverRestStore.query({referenceId:referenceId}).then(function(data) {
            dojo.forEach(data, function(instanceData) {  
                ...
                dojo.byId("vmDetailName").innerHTML = instanceData.name;
                
                dojo.byId("vmDetailReferenceId").innerHTML = instanceData.referenceId;
                dojo.byId("vmDetailName").innerHTML = instanceData.name;
                dojo.byId("vmDetailCreatedDate").innerHTML = instanceData.createdOn;
                dojo.byId("vmDetailUpdated").innerHTML = instanceData.updatedOn;
                dojo.byId("vmDetailRam").innerHTML = (instanceData.flavorMemory / 1024).toFixed(2) + "  " + translator.common.gb;
                dojo.byId("vmDetailVcpu").innerHTML = instanceData.flavorVpcu;
                dojo.byId("vmDetailDisk").innerHTML = instanceData.flavorRootDisk + "" + translator.common.gb;
                ...
                if(instanceData.privateIPs === "" || instanceData.privateIPs === undefined || instanceData.privateIPs === "undefined") {
                    dojo.byId("vmDetailPrivateIPs").innerHTML = "..............."
                } else {
                    dojo.byId("vmDetailPrivateIPs").innerHTML = instanceData.privateIPs;
                }
                if(instanceData.floatingIPs === "" || instanceData.floatingIPs === undefined || instanceData.floatingIPs === "undefined") {
                    dojo.byId("vmDetailFloatingIPs").innerHTML = "...............";
                } else {
                    dojo.byId("vmDetailFloatingIPs").innerHTML = instanceData.floatingIPs;
                }                
                if(instanceData.isMonitoringEnabled === true || instanceData.isMonitoringEnabled === "true") {
                    dojo.byId("vmDetailMonitoringEnabledStat").innerHTML = "YES";
                } else {
                    dojo.byId("vmDetailMonitoringEnabledStat").innerHTML = "NO";
                }                
                
                dojo.byId("vmDetailNetworks").innerHTML = "<img src='images/preloader_circle.gif' alt='" + translator.common.loader.loading + "' height='3' width='20'/> ";
                nicRestStore.query({serverId: instanceData.referenceId}).then(function (networkData) {                                                            
                    if(networkData === "" || networkData === undefined || networkData.length === 0) {
                        dojo.byId("vmDetailNetworks").innerHTML = "...........";
                    } else if(networkData.length === 1) {
                        dojo.byId("vmDetailNetworks").innerHTML = networkData[0].network.name;
                    } else {
                        dojo.byId("vmDetailNetworks").innerHTML = "";
                        dojo.forEach(networkData, function (currentNic, index) {  
                            dojo.byId("vmDetailNetworks").innerHTML += currentNic.network.name;
                            if(networkData.length !==  index+1) {
                                dojo.byId("vmDetailNetworks").innerHTML += ",";
                            }                            
                        });
                    }                    
                });
//                if(instanceData.ip === "" || instanceData.ip === undefined || instanceData.ip === "undefined") {
//                    dojo.byId("nicIp").innerHTML = "..............."
//                } else {
//                    dojo.byId("nicIp").innerHTML = instanceData.ip;
//                }                                                                      
                
                if(instanceData.state === "ACTIVE") {
                    ...
                    dojo.byId("viewCosoleImg").onclick = function () {
                        ViewServer.viewConsole();
                    }
                    dojo.byId("viewCosoleImg").style.cursor = "pointer"
                } else if(instanceData.state === "SHUTOFF") {
        ...
        networksRestStore.query({serverId : serverId}).then(function (data) {
            if (data.length == 0 || data == undefined || data == 'undefined' || data == '' || data == " ") {                
                ...
                dojo.forEach(data, function(volumeData) {                                                                                                            
                    ...
                    volumeListItem.placeAt("attachedVolumeListGrid");
...
//                        volumeListItem.disableOptions();                         
       ...
       //get detached volume list
        ...
        volumeRestStore.query().then(function(data) {  
            if(data.length === 0 || data === undefined || data === "" || data === "undefined") {
                dojo.query("#noAvailableAttachedVolumes").removeClass("hide", true);
                dojo.query("#AttachedVolumesAvailableOptions").toggleClass("hide", true);
                dojo.query("#AttachedVolumesActionPart").toggleClass("hide", true);                                                
            } else {
                dojo.query("#noAvailableAttachedVolumes").toggleClass("hide", true);    
                dojo.query("#AttachedVolumesAvailableOptions").removeClass("hide", true);
                dojo.query("#AttachedVolumesActionPart").removeClass("hide", true);      
                dojo.forEach(data, function(el) {
           ...
           var gridLayout = [
               [
                ...
                {'name': translator.common.name, 'field': 'name', 'width': '100px', datatype:"string",  autoComplete: true,'formatter': function(data) {
                        //powerstate = 0 rebuild or error state
                ...
                {'name': translator.common.size.sizeName, 'field': 'plan', 'width': '250px', datatype:"string",  autoComplete: true },
...
//                        }
                            //Powerstate:  1- running,reboot,resume,start,rebuild,resize  3- Paused  4-Shutoff  0-Build                 
                            ...
                            if(data.powerState !== "0") {
                                ...
                                if(data.powerState !== "0") {
                                    var vmSnap = new MenuItem({
                                        label: translator.common.takeSnapshot,
                                ...
                                var monitorMenuItem = new MenuItem({
                                    label: translator.common.monitoring,
        ...
        nicRestStore.query({serverId : serverId}).then(function (data) {
            if(data == "" || data == "undefined") {
                    ...
                    dojo.forEach(data, function (el, index) {                     
                        var defaultStat = "";
                        var count = index + 1;
                        var adminStatus = (el.adminState === true) ? "UP":"DOWN";   
                        var contentDiv = "";  
                        var viewNetwotkUrl = "#/user/network/view/" + el.network.referenceId;
                        var paneStat = true; 
                        var networkName = "";                                                   
                        networkName = "<a href=" + viewNetwotkUrl + ">" + el.network.name + "</a>"                                                        
...
//                        defaultStat = "("+ translator.common.defaultVal +")";  
                        ...
                        contentDiv = 
                                "<div class='row-fluid'> \n\
                                    ...
                                    <div class='span12 field-box'><label class='headerLabel'>"+translator.common.idCaps+":</label><span id='nicId'>"+ el.referenceId + "</span></div>\n\
                                <div class='span12 field-box'><label class='headerLabel'>"+translator.common.networkName+":</label>"+networkName+"</div><div class='span12 field-box'><label class='headerLabel'>"
                                +translator.common.macAddress+":</label>"+                                                                               
                                    "<span>" + el.macAddress + "</span></div><div class='span12 field-box'><label class='headerLabel'>"
                                    +translator.common.fixedIp+":</label>"+                                                                                
                                    "<span>" + el.ipAddress + "</span></div><div class='span12 field-box'><label class='headerLabel'>"+translator.common.status.name+":</label>"+                                        
                                    "<span>" + el.status.name + "</span></div><div class='span12 field-box'><label class='headerLabel'>"+translator.common.adminState+":</label>"+                                        
                                    "<span>" + adminStatus+ "</span></div></div>";
                        
                        var tp = new dijit.TitlePane({
                            "class": "",
                            style: "height: auto%; width: 60%; margin-left: 110px;",
                            title: "Nic"+ count + " " + "  |  " + el.network.name,
                            content: contentDiv,
                            open: paneStat                            
                        }).placeAt("userNicList");
                        tp.startup();
...
//        volumeList.newItem({id: "", name: ""});
    ...
    'ipAddressList': function(id) {
        ...
        dojo.byId("ipAddressListLoader").style.display = "block";
        dojo.byId("ipAddressList").style.display = "none";
        var floatingIpRestStore = new JsonRest({
            target: core.getContextPath() + "/api/floatingIp/associateList"
        });
...
//        volumeList.newItem({id: "", name: ""});
        floatingIpRestStore.query().then(function(data) {
            dojo.byId("ipAddressList").style.display = "block";
            dojo.byId("ipAddressListLoader").style.display = "none"; 
            dojo.forEach(data, function(el) {
                floatingIpList.newItem({id: el.floatingIpAddress, name: el.floatingIpAddress});
                if(data.length === 1) {
                   defaultValue = el.floatingIpAddress;
                }
            });
...
var InstanceMonitoring = {          
    'init': function() {
        ...
        dijit.byId("alertTitlePane").set("open", false);
        dijit.byId("portIPTitlePane").set("open", false);        
        var monitoringIpRestStore = new JsonRest({
            target: core.getContextPath() + "/api/floatingIp/instanceIp"
        });
...
//        imageList.newItem({id: "", name: ""});
   ...
   'checkIsDeviceEnabled': function(referenceId) {              
       ...
       console.log("check device fun is calling");
       devicesRestStore.query({instanceId: referenceId}).then(function(data) {                                  
           if(data == undefined || data == 'undefined' || data == '' || data == " " || data.length == 0 ) {
                ...
                dojo.forEach(data, function(resultData) {                    
                    ...
                    if((resultData.jobId !== null && resultData.jobStatus === "SUCCESS") ||(resultData.jobId !== null && resultData.jobStatus === "STARTED")) {
                        ...
                        devicesEnableStateStore.query({deviceId: deviceId}).then(function(deviceResult) {       
                            console.log("Device stat" + deviceResult[0].deviceStatus);
                            if(deviceResult[0].deviceStatus === "RUNNING") {
                                console.log("***Device stat 1***");
                                dojo.query("#instanceMonitoringDiv").toggleClass("hide_text", true);
                                dojo.query("#monitoringContainerLoader").removeClass("hide_text", true); 
                                dijit.byId("vmInfoTabContainer").resize();
                            } else if(deviceResult[0].deviceStatus === "COMPLETED") {
                                console.log("***Device stat 2***");
                                dojo.query("#instanceMonitoringDiv").removeClass("hide_text", true);
                                dojo.query("#monitoringContainerLoader").toggleClass("hide_text", true);   
                                dijit.byId("vmInfoTabContainer").resize();
                            } else {
                                console.log("***Device stat 3***");
                                dojo.query("#instanceMonitoringDiv").removeClass("hide_text", true);
                                dojo.query("#monitoringContainerLoader").toggleClass("hide_text", true);   
                                dijit.byId("vmInfoTabContainer").resize();
                            }
   ...
   'populateAlertValues' : function() {
       ...
       var serverId = dojo.byId("instanceId").value;
        ...
        alarmRestStore.query({serverId : serverId}).then(function (data) {
            if (data.length == 0 || data == undefined || data == 'undefined' || data == '' || data == " ") {
                dijit.byId("alertTitlePane").set("title" , translator.common.alarm + " ( " + 0 + "  ) ");
                dojo.byId("moniteringAlertList").innerHTML = "";
                dojo.byId("noMonitorAlertMessageBox").style.display = "block";

            } else {
                dijit.byId("alertTitlePane").set("title" , translator.common.alarm + " ( " + data.length + "  ) ");
                dojo.byId("noMonitorAlertMessageBox").style.display = "none";
                dojo.forEach(data, function (resultData) {
                    dataList.newItem({
