    ...
    "dijit/Dialog"
        ...
        function(dojo, i18n, translator, dijit, domClass, domConstruct, JsonRest, query, registry, FilteringSelect, Select,
            ...
            controller({
                name: "flavors",
                module: "admin",
                filePath: "/js/app/admin/flavors.js",
                layout: {
                    name: "flavors",
                    containerId: "content"
                },
            ...
            },
            {
                ...
                "list": action(function() {
                    ...
                    core.ui.loadTemplate("adminFlavorsList", core.ui.getContentId());
                    ListFlavors.init();
                }),
            ...
            if (zoneData.length === 0 || zoneData === undefined || zoneData === "undefined") {                
                ...
                currency.query().then(function(data) {
                    dojo.forEach(data, function(cur) {
                        dojo.byId("floavourCurrencyValue").innerHTML = cur.currency;
                    });
                });
        
                var countRest = new JsonRest({
                    target: core.getContextPath() + "/api/flavor/count"
                });
                ...
                openStackConfigCheck.query().then(function(data) {
                    ...
                    if(data === false) {
                        dojo.byId("adminFlavorPullDiv").style.display = "none";
                        dojo.byId("openStackNotConfiguredMsgFlavor").style.display = "block";
                    } else{
...
//                {'name': "ID", 'field': 'id', 'width': '200px', 'datatype': 'string', 'autoComplete': 'true'},
                {'name': translator.common.name, 'field': 'name', 'width': '200px', 'datatype': 'string', 'autoComplete': 'true', 'formatter': function(data) {
                        var editTag = "<a href='#/admin/flavors/edit/"+data.referenceId+"' title='"+translator.common.edit+"'>"+data.name+"</a>";
                        return editTag;
                }},
//                 {'name': translator.common.region, 'field': 'region', 'width': '100px', 'datatype':'string',  'autoComplete': 'true'},                 
//                 {'name': translator.common.zone, 'field': 'zone', 'width': '150px', 'datatype':'string',  'autoComplete': 'true'},
                {'name': translator.common.vcpu, 'field': 'vcpu', 'width': '100px', 'datatype': 'string', 'autoComplete': 'true'},
                {'name': translator.common.ram, 'field': 'ram', 'width': '100px', 'datatype': 'string', 'autoComplete': 'true',},
                {'name': translator.common.rootDisk, 'field': 'rootDisk', 'width': '100px', 'datatype': 'string', 'autoComplete': 'true',},
                ...
                {'name': translator.common.action, 'field': 'action',
                    'formatter': function(data) {
                        ...
                        if(data.isDisabled === true || data.isDisabled === "true") {                            
                             html = "<a href='#/admin/flavors/edit/"+data.referenceId+"' title='"+translator.common.edit+"'><i class='icon-edit'></i></a>" +                                      
                                    "<a class='offset1' title='"+translator.common.enable+"' onclick='ListFlavors.changeFlavorDialog(\"" + data.referenceId + "\", \"enable\")'><i class='icon-eye-open'></i></a></li>"+
                                    "<a onclick='FlavorInfo.deleteFlavorDialogAlert(\"" + data.referenceId + "\")' class='offset1' title='"+translator.common.deleteData+"'><i class='icon-remove'></i></a></li>";
                         } else if(data.isDisabled === false || data.isDisabled === "false") {
                            
                             html = "<a href='#/admin/flavors/edit/"+data.referenceId+"' title='"+translator.common.edit+"'><i class='icon-edit'></i></a>" +                                       
                                    "<a class='offset1' title='"+translator.common.disable+"' onclick='ListFlavors.changeFlavorDialog(\"" + data.referenceId + "\", \"disable\")'><i class='icon-eye-close'></i></a></li>" + 
                                    "<a class='offset1' onclick='FlavorInfo.deleteFlavorDialogAlert(\"" + data.referenceId + "\")' title='"+translator.common.deleteData+"'><i class='icon-remove'></i></a></li>";
                        }
                        return html;   
...
//                            swapDisk: resultData.swapDisk  + " " + translator.common.mb,
//                            ephemeralDisk: resultData.ephemeralDisk  + " " + translator.common.gb,
                        action: resultData
                    });
                });
                dojo.byId("adminFlavorsList").innerHTML = "";
