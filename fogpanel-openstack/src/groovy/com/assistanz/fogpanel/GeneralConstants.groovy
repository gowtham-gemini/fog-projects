...
class GeneralConstants {	
    ...
    public static final String OBJECT_METADATA_NAME = "X-Object-Meta-Name";
    public static final String CONTENT_TYPE = "Content-Type";
    
    public static final String CATALOG_TYPE_NETWORK = "network";
    public static final String CATALOG_TYPE_COMPUTE_V3 = "computev3";
    public static final String CATALOG_TYPE_COMPUTE = "compute";
    public static final String CATALOG_TYPE_IMAGE = "image";
    public static final String CATALOG_TYPE_VOLUME = "volume";
    public static final String CATALOG_TYPE_OBJECTSTORE = "object-store";
