...
<html>
<head>
	<title>Detail Admin Version-2 </title>
    ...
    <!-- libraries -->
    <link href="${resource(dir: 'css/gemini/css/lib/', file: 'jquery-ui-1.10.2.custom.css')}" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" href="${resource(dir: 'css/gemini/css/compiled/', file: 'index.css')}" type="text/css" media="screen" />
...
<!--    <link href='http://fonts.googleapis.com/css?family=Lato:300,400,700,900,300italic,400italic,700italic,900italic' rel='stylesheet' type='text/css' />-->
    ...
    <![endif]-->
    <script>
      require(["dojo/parser", "dijit/TitlePane","dijit/Menu",
            "dijit/MenuItem"]);    
    </script>
    <script>
     require(["dojo/parser",
...
<body>
        ...
        <div id="mainMenu" data-dojo-type="dijit.Menu">
            <ul id="dashboard-menu">
                ...
                <li class="active">
                    ...
                    <a href="index.html">
                        <div id="edit" data-dojo-type="dijit.MenuItem">
                            <i class="icon-home"></i>
                             <span >Home</span>
                        </div>
                    </a>
                ...
                <li>
                    <a class="dropdown-toggle" href="#">
                        <div id="users" data-dojo-type="dijit/TitlePane"  data-dojo-props="title: '   <span >Users</span>'">
    ...
    <script src="../Dojo_Toolkit/js/lib/dojo/dojo/dojo.js" type="text/javascript"></script>
