      ...
      <div class="loader" id="userLoader">
        <div class="loader-cont">
            <div>
                ...
                <g:else> 
                    <img height="49" width="133"  src="${resource(dir: 'images', file: 'geminiLogo.png')}" class="logo fogPanelLogo"/>
                    <img style="display: none;" src="${logoUrl}" class="logo fogPanelLogo" />               
                </g:else>
        ...
        <div class="logo_wrapper"> 
          <a class="brand" href="#/user/home">
            <g:if test="${logoUrl == ''}">                   
                ...
                <g:else>                 
                    <img height="49" width="133"  src="${resource(dir: 'images', file: 'geminiLogo.png')}" class="logo fogPanelLogo"/> 
                    <img style="display: none" src="${logoUrl}" class="fogPanelLogo" />                
                </g:else>          
          </a>
            <div style="display: none;" class="powered">Powered by <a title="FogPanel" href="http://www.fogpanel.com/" target="new">Gemini</a></div>
        </div>
