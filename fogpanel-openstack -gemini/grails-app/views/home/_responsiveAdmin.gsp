...
<html lang="${lang}">
    <head>
      ...
      <link rel="stylesheet" href="${resource(dir: 'js/dojo-1.8/dojox/grid/resources', file: 'classicGrid.css')}"  media="screen" type="text/css" />
      <link rel="stylesheet" href="${resource(dir: 'js/dojo-1.8/dojox/grid/enhanced/resources/classic', file: 'EnhancedGrid.css')}"  media="screen" type="text/css" />
      <link href='http://fonts.googleapis.com/css?family=Roboto' rel='stylesheet' type='text/css'>
      
     
      <!--<link href="../../../web-app/js/dojo-1.8/dojox/grid/resources/classicGrid.css" rel="stylesheet" type="text/css"/>-->
      <link href="" rel="stylesheet" type="text/css"/>
      <!--Styles By pradeep :: Begins Here-->
      
      <!--Bootstrap-3 Themes :: Begins Here-->
<!--     <link rel="stylesheet" href="${resource(dir: 'css/gemini/bootstrap-3/css/bootstrap', file: 'bootstrap.css')}"  media="screen" type="text/css" />
   <link rel="stylesheet" href="${resource(dir: 'css/gemini/bootstrap-3/css/bootstrap', file: 'bootstrap-overrides.css')}"  media="screen" type="text/css" />-->
      <!--Bootstrap-3 Themes :: Ends Here-->
...
<!--          <script type="text/javascript" src="${resource(dir: 'js/dojo-1.8/release/dojo/dojo')}/dojo.js"></script>
    ...
    <body class="classic">  
      ...
      <div class="account-type-cont" style="display: none;">
      ...
      <div class="navbar navbar-inverse">
        <div data-dojo-type="FogPanel.Navigator" id="templateNavigator">     
          ...
          <a class="brand" href="#/admin/dashboard">            
                <g:if test="${logoUrl == ''}">                   
                    <img src="${resource(dir: 'images', file: 'geminiLogo.png')}" class="fogPanelLogo" />                    
                </g:if>
                <g:else>                 
