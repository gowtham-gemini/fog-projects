<div class="row-fluid">
    <div class="new-user"> 
        <form data-dojo-type="dijit.form.Form" id="adminMiscNetworkReadSnapshotForm" class="form-horizontal span12">
            <div class="row-fluid">
                <div class="value_dollar pull-right"><g:message code="default.valueIn" /><span id="networkReadCurrencyValue"></span></div>  
            </div>
            <div class="row-fluid" id="networkReadSnapshotPriceLabelContainer">
            ...
            <div class="row-fluid">              
                <div class="span9 offset1">
                    <div id="networkReadMiscSnapshotCostInfo" class="span12"></div>          
                </div>                                    
            </div>  
            <div class="row-fluid" id="networkReadSnapUpdateActionButton">
            ...
            <div class="row-fluid">
                <div class="span12 hide_text" id="networkReadSnapshotZoneLoader">
...
<div data-dojo-type="dijit.Dialog" id="networkReadSnapshotEditConformationDialog" title="<g:message code="default.button.update.common" />" class="span4">
