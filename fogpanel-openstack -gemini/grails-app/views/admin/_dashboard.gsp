...
<!--Main Stats :: Begins Here-->
                
<div id="main-stats">
                <div class="row-fluid stats-row">
                    <div class="span4 stat">
                        <div class="data">
                            <sup id="dailyUsd">USD</sup>
                            <span class="number" id="totalDaily"></span>
                            <span class="pull-right"><g:message code="stat.billing.usageCost"/></span>
                        </div>
                        <i class="small"><span class="date small" id="dailyDate"></span></i>
                    </div>
                    
                    <div class="span4 stat">
                        <div class="data">
                            <sup id="monthlyUsd">USD </sup>
                            <span class="number" id="totalMonthly"></span>
                            <span class="pull-right"><g:message code="common.billing.currentMonthCost"/></span>
                            
                        </div>
                        <i class="small"><span class="date" id="monDate"></span></i>
                    </div>
                    
                    <div class="span4 stat last">
                        <div class="data">
                             <sup id="paymentUsd"> USD </sup>
                            <span id="totalPayment" class="number"></span>
                            <span class="pull-right"><g:message code="common.billing.currentMonthPayment"/></span>
                        </div>
                        <i class="small"><span class="date" id="monPayDate"></span></i>
                    </div>
                </div>
            </div>
        <!--Main Stats :: Ends Here-->
                        
<div class="row-fluid stat_cont configList" id="adminCostCheckListDiv" style="display: none;">
     <ul class="span12" >
         <li id="orgLi" style="display: none;" class="alert alert-block">
            <a href="#/admin/settings/organizationBilling" style="color: #e6250e;" class="item">
                <h4><i class="icon-warning-sign"></i><g:message code="common.orgBillingSetting.message"/></h4> 
            </a> 
        </li>
        <li id="domainLi" style="display: none;" class="alert alert-block">
            <a href="#/admin/domain" style="color: #e6250e;" class="item">
                <h4><i class="icon-warning-sign"></i><g:message code="common.domainConfig.message" /></h4>
            </a> 
        </li>
        <li id="openstackConfigLi" style="display: none;" class="alert alert-block">
            <a href="#/admin/settings/openstackConfig/" class="item" style="color: #e6250e;">
                <h4><i class="icon-warning-sign"></i><g:message code="common.openstackConfig.message" /></h4>
            </a> 
        </li>
        <li id="zenossConfigLi" style="display: none;" class="alert alert-block">
            <a href="#/admin/settings/zenoss" class="item" style="color: #e6250e;">
                <h4><i class="icon-warning-sign"></i> <g:message code="common.zenossConfig.message" /></h4>
            </a> 
        </li>
        <li id="regionLi" style="display: none;" class="alert alert-block">
            <a href="#/admin/settings/regionConfig/" class="item" style="color: #e6250e;">
                <h4><i class="icon-warning-sign"></i><g:message code="common.regionConfig.message" /></h4>
            </a> 
        </li>
        <li id="importData" style="display: none;" class="alert alert-block">
            <a class="item" href="#/admin/settings/importData" style="color: #e6250e;">
                <h4><i class="icon-warning-sign"></i><g:message code="common.importDataFromOpenstack" /></h4>
            </a>
        </li>
<!--        <li id="volumeTypeLi" style="display: none;">
        ...
        <li id="snapLi" style="display: none;" class="alert alert-block">
            <a href="#/admin/miscellaneous/snapshot" class="item">
              <h4><i class="index_title_icons_cldsnapshot"></i><g:message code="common.snapshot.message" /></h4>
            </a>  
        </li>
        <li id="vmsnapLi" style="display: none;" class="alert alert-block">
            <a href="#/admin/miscellaneous/vmSnapCost" style="color: #C09853;" class="item">
              <h4><i class="index_title_icons_cldsnapshot"></i><g:message code="common.VMSnapshot.message" /></h4>
            </a> 
        </li>
        <li id="ipLi" style="display: none;" class="alert alert-block">
            <a href="#/admin/miscellaneous/ipCost" style="color: #C09853;" class="item">
                <h4> <i class="index_title_icons_serv_miscel"></i>
<!--                <img src="images/popup-icons/ip_icon.png" style="margin-left: -13px;" width="50" height="30">-->
              <g:message code="common.ipCost.message" /></h4>
            </a> 
        </li>
        <li id="bandLi" style="display: none;">
            <a href="#/admin/miscellaneous/bandwidth" style="color: #C09853;" class="item">
                <h4><i class="index_title_icons_serv_miscel"></i>
                <g:message code="common.bandwidth.message"/></h4>  
             
            </a> 
        </li>
        <li id="firewallLi" style="display: none;">
            <a href="#/admin/firewall" class="item" style="color: #C09853;">
                <h4><i class="index_title_icons_cldfirewall"></i><g:message code="common.firewall.message" /></h4>
            </a> 
        </li>       
     </ul>
</div>
              ...
              <div class="row-fluid stat_cont configList">
                  <ul class="span12">
                      <li>
                          <a class="item">
