...
<ul class="breadcrumb">
    ...
    <li><a href="#/admin/infrastructure/cloud"><g:message code="menu.admin.cloud"/></a><span class="divider">/</span></li> 
    <li><a href="#/admin/infrastructure"><g:message code="menu.admin.cloud.infrastructure"/></a><span class="divider">/</span></li>
      <li><a href="#"><g:message code="menu.user.cloud.instance"/></a></li>
