...
<div class="row-fluid">
        <div class="row-fluid header">
            <h3 id="imagePagehead"></h3>   <div class="span2 value_dollar pull-right" style="display: none;"><g:message code="default.valueIn"/>  <span id="currencyValue"></span></div>
        </div>
            ...
            <div id="imageContent">
                <div class="row-fluid">
                    <div class="span12">
                     ...
                     <div class="row-fluid">
                        <div class = "control-group span4 customDisk" id="imageSourceDiv" style="display: block;">
                        ...
                        <div class="control-group span4 horizontalcontent" id="imageUrlDiv" style="display: block;">
                        ...
                        <div class="control-group span4 horizontalcontent" id="imageFileDiv" style="display: none;">
                            ...
                            <div class="control-group span4 customDisk" id="imagesArchDiv">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                            ...
                            <div class="span7 pull-right">
                                ...
                                <div id="imageUpdateButtonDiv" style="display: none;" class="span4">
                                ...
                                <div id="imageCancelButtonDiv" class="span4">
...
<div data-dojo-type="dijit.Dialog" class="full_loader" id="pullImageLoader" class="span6">
    <div class="row-fluid">
