...
<ul class="breadcrumb">
    ...
    <li><a href="#/admin/settings/openstack"><g:message code="menu.admin.configuration.openstack"/></a><span class="divider">/</span></li>
...
<div id="importDataFromOpenStack" style="display : block">
    ...
    <div class="row-fluid"> 
        ...
        <div class="row-fluid accquireip-form-boxcont" style="margin-top: 5px;">
            <div class="span12">
                <div class="span8" style="padding: 16px;">
                    <b><g:message code="common.network"/></b>
                </div>
                    <div class="span2 pull-right" style="margin-top: 10px;">
                        <button type="button" data-dojo-type= "dijit.form.Button" id="pullNetworkButton" class="cancelbtn" onclick="ImportDataFromOpenstack.confirmPullNetwork()" id="">
                                <g:message code="common.import"/>
                        ...
                        <button type="button" data-dojo-type= "dijit.form.Button" class="cancelbtn" onclick="ImportDataFromOpenstack.checkDataImportNetworkStatus()">
                            <g:message code="common.check"/>
                        </button>
                </div>
            </div> 
    ...
    <div data-dojo-type="dijit.Dialog" id="pullNetworkConform" class="span4">
        <div class="row-fluid">
            <!--<div class="span2"><img src='images/popup-icons/ip_icon.png'/></div>-->
            <div class="span10">
                <div class="span12"><p><g:message code='common.openstack.pullNetworkMessage' /></p></div>
                <div class="span12"><p class="alert alert-info"><g:message code='common.openstack.pullPlanMessageNote' /></p></div>
            </div>                                    
        </div>
        <div class="row-fluid">
            <button  type="button" class="primarybtn" data-dojo-type="dijit.form.Button" onclick="ImportDataFromOpenstack.pullNetwork()"><g:message code="common.ok"/></button>
            <button  type="button" class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="ImportDataFromOpenstack.cancelPullNetwork()"><g:message code="common.cancel"/></button>
        </div>
    </div>
    ...
    <div data-dojo-type="dijit.Dialog" id="pullAllDataConfirm" class="span4">
        <div class="row-fluid">
            <!--<div class="span2"><img src='images/popup-icons/ip_icon.png'/></div>-->
            <div class="span10">
                <div class="span12"><p><g:message code='common.openstack.pullAllDataMessage' /></p></div>
                <div class="span12"><p class="alert alert-info"><g:message code='common.openstack.pullAllDataMessageNote' /></p></div>
            </div>                                    
        </div>
        <div class="row-fluid">
    ...
    <div data-dojo-type="dijit.Dialog" id="pullRegionsConfirm" class="span4" style="display:none;">
        <div class="row-fluid">
            <!--<div class="span2"><img src='images/popup-icons/ip_icon.png'/></div>-->
            <div class="span10">
                <div class="span12"><p><g:message code='common.openstack.pullRegionMessage' /></p></div>
                <div class="span12"><p class="alert alert-info"><g:message code='common.openstack.pullRegionNote' /></p></div>
            </div>                                    
        </div>
        <div class="row-fluid">
    ...
    <div data-dojo-type="dijit.Dialog" id="pullDomainsConfirm" class="span4" style="display:none;">
        <div class="row-fluid">
            <!--<div class="span2"><img src='images/popup-icons/ip_icon.png'/></div>-->
            <div class="span10">
                <div class="span12"><p><g:message code='common.openstack.pullDomainMessage' /></p></div>
                <!--div class="span12"><p class="alert alert-info"><g:message code='common.openstack.pullRegionNote' /></p></div-->
            </div>                                    
        </div>
        <div class="row-fluid">
