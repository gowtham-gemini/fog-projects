    ...
    def pullNetworkFromOpenstack(jobid) {        
        ...
        try {   
            ...
            job.save(flush: true)  
                ...
                println("network Result 11" + networks)  
                
                for (OpenstackNetwork openstackNetwork : networks) {     
                    
                    println("OpenstackNetwork Result 11" + openstackNetwork)
                    ...
                    if(openstackNetwork.isRouterExternal() == true) {
                        ...
                        println("name"+openstackNetwork.getName())
                        println("****subnets result 3*****" + openstackNetwork.getSubnets())         
                        if(!network) {
