...
//                event.put("eventType", item.eventType);
    ...
    def getDefaultMailTemplateMap() {
        ...
        root.put("applicationUrl", ApplicationHolder.getApplication().config.openstack.applicationUrl);
        root.put("user", user);
        ...
        def logoUrl =  "" 
        if(logoConfig == "") {                                  
            logoUrl =  ApplicationHolder.getApplication().config.openstack.applicationUrl.toString() + "/images/fog_logo.png"
        } else {
