 ...
 *
 */
public class CreateGlobalLoadBalancerRuleResponse {

    /**
     * the global load balancer rule ID
     */
    private String globalLoadBalancerRuleId;
    ...
    public String getGlobalLoadBalancerRuleId() {
        return globalLoadBalancerRuleId;
    }

    public void setGlobalLoadBalancerRuleId(String globalLoadBalancerRuleId) {
        this.globalLoadBalancerRuleId = globalLoadBalancerRuleId;
    }
    ...
    public void setGlobalLoadBalancerRuleName(String globalLoadBalancerRuleName) {
        this.globalLoadBalancerRuleName = globalLoadBalancerRuleName;
    }
