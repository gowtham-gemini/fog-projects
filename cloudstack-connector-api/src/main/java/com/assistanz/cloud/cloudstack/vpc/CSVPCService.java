            ...
            for (int index = 0; index < list.getLength(); index++) {
                ...
                for (int childIndex = 0; childIndex < networkProperties.getLength(); childIndex++) {
                    ...
                    if (networkProperty.getNodeName().equals("id")) {
                        ...
                        network.setType(networkProperty.getTextContent());
                                ...
                                if (serviceProperty.getNodeName().equals("name")) {
                                    ...
                                    if (capabilityProperties.getLength() > 0) {
                                        ...
                                        for (int capabilityIndex = 0; capabilityIndex < capabilityProperties.getLength(); capabilityIndex++) {
                                            ...
                                            networkProperty = capabilityProperties.item(childIndex);
                                        }
                                    ...
                                    if (providerProperties.getLength() > 0) {
                                        ...
                                        for (int providerIndex = 0; providerIndex < providerProperties.getLength(); providerIndex++) {
                                            Node providerProperty = providerProperties.item(index);
        ...
        if (list.getLength() > 0) {
            for (int vpcIndex = 0; vpcIndex < list.getLength(); vpcIndex++) {
                ...
                for (int childIndex = 0; childIndex < vpcProperties.getLength(); childIndex++) {
                    ...
                    if (property.getNodeName().equals("id")) {
                        vpc.setId(property.getTextContent());
                    } else if (property.getNodeName().equals("account")) {
                        vpc.setAccount(property.getTextContent());
                                    ...
                                    if (serviceProperties.getLength() > 0) {
                                        ...
                                        for (int serviceIndex = 0; serviceIndex < serviceProperties.getLength(); serviceIndex++) {
                                            ...
                                            if (networkProperty.getNodeName().equals("name")) {
                                                service.setName(networkProperty.getTextContent());
                                            } else if (networkProperty.getNodeName().equals("capability")) {
                                                NodeList capabilityProperties = networkProperty.getChildNodes();
                                                if (capabilityProperties.getLength() > 0) {
                                                    CapabilityResponse capability = new CapabilityResponse();
...
//                        }
     ...
     * @throws Exception
     */
    public VpcJobResultResponse vpcJobResult(String asychronousJobid)
            throws Exception {
        ...
        return getVpcJobResultResponse(responseDocument);
    }

    /**
     * Converts XML document into VpcJobResultResponse object
     *
     * @param doc
     * @return
     */
    private VpcJobResultResponse getVpcJobResultResponse(Document doc) {
        VpcJobResultResponse response = new VpcJobResultResponse();
        ...
        if (list.getLength() > 0) {
            ...
            for (int index = 0; index < node.getLength(); index++) {
                ...
                if (nodeProperty.getNodeName().equals("vpc")) {
                    List<NetworkResponse> networks = new LinkedList<NetworkResponse>();
                    List<ServiceResponse> services = new LinkedList<ServiceResponse>();
                    List<CapabilityResponse> capabilities = new LinkedList<CapabilityResponse>();
                    List<ProviderResponse> providers = new LinkedList<ProviderResponse>();
                    ...
                    for (int childIndex = 0; childIndex < childNodeProperties.getLength(); childIndex++) {
                        ...
                        if (property.getNodeName().equals("id")) {
                            ...
                            response.setCidr(property.getTextContent());
                        } else if (property.getNodeName().equals("created")) {
                            response.setCreated(property.getTextContent());
                        } else if (property.getNodeName().equals("displaytext")) {
                            response.setDisplayText(property.getTextContent());
                        } else if (property.getNodeName().equals("domain")) {
                            ...
                            response.setNetworkDomain(property.getTextContent());
                        } else if (property.getNodeName().equals("project")) {
                            response.setProject(property.getTextContent());
                        } else if (property.getNodeName().equals("projectid")) {
                            response.setProjectId(property.getTextContent());
                        } else if (property.getNodeName().equals("restartrequired")) {
                            response.setRestartRequired(property.getTextContent());
                        } else if (property.getNodeName().equals("state")) {
                            response.setState(property.getTextContent());
                        } else if (property.getNodeName().equals("vpcofferingid")) {
                            response.setVpcOfferingId(property.getTextContent());
                        } else if (property.getNodeName().equals("zoneid")) {
     ...
     * @throws Exception
     */
    public VpcOfferingJobResultResponse vpcOfferingJobResult(String asychronousJobid)
            throws Exception {
        ...
        return getVpcOfferingJobResultResponse(responseDocument);
    }

    /**
     * Converts XML document into VpcOfferingJobResultResponse object
     *
     * @param doc
     * @return
     */
    private VpcOfferingJobResultResponse getVpcOfferingJobResultResponse(Document doc) {
        VpcOfferingJobResultResponse response = new VpcOfferingJobResultResponse();
        ...
        if (list.getLength() > 0) {
            ...
            for (int index = 0; index < node.getLength(); index++) {
                Node nodeProperty = node.item(index);
                if (nodeProperty.getNodeName().equals("vpcoffering")) {
                    List<ServiceResponse> services = new LinkedList<ServiceResponse>();
                    NodeList childNodeProperties = nodeProperty.getChildNodes();
                    for (int childIndex = 0; childIndex < childNodeProperties.getLength(); childIndex++) {
                        ...
                        if (childNodeProperty.getNodeName().equals("id")) {
                            ...
                            response.setDisplayText(childNodeProperty.getTextContent());
                        ...
                        } else if (childNodeProperty.getNodeName().equals("service")) {
                            NodeList serviceProperties = childNodeProperty.getChildNodes();
                            if (serviceProperties.getLength() > 0) {
                                ServiceResponse service = new ServiceResponse();
                                List<CapabilityResponse> capabilities = new LinkedList<CapabilityResponse>();
                                List<ProviderResponse> providers = new LinkedList<ProviderResponse>();
                                for (int serviceIndex = 0; serviceIndex < list.getLength(); serviceIndex++) {
                                    Node serviceProperty = serviceProperties.item(serviceIndex);
                                    if (serviceProperty.getNodeName().equals("name")) {
                                        service.setName(childNodeProperty.getTextContent());
                                    } else if (serviceProperty.getNodeName().equals("capability")) {
                                        NodeList capabilityProperties = serviceProperty.getChildNodes();
                                        if (capabilityProperties.getLength() > 0) {
                                            CapabilityResponse capability = new CapabilityResponse();
                                            for (int capabilityIndex = 0; capabilityIndex < capabilityProperties.getLength(); capabilityIndex++) {
                                                ...
                                                if (capabilityProperty.getNodeName().equals("canchooseservicecapability")) {
                                                    capability.setCanChooseServiceCapability(childNodeProperty.getTextContent());
                                                } else if (capabilityProperty.getNodeName().equals("name")) {
                                                    capability.setName(childNodeProperty.getTextContent());
                                                } else if (capabilityProperty.getNodeName().equals("value")) {
                                                    capability.setValue(childNodeProperty.getTextContent());
                                                }
                                            }
                                            capabilities.add(capability);
                                        }
                                        ...
                                        if (providerProperties.getLength() > 0) {
                                            ...
                                            for (int providerIndex = 0; providerIndex < providerProperties.getLength(); providerIndex++) {
                                                Node providerProperty = providerProperties.item(providerIndex);
                                                if (providerProperty.getNodeName().equals("id")) {
                                                    provider.setId(childNodeProperty.getTextContent());
                                                } else if (childNodeProperty.getNodeName().equals("canenableindividualservice")) {
                                                    provider.setCanEnableIndividualService(childNodeProperty.getTextContent());
                                                } else if (childNodeProperty.getNodeName().equals("destinationphysicalnetworkid")) {
                                                    provider.setDestinationPhysicalNetworkId(childNodeProperty.getTextContent());
                                                } else if (childNodeProperty.getNodeName().equals("name")) {
                                                    provider.setName(childNodeProperty.getTextContent());
                                                } else if (childNodeProperty.getNodeName().equals("physicalnetworkid")) {
                                                    provider.setPhysicalNetworkId(childNodeProperty.getTextContent());
                                                } else if (childNodeProperty.getNodeName().equals("servicelist")) {
                                                    provider.setServiceList(childNodeProperty.getTextContent());
                                                } else if (childNodeProperty.getNodeName().equals("state")) {
                                                    provider.setState(childNodeProperty.getTextContent());
                                                }
                                            }
                                            providers.add(provider);
                                        }
     ...
     * @throws Exception
     */
    public PrivateGatewayJobResultResponse privateGatewayJobResult(String asychronousJobid)
            throws Exception {
        ...
        return getPrivateGatewayJobResultResponse(responseDocument);
    }

    /**
     * Converts XML document into PrivateGatewayJobResultResponse object
     *
     * @param doc
     * @return
     */
    private PrivateGatewayJobResultResponse getPrivateGatewayJobResultResponse(Document doc) {
        PrivateGatewayJobResultResponse response = new PrivateGatewayJobResultResponse();
        ...
        if (list.getLength() > 0) {
            ...
            for (int index = 0; index < node.getLength(); index++) {
                Node nodeProperty = node.item(index);
                if (nodeProperty.getNodeName().equals("privategateway")) {
                    List<TagsResponse> tagss = new LinkedList<TagsResponse>();
                    NodeList childNodeProperties = nodeProperty.getChildNodes();
                    for (int childIndex = 0; childIndex < childNodeProperties.getLength(); childIndex++) {
                        Node childNodeProperty = childNodeProperties.item(childIndex);
                        ...
                        } else if (childNodeProperty.getNodeName().equals("sourcenatsupported")) {
                            response.setSourceNatSupported(childNodeProperty.getTextContent());
                        } else if (childNodeProperty.getNodeName().equals("state")) {
                            response.setState(childNodeProperty.getTextContent());
     ...
     * @throws Exception
     */
    public StaticRouteJobResultResponse staticRouteJobResult(String asychronousJobid)
            throws Exception {
        ...
        return getStaticRouteJobResultResponse(responseDocument);
    }

    /**
     * Converts XML document into StaticRouteJobResultResponse object
     *
     * @param doc
     * @return
     */
    private StaticRouteJobResultResponse getStaticRouteJobResultResponse(Document doc) {
        StaticRouteJobResultResponse response = new StaticRouteJobResultResponse();
        ...
        if (list.getLength() > 0) {
            ...
            for (int index = 0; index < node.getLength(); index++) {
                Node nodeProperty = node.item(index);
                if (nodeProperty.getNodeName().equals("staticroute")) {
                    List<TagsResponse> tagss = new LinkedList<TagsResponse>();
                    NodeList childNodeProperties = nodeProperty.getChildNodes();
                    for (int childIndex = 0; childIndex < childNodeProperties.getLength(); childIndex++) {
                        Node childNodeProperty = childNodeProperties.item(childIndex);
                        if (childNodeProperty.getNodeName().equals("id")) {
                            ...
                            response.setAccount(childNodeProperty.getTextContent());
                        } else if (childNodeProperty.getNodeName().equals("cidr")) {
                            response.setCidr(childNodeProperty.getTextContent());
                        } else if (childNodeProperty.getNodeName().equals("domain")) {
                            response.setDomain(childNodeProperty.getTextContent());
                        } else if (childNodeProperty.getNodeName().equals("domainid")) {
                            response.setDomainId(childNodeProperty.getTextContent());
                        } else if (childNodeProperty.getNodeName().equals("gatewayid")) {
                            response.setGatewayId(childNodeProperty.getTextContent());
                        } else if (childNodeProperty.getNodeName().equals("project")) {
                            response.setProject(childNodeProperty.getTextContent());
                        } else if (childNodeProperty.getNodeName().equals("projectid")) {
                            response.setProjectId(childNodeProperty.getTextContent());
        ...
        if (list.getLength() > 0) {
            for (int vpcOfferingIndex = 0; vpcOfferingIndex < list.getLength(); vpcOfferingIndex++) {
                ...
                for (int childIndex = 0; childIndex < vpcOfferingProperties.getLength(); childIndex++) {
                    ...
                    if (property.getNodeName().equals("id")) {
                        vpcOffering.setId(property.getTextContent());
                    } else if (property.getNodeName().equals("created")) {
                        ...
                        vpcOffering.setName(property.getTextContent());
                    } else if (property.getNodeName().equals("state")) {
                        ...
                        if (serviceProperties.getLength() > 0) {
                            ServiceResponse service = new ServiceResponse();
                            for (int serviceIndex = 0; serviceIndex < serviceProperties.getLength(); serviceIndex++) {
                                property = serviceProperties.item(serviceIndex);

                                if (property.getNodeName().equals("name")) {
                                    service.setName(property.getTextContent());
                                    services.add(service);
                                } else if (property.getNodeName().equals("provider")) {
                                    Node providerProperties = property.getFirstChild();
