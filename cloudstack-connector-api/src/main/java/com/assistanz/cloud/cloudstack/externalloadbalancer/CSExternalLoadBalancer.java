...
public class CSExternalLoadBalancer {
    ...
    private AddExternalLoadBalancerResponse getAddExternalLoadBalancerResponse(Document doc) {
        ...
        if (list.getLength() > 0) {
            ...
            response.setExternalLoadBalancerId(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setNumRetriesExternalLoadBalancer(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalLoadBalancerPrivateInterface(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalLoadBalancerPublicInterface(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalLoadBalancerUserName(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalLoadBalancerZoneId(node.getTextContent());
        }
    ...
    private ListExternalLoadBalancersResponse getListExternalLoadBalancersResponse(Document doc) {
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostAverageLoad(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostCapabilities(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostClusterId(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostClusterName(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostClusterType(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostCpuAllocated(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostCpuNumber(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostCpuSpeed(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostCpuUsed(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostCpuWithOverProvisioning(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostCreatedDate(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostDisconnected(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostDiskSizeAllocated(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostDiskSizeTotal(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostEvents(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostHypervisor(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostIpAddress(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostManagementServerId(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostMemoryAllocated(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostMemoryTotal(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostMemoryUsed(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostNetworKbbsRead(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostNetworKbbsWrite(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostOsCategoryId(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostOsCategoryName(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostPodId(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostPodName(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostRemovedDate(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostResourceState(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostSate(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostType(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostVersion(node.getTextContent());
        }
        // get zoneid from XML and set as user Time Zone
        list = doc.getElementsByTagName("zoneid");
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostZoneId(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setHostZoneName(node.getTextContent());
        }
