...
public class CSExternalFirewallService {
    ...
    private AddExternalFirewallResponse getAddExternalFirewallResponse(Document doc) {
        ...
        if (list.getLength() > 0) {
            ...
            response.setExternalFirewallId(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallIpAddress(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setNumRetriesExternalFirewall(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallPrivateInterface(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallPrivateZone(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallPublicInterface(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallPublicZone(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallTimeout(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallUsageInterface(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallUserName(node.getTextContent());
        }
        ...
        if (list.getLength() > 0) {
            Node node = list.item(0);
            response.setExternalFirewallZoneId(node.getTextContent());
        }
