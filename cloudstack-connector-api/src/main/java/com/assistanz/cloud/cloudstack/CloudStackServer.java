...
public class CloudStackServer {
    ...
    private static final Log logger = LogFactory.getLog(CloudStackServer.class);

    /**
     * Creates a new Server Instance that could connect to the specified URL, with the provided key and secret
     *
     * @param apiURL
     * @param secret
     * @param apikey
...
//         System.out.println(method.getPath());
    ...
    private void CloudStackException(Exception e) {
