...
public class CSTemplateService {
     ...
     * featured-templates that are featured and are public* self-templates that have been registered/created by the
     * owner* selfexecutable-templates that have been registered/created by the owner that can be used to deploy a new
     * VM* executable-all templates that can be used to deploy a new VM* community-templates that are public.
     * @param optional
     * @return
     * @throws Exception
     */
            ...
            for (int index = 0; index < list.getLength(); index++) {
                ...
                for (int childIndex = 0; childIndex < templateProperties.getLength(); childIndex++) {
                    ...
                    if (property.getNodeName().equals("id")) {
                        template.setId(property.getTextContent());
                    } else if (property.getNodeName().equals("account")) {
                        template.setAccount(property.getTextContent());
                        ...
                        template.setCreated(property.getTextContent());
                        ...
                        template.setDisplayText(property.getTextContent());
                    } else if (property.getNodeName().equals("domain")) {
                        template.setDomain(property.getTextContent());
                        ...
                        template.setFormat(property.getTextContent());
                        ...
                        template.setIsDynamicallyScalable(property.getTextContent());
                        ...
                        template.setName(property.getTextContent());
                        ...
                        template.setProject(property.getTextContent());
                        ...
                        template.setProjectId(property.getTextContent());
                        ...
                        template.setSize(property.getTextContent());
                        ...
                        template.setSshKeyEnabled(property.getTextContent());
                    } else if (property.getNodeName().equals("status")) {
                        template.setStatus(property.getTextContent());
                        ...
                        template.setZoneId(property.getTextContent());
                    } else if (property.getNodeName().equals("zonename")) {
                        template.setZoneName(property.getTextContent());
    ...
    private ListTemplatePermissionsResponse getListTemplatePermissionsResponse(Document doc) {
        ...
        // List template visibility and all accounts that have permissions to view this template
        NodeList list = doc.getElementsByTagName("templatepermission");
        List<TemplatePermissionResponse> templatePermissions = new LinkedList<TemplatePermissionResponse>();

        if (list.getLength() > 0) {
            for (int index = 0; index < list.getLength(); index++) {
                Node templatePermissionNode = list.item(index);

                TemplatePermissionResponse templatePermission = new TemplatePermissionResponse();

                NodeList templatePermissionProperties = templatePermissionNode.getChildNodes();
                for (int childIndex = 0; childIndex < templatePermissionProperties.getLength(); childIndex++) {
                    Node property = templatePermissionProperties.item(childIndex);

                    if (property.getNodeName().equals("id")) {
                        templatePermission.setId(property.getTextContent());
                    } else if (property.getNodeName().equals("account")) {
                        templatePermission.setAccount(property.getTextContent());
                    } else if (property.getNodeName().equals("domainid")) {
                        templatePermission.setDomainId(property.getTextContent());
                    } else if (property.getNodeName().equals("ispublic")) {
                        templatePermission.setIsPublic(property.getTextContent());
                    } else if (property.getNodeName().equals("projectids")) {
                        templatePermission.setProjectIds(property.getTextContent());
                    }
                }
                templatePermissions.add(templatePermission);
            }
        }

        response.setTemplatePermissions(templatePermissions);
        return response;
    ...
    /**
     * Converts XML document into TemplateJobResultResponse object
     *
     * @param doc
     * @return
     */
                ...
                if (nodeProperty.getNodeName().equals("template")) {
                    ...
                    for (int childIndex = 0; childIndex < childNodeProperties.getLength(); childIndex++) {
                        ...
                        if (childNodeProperty.getNodeName().equals("id")) {
                            ...
                            response.setFormat(childNodeProperty.getTextContent());
                        ...
                        } else if (childNodeProperty.getNodeName().equals("isdynamicallyscalable")) {
                            response.setIsDynamicallyScalable(childNodeProperty.getTextContent());
                        ...
                        } else if (childNodeProperty.getNodeName().equals("sshkeyenabled")) {
                            response.setSshKeyEnabled(childNodeProperty.getTextContent());
