...
public class ZenossFacade {
    ...
    public ZenossFacade(String endPointURL, String userName, String password) throws ApplicationException {
        System.out.println("***New connection Created from zenoss***");
        RestServiceHandler restServiceHandler = RestServiceFactory.getHttpClient(endPointURL, userName, password);
