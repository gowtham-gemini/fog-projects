                    ...
                    'formatter': function(data) {
                        ...
                        if(data) {
                             html = "<a href='#/admin/flavors/edit/"+data.referenceId+"' title='"+translator.common.edit+"'><i class='icon-edit'></i></a>" +                                      
                                    "<a class='offset1' title='"+translator.common.disable+"' onclick='ComputaionListInfo.disablePlan("+data.referenceId+")'><i class='icon-eye-close'></i></a></li>"+
                             ...
                             html = "<a href='#/admin/flavors/edit/"+data.referenceId+"' title='"+translator.common.edit+"'><i class='icon-edit'></i></a>" +                                       
                                    "<a class='offset1' title='"+translator.common.enable+"' onclick='ComputaionListInfo.enablePlan("+data.referenceId+")'><i class='icon-eye-open'></i></a></li>" + 
