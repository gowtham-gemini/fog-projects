...
var IPServices =  {
    populateValues : function () {        
        ...
        dojo.byId("ipServiceGridNode").innerHTML = "<img src='images/vmload.gif' alt='"+translator.common.loader.imageLoadError+"' height='36' width='100'/> </br> <p>"+translator.user.loader.sshKeyLoader+"</p>";         
        ...
        var gridLayout = [
            [
                ...
                {'name': translator.common.monitored, 'field': 'monitored', 'width': '100%', datatype:"string",  autoComplete: true, 'formatter': function(data) {
                        var checkBoxElement = new dijit.form.CheckBox({
    ...
    'populateValues': function() {                
           ...
           var gridLayout = [
               [
                ...
                {'name': translator.common.size.sizeName, 'field': 'plan', 'width': '200px', datatype:"string",  autoComplete: true,'formatter': function(data) {                                                                      
                         return  "<span class='bold'>" + data.name + "|"+ data.memory+ " MB RAM " + "|" +data.vcpus+" VCPU |"+data.rootgb+" GB Disk "+ "</span>";
                     }
                },
