databaseChangeLog = {
	...
	changeSet(author: "lakshmi (generated)", id: "1412148545335-18") {
		createTable(tableName: "payments") {
			...
			column(name: "gateway_name", type: "longtext")

			column(name: "manual_payment_code", type: "longtext")

			column(name: "payment_date", type: "datetime") {
				constraints(nullable: "false")
			}

			column(name: "payment_load", type: "longtext")

			column(name: "payment_status", type: "longtext")
