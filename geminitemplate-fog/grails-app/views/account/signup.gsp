    ...
    <div class="row">
      ...
      <div class="row login-wrapper">
        <div id="wrapper" class="col-md-12">
          ...
          <div class="wizard_container col-md-6 welcome_wiz">
            <div class="row">
                          ...
                          <div class="row">
                              <div class="control-group col-md-9"> 
                                  ...
                                  <div class="controls">
                                      ...
                                      name="userName" id="userName" value="${invitationName}" onblur="app.signup.validateUserName(this)"> 
                                  </div>
                              </div> 
                          </div>
                <!--<div class="row">-->
...
<!--                    <div class="controls">
                  ...
                  <!--</div>-->
<!--                  <div class="col-md-3 validationErrorMsg" id="emailValidateMsg">
            ...
            <div data-dojo-type="dojox.widget.WizardPane" id="wizard_page_2" 
              ...
              <div class="control-group col-md-9"> 
                ...
                <div class="col-md-3 validationErrorMsg" id="countryErrorMsg">
            ...
            <g:else>
              <div class="row">
                ...
                <g:if test="${accountType.equals("RETAIL") && cardRequired.equals("TRUE")}">
                    <div class="row" id="creditCardPage"> 
                      <div id="cardDetails">
                        <div class="row">
                          <div class="control-group col-md-9"> 
                        ...
                        <div class="row">
                          <div class="control-group col-md-9"> 
                            ...
                            <div class="controls">
                                ...
                                <div class="col-md-4"><div id="newYearList"></div></div>
                            </div>
                          </div>
                        </div>                        
                      </div>      
              ...
              <div class="element terms">
                ...
                <label for="agreement" class="col-md-4"><g:message code="signup.acceptThe"/>
              ...
              <div data-dojo-type="dijit.Dialog"  id="dialog" style="height: 400px;" title="<g:message code="signup.termsAndConditions"/>" class="customDialog col-md-8">
