   ...
   <body class="invoice_frame">	
       <div class="row">
           <div class="col-md-3">
                ...
                <div style="text-align:center;" class="col-md-3 duedate_cont"><g:message code="common.asOnDate"/>:${invoiceDate}</div>
        ...
        <g:else>
            <div class="invoice_pricebox_ui">
                ...
                <ul>
                    <li class="prev-bal">
                        <div class="row amtvalue"><g:formatNumber number="${invoice.previousBalance}" format="0.00"/></div>
                        <g:message code="common.billing.prevBalance"/>
                    </li>
                    <li class="payment">
                        <div class="row amtvalue"><g:formatNumber number="${invoice.payment}" format="0.00"/></div>
                    ...
                    <g:else>
                        <li class="credit">
                            <div class="row amtvalue"><g:formatNumber number="${refund}" format="0.00"/></div>
                            <g:message code="menu.admin.billing.refund"/>
                        </li>
                    </g:else>
                        <li class="curr-chrg">
                            <div class="row amtvalue"><g:formatNumber number="${invoice.currentDue}" format="0.00"/></div>
                            <g:message code="menu.admin.billing.currentCharge"/>
                        </li>
                        <li class="total-pay">
                            <div class="row amtvalue"><g:formatNumber number="${Math.ceil((totalAmount - userAccount.credit) * 100d) / 100d}" format="0.00"/></div>
                        ...
                        <div class="row current-usage-info-cont">
                            <div class="col-md-12" style="position:relative">
                                <div class="col-md-3 current-usage-info-zone">
                                    <ul>
                                        ...
                                        <g:each in="${zoneCost}"> 
                                            <div class="col-md-3 current-usage-info-vms" style="display:none;" id="${it.zoneCount}">
                                                <ul>
                                        ...
                                        <g:each in="${zoneCost}"> 
                                            <g:each in="${it.billableItem}"> 
                                                <div class="col-md-6 current-usage-info-vms-desc" style="display:none;" id="${it.billableItemCount}">
                                                    <ul>
                                                        ...
                                                        <div class="cuinfo-vms-desc-table">
                                                            <div class="divTable">
                                                                <div class="divTableRow_title">
                                                                    ...
                                                                    <div class="divTableCell"><g:message code="common.itemPlan"/></div>
                                                                    <div class="divTableCell"><g:message code="common.units"/></div>
                                                                    <div class="divTableCell"><g:message code="common.qty"/></div>
                                                                    <div class="divTableCell"><g:message code="common.totalAmount"/></div>
                                                                </div>
