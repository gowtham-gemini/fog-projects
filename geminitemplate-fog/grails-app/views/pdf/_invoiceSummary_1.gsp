...
<!--    <link rel="stylesheet" type="text/css" href="${resource(dir: 'css/', file: 'invoice.css')}" media="all"/>-->
    <style type="text/css" media="all">
            ...
            */	-webkit-border-radius: 8px;
            ...
            .content .resultContent .mainContent col-md- {
                float: right;   
                padding: 5px;
                /*font-size: 12px;*/
            }
            ...
            .content .rigthContent .invoiceDetails .col-md-Container col-md- {
                display: block;
                font-size: 10px;
                text-align: right;
                font-family: sans-serif;
            ...
            .content .rigthContent .invoiceDetails .bottomBorder col-md- {
            ...
            .content .rigthContent .invoiceDetails .col-md-Container {
                width: 120px;
                float: left;
            }
  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="rigthContent">
        ...
        <div class="invoiceDetails">
          ...
          <div class="col-md-Container bottomBorder"> 
    ...
    <div class="content" style="margin-top: 160px;">
      ...
      <div class="rigthContent">
        <div class="invoiceDetails">
          ...
          <div class="col-md-Container"> 
             <span >${invoice.previousBalance}</span>
          </div>
        </div>
        <div class="invoiceDetails">
          <div class="labelContaicer">
        ...
        <div class="invoiceDetails">
          <div class="labelContaicer">
            <label class="control-label">Current Charge(+)</label>
          </div>
          <div class="col-md-Container">
             <span >${invoice.currentDue}</span>
          </div>
        </div>
        <div class="invoiceDetails">
          <div class="labelContaicer bottomBorder">
            <label class="control-label" style="font-weight: bold">TOTAL PAYABLE</label>
          </div>
          <div class="col-md-Container bottomBorder">
             <span   style="font-weight: bold">${invoice.totalAmount}</span>
          </div>
        </div>
      </div>
    </div>
    <div class="content">
      ...
      <p>You are responsible for any fees until your account is formally closed.</p>
      <p>A late fee of ${lateFee} will be assessed if payment is not received by the due date.</p>
    </div>
    <div class="content">
      <h6>Charges for this Invoice:</h6>
      <table class="sample_table">
        <tr>
          <th style="width: 200px;">Service offered</th>
          <th>Unit</th>
          <th>UnitPrice</th>
          <th>Qty</th>
          <th>Price</th>
        ...
        <g:each in="${invoiceItemList}">
          <tr>
          <td class="leftAlign">${it.itemName}</td>
          <td>${it.units}</td>
          <td>${it.usageUnitPrice}</td>
          <td>${it.usageUnits}</td>
          <td>${it.usageAmount}</td>
    ...
    <div class="content">
      <div class="resultContent offset2">
        <label class="">Total Balance for this Invoice:</label>
        <div class="mainContent">
           <span  class="">${invoice.totalAmount}</span>
        </div>
      </div>
    </div>
    <div class="content">
