...
<html>
    <head>
      ...
      <title>Report For Payment Pending</title>
...
<body>
  <div class="report-filter-sec">
    <g:if test="${params.forDateRange.equals("SELECTIVE")}">
        <div>  <span ><g:message code="common.dateRange"/>:</span> ${params.fromDate} - ${params.toDate} </div>
    </g:if>
    <g:else>
      ...
      <table class="fogpanel_report_widget" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <th><g:message code="common.pendingAmount"/></th>
        </tr>
        <g:each in="${paymentList}">
          <tr>
            <td>${it.accountId}</td>
