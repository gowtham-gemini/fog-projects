<html>
  <head>
    ...
    <table class="code_table">
      ...
      <tbody>
        <tr><td colcol-md-="3"><em>URL method examples:</em></td></tr>
        <tr>
          <td rowcol-md-="2" >Simple Usage:</td>
          <td>
        ...
        <tr>
          <td rowcol-md-="2" >Simple Usage:</td>
          <td>
            <code>&lt;g:pdfLink url="/pdf/list"&gt;PDF View&lt;/g:pdfLink&gt;</code>
          </td>
          <td rowcol-md-="2">
            <g:pdfLink url="/pdf/list">List</g:pdfLink>
          </td>
        </tr>
        <tr>
          <td rowcol-md-="2" >Simple Usage:</td>
          <td>
            <code>&lt;g:pdfLink url="/pdf/invoiceSummary"&gt;PDF View&lt;/g:pdfLink&gt;</code>
          </td>
          <td rowcol-md-="2">
            <g:pdfLink url="/pdf/invoiceSummary">invoiceSummary</g:pdfLink>
          </td>
        </tr>
        ...
        <tr>
          <td rowcol-md-="2" >Simple Usage w/ Get data:</td>
          <td>
        ...
        <tr>
          <td rowcol-md-="2" >Custom filename</td>
          <td>
        ...
        <tr>
          <td rowcol-md-="2">Bundled icon</td>
          <td>
        ...
        <tr>
          <td rowcol-md-="2">Bundled icon w/ link content</td>
          <td>
        ...
        <tr><td colcol-md-="3"><em>String method examples:</em></td></tr>
  %{--  <tr>
          <td rowcol-md-="2" >Simple Template Usage:</td>
          <td>
        ...
        <tr>
          <td rowcol-md-="2" >Simple Controller Action Usage (action and id are optional):</td>
          <td>
            <code>&lt;g:pdfLink pdfController="pdf" pdfAction="demo2"&gt;GSP as PDF&lt;/g:pdfLink&gt;</code>
          </td>
          <td rowcol-md-="2">
            <g:pdfLink pdfController="pdf" pdfAction="DTLDemo">GSP asdgdsf PDF</g:pdfLink>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          <td rowcol-md-="2" >Simple Controller Action + Id Usage:</td>
          <td>
    ...
    <table class="code_table">
      ...
      <tbody>
        <tr><td colcol-md-="3"><em>GET method examples:</em></td></tr>
        <tr>
          <td rowcol-md-="2" >Simple Usage:</td>
          <td>
        ...
        <tr>
          <td rowcol-md-="2" >w/ Id and Filename:</td>
          <td>
        ...
        <tr><td colcol-md-="3"><em>POST method examples:</em></td></tr>
        <tr>
          <td rowcol-md-="2" >Controller and Action:</td>
          <td>
        ...
        <tr>
          <td rowcol-md-="2" >Controller, Action, Id and Filename:</td>
          <td>
            <code>&lt;g:pdfForm controller="pdf" action="demo3" method="post"&gt;...&lt;/g:pdfForm&gt;</code>
          </td>
          <td rowcol-md-="2">
        ...
        <tr>
          <td rowcol-md-="2" >Template and Filename:</td>
          <td>
