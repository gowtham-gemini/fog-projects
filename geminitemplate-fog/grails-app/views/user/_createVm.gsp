...
<div class="new-user createVm"> 
  ...
  <div class="row form-wrapper">
    <!-- left column -->
	<div class="col-md-3 createvm-banner">
    ...
    <div class="col-md-6 createvm-form with-sidebar">
      <div class="container">
          <form class="form-horizontal" data-dojo-type="dijit.form.Form" id="createVMForm"> 
            <div id="createVMPage">
              ...
              <div class="col-md-12 field-box control-group" style="margin-top: 10px">
              ...
              <div class="col-md-12 field-box control-group" id="vmTemplateNameInfo">
            ...
            <div class="col-md-12 field-box control-group">
             ...
             <div class="col-md-12 field-box control-group hide_text" id="billingTypeDiv">
     ...
     <div class="col-md-3" id="offeringInfo">
      <div class="new_user_form inline-input">     
        <div class="row">    
            <!--<div class="col-md-4"><a onclick=""><g:message code='common.rateCard' /></a><g:render template="rateCard" /></div>-->
            <div  class="col-md-6 create_vm_cost offset7"><div class="value_dollar"><g:message code="default.valueIn"/> <span  id="createVMCurrecy" style="color: #374859; float: none"></span></div></div>             
        </div>
        <div class="row customLabel" id="imageDataInfo">
            <div class="col-md-12">
          ...
          <div class="row customLabel" id="flavorInfo">
            <div class="col-md-12">
            ...
            <div class="col-md-12 hide_text" id="flavorMonDiv">
              <label><g:message code="common.monthly"/>:</label>
               <span  id="monthlyFlavorCost"></span>
            </div> 
          </div>                     
                         
        <div class="row customLabel" id="vmAvgCostInfo">   
            <div class="col-md-12">
        ...
        <div class="row customLabel" id="summaryInfo">
          <div class="col-md-12">
...
<div data-dojo-type="dijit.Dialog" id="createVMLoading" title="<g:message code='common.vm.buildingVM' />" style="color: black;" class="customDialgue col-md-6">
      <div class="row">
          <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
          <div class="col-md-9">
              <div class="col-md-12"><p><g:message code='common.vm.buildingVMMsg1' /></p></div>
              <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.vm.buildingVMMsg2' /></p></div>              
          </div>          
      </div>
    <div class="row">        
...
<div data-dojo-type="dijit.Dialog" title="<g:message code="common.summary"/>" id="vmSummaryPage" class="customDialgue">
  <div  class="new-user col-md-6">
    ...
    <div class="row form-wrapper">
    <!-- left column -->
    <div class="col-md-12" id="vmSummaryForm">
      <div class="container">        
        <form class="new_user_form inline-input" data-dojo-type="dijit.form.Form">                              
          <div class="row summaryInfoWrapper">
            <div class="col-md-12">
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12" id="summaryAvgCostInfo">
            <label><g:message code="common.cost"/></label>
             <span  id="summaryImageCost"></span>
          </div>
          <hr>           
          </div>         
          <div class="row summaryInfoWrapper" id="summaryFlavorInfo">
            <div class="col-md-12">
              <!--<div class="col-md-6">-->
                 <h3><g:message code="common.flavorInfo"/></h3> 
              <!--</div>-->   
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-5">
              ...
              <div class="col-md-12 hide_text" id="flavorAvgMonthlyCost">
            <div class="col-md-7">
                <div class="col-md-12">
                    <label><g:message code="common.monthly"/>:</label>
...
<!--            <div class="col-md-5">
                <div class="col-md-12 hide_text" id="sumBandwidthCost">
