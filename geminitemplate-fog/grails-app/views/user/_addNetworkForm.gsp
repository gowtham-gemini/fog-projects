                ...
                <div class="container">
                    <form id="adminNetworkAddForm" data-dojo-type="dijit.form.Form" class="form-horizontal">
                        ...
                        <!--<div class="row">-->      
                            ...
                            <div class="col-md-12 field-box control-group hide_text" id="networkBillingTypeDiv">
...
<!--                            <div class="col-md-9"></div>-->
                            <div class="col-md-12 field-box">
                                ...
                                <div id="networkCancelButtonDiv" class="col-md-4 pull-right">
                                    <button id="networkCancelButton"  data-dojo-type="dijit.form.Button" onclick="Networks.cancel()" class="cancelbtn">
                                        <g:message code="common.cancel"/>
                                    </button>
                                </div>
                                <div id="networkAddButtonDiv" class="col-md-2 pull-right" style="display: block;" >
                                    <button   id="networkAddButton"  data-dojo-type="dijit.form.Button" onclick="NetworkInfo.add()" class="okbtn">
                                        <g:message code="common.ok"/>
                                    </button>
                                </div>        
                                <div id="networkUpdateButtonDiv" style="display: none;" class="col-md-2 pull-right">
            ...
            <div class="col-md-3 offeringInfo">
                <div class="new_user_form inline-input">     
                  <div class="row">    
                      ...
                      <div  class="col-md-6 create_vm_cost offset6"><div class="value_dollar"><g:message code="default.valueIn"/> <span  id="createVolumeCurrecy" style="color: #374859; float: none"></span></div></div>             
                  </div>
                  <div class="row costInfoDesign" id="networkInfo">
                      <div class="col-md-12">
                          <h3><g:message code="common.networkInfo"/></h3>
                      </div>
                      <div class="col-md-12">       
                          <label><g:message code="common.network"/>:</label>
                           <span  id="networkCost"></span>
                      </div>
                        <div class="col-md-12 hide_text" id="networkMonthCostDiv">       
                          <label><g:message code="common.monthCost"/>:</label>
                           <span  id="networkMonthCost"></span>
                      </div>
                      <div class="col-md-12">
                        <label><g:message code="common.bandwidthRead"/>:</label>
                         <span  id="bandwidthRead"></span>
                      </div>
                      <div class="col-md-12">
                        <label><g:message code="common.bandwidthWrite"/>:</label>
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="pullNetworkLoader">
    <div class="row">
        <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
        <div class="col-md-9">
            <div class="col-md-12"><p><g:message code='common.createNetworkInfoOne' /></p></div>
            <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.createNetworkInfoTwo' /></p></div>              
        </div>          
    </div>
    <div class="row">        
