...
<div class="row form-wrapper" id="pad-wrapper">
  ...
  <div class="col-md-6" id="creditCardPage"> 
        ...
        <div id="cardDetails">
          ...
          <div class="col-md-12 control-group field-box">
              ...
              <div class="controls">
                  ...
                  <div class="col-md-1 offset3" style="margin-left: 10px;">
...
<div data-dojo-type="dijit.Dialog" id="cardVerifyLoader" class="col-md-6">
  <div class="row" id="processCardVerifyMessage" style="display: block">
    <img src="images/configLoader.gif" class="col-md-1 spacing"/>
    <p class="message col-md-10"> <g:message code="user.verify"/></p>
  </div>
