  ...
  <div class="row form-wrapper">
    ...
    <div class="col-md-3">
      <div class="new_user_form inline-input">
        ...
        <div class="col-md-12 field-box validationErrorMsg" id="passwordValidateMsg">
...
<div class="row" id="accountProfilePage">
            ...
            <div class="control-group generalContents">
             ...
             <div class="control-group generalContents">
               ...
               <div class="controls">
                 ...
                 <div id="profileCountry" class="hide_lable col-md-4"></div>
             ...
             <div class="control-group generalContents">
               ...
               <div class="controls">
                 ...
                 <div class="hide_lable col-md-4" id="profileState"></div>
               </div>
             </div>
             <div class="control-group generalContents">
  ...
  <div class="col-md-3 rectContainerMedium">
  </div>
  <div class="row"><a class="offset1">Upload Your Photo</a></div>
</div>
