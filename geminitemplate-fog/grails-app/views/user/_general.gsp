...
<div class="row form-wrapper overflow-text">
    <div class="col-md-12">
        <div class="col-md-4 generalPage">
            <div class="row">
...
<!-- left column -->
            <div id="generalPage">
                <form data-dojo-type="dijit.form.Form" id="generalForm" class="form-horizontal">
                    ...
                    <div class="col-md-12 control-group field-box">
                        <label for="accountIdentifier"><g:message code="common.userName"/>:</label>
                        <div class="controls">
                            <input type="text" data-dojo-type="dijit.form.ValidationTextBox" 
                            data-dojo-props="disabled:true" 
                            name="accountIdentifier" id="accountIdentifier"> 
                        </div>
                    </div>
                    <div class="col-md-12 control-group field-box">
                        <label for="domainName"><g:message code="common.domain"/>:</label>
                        <div class="controls">
                            <input type="text" data-dojo-type="dijit.form.ValidationTextBox" 
                            data-dojo-props="disabled:true" 
    ...
    <!--    <div class="col-md-3">
          <div class="new_user_form inline-input">
            ...
            <div class="col-md-12 field-box" id="billingPeriodDaysDescriptionContainer">
               <span  id="editTaxPercentageLabel">The allocated Percentage(%) of the tax</span>
            </div>
      </div>
                    </div>-->
        <div class="col-md-4 billingPage">
            <div class="row">
            ...
            <div id="billingPage">
                <form class="form-horizontal" data-dojo-type="dijit.form.Form" id="billingForm">              
                    ...
                    <div class="col-md-12 control-group field-box">
                        <label for="email" class="control-label"><g:message code="common.email"/>: <span  class="require">*</span></label>
                        <div class="controls">
    ...
    <!--     <div class="col-md-3">
        ...
        <div class="col-md-4 profilePage overflow-text">
            <div class="row">
