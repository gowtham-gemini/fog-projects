...
<div class="row" id="accountContactPage">
  
  <div data-dojo-type="dijit.layout.TabContainer" id="contactTabContainer"
       class="col-md-12" style="height: 400px;" onClick="">
           ...
           <form class="form-horizontal" data-dojo-type="dijit.form.Form" 
             ...
             <div class="control-group generalContents">
               ...
               <div class="controls ">
                 ...
                 <div class="hide_lable col-md-4" id="contactCountry"> </div>            
               </div>
             ...
             <div class="control-group generalContents">
               ...
               <div class="controls ">
                 ...
                 <div class="hide_lable col-md-4" id="contactState"> </div>             
               </div>
