...
<div class="col-md-8 with-sidebar" id="updateRecurringItemPage">
<div class="container">
    <form id="manualPaymentForm" data-dojo-type="dijit.form.Form" class="form-horizontal">        
        <div class="col-md-12 field-box control-group" id="paymentGateways">
        ...
        <div id="paypalDiv">
            ...
            <div class="" id="manualPaymentPage">                 
              <div id="payAmountDiv" class="col-md-12 field-box control-group">
    ...
    <div class="row container">
        <form data-dojo-type="dijit.form.Form" id="ccAvenuPaymentForm" class="form-horizontal">
            <div class="" id="ccAvenuePage">                
                ...
                <div class="row">
                    <div style="margin-left: -100px;" class="col-md-1"></div>
                    <div class="col-md-10 field-box control-group" id="ccAvenuePaymentBank"> 
