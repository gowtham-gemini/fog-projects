...
<div class="row" id="pad-wrapper">
    <form class="form-horizontal" id="sshKeyForm" data-dojo-type="dijit.form.Form">
        ...
        <div class="col-md-4" id="createSSHKeyBtnDiv">
        ...
        <div class="col-md-4" id="sshKeyLoader" style="display: none"> 
            <img src='images/preloader_circle.gif' alt='Loading' height='16' width='23'/>
        </div>
        </div>
      </form> 
</div>
<div class="row form-wrapper" id="pad-wrapper"></div>
...
<div data-dojo-type="dijit.Dialog" id="privateKeyDialog" title="" class="col-md-8">
    <div class="form-horizontal">
        <input type="hidden" id="sshId">
        <div class="row">
        <textarea class="col-md-12" rows="15" cols="200" id="sshPrivateKey"></textarea>
        </div>
        <div class="pull-right">
            ...
            <div class="col-md-4" id="sshDeleteKeyLoader" style="display: none"> 
                <img src='images/preloader_circle.gif' alt='Loading' height='16' width='23'/>
            </div>
        </div>
     </div>
...
<div data-dojo-type="dijit.Dialog" id="privateKeyDeleteDialog" title="<g:message code='user.deletePrivateSshKey.title' />" class="customDialgue" style="display: none;color: black; width: 350px;">
    <div class="row">
        <div class="col-md-10">
            <div class="col-md-12"><g:message code='user.deletePrivateSshKey.confirm' />  </div>            
        </div>        
        <div class="row">
...
<div data-dojo-type="dijit.Dialog" id="deleteSshDialogAlert" title="<g:message code='user.deleteSsh.title' />" class="customDialgue" style="display: none;color: black; width: 350px;">
    <div class="row">
        <div class="col-md-10">
            <div class="col-md-12"><g:message code='user.deleteSsh.confirm' />  </div>            
        </div>        
        <div class="row">
