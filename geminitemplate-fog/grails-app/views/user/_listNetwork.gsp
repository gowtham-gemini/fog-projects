    ...
    <div class="col-md-5 dijitDialogueBackground">
        ...
        <div>
            <div class="control-group col-md-3 pull-right"> 
                <button id="upadateNetworkButton" class="defaultbtn" type="button" data-dojo-type="dijit.form.Button" onclick="NetworkInfo.upadte()"><g:message code="common.update"/></button>
...
<div data-dojo-type="dijit.Dialog" id="deleteNetworkDialog" title="<g:message code="user.network.deleteConfirm"/>" class="col-md-4">
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="networkLoader">
  <div class="row">
