    ...
    <div class="loader" id="loader">
      <div class="loader-cont">
        <div>
          ...
          <div><p class="col-md-2" style="text-align: center"><g:message code="common.message.loading" /></p></div>         
      </div>
    </div>
    <div class="row">
...
<div id="">
  <div class="products-table">
    ...
    <div class="alert alert-danger errorMessage" id="" style="display: block;">
        ...
        <g:message code="common.account.disable.info" />
    </div>                      
...
<div data-dojo-type="dijit.Dialog" id="paymentDialog" title="<g:message code="common.makePayment" />" class="col-md-5">  
  ...
  <div data-dojo-type="dijit.Dialog" id="summaryDialog" title="<g:message code="common.summary" />" class="col-md-12">  
...
<div data-dojo-type="dijit.Dialog" id="supportDialog" title="<g:message code="menu.user.support" />" class="col-md-8">  
...
<!--  <div class="col-md-4 createvm-banner">
    ...
    <div class="row form-wrapper">
        ...
        <div class="col-md-6">
            ...
            <form class="form-horizontal" id="makePaymentRadioForm" data-dojo-type="dijit.form.Form">
                <div class="col-md-12 field-box control-group form-horizontal" id="paymentGateways">
    ...
    <div class="col-md-6"> 
      ...
      <form id="manualPaymentForm" data-dojo-type="dijit.form.Form" class="form-horizontal">
         <div id="manualPaymentPage">
            <!--<div class="row">-->
              <div class="col-md-12 field-box control-group" id="payAmountDiv">
...
<div id="ccAvenueDiv" style="display: none;"> 
   <div  class="new-user">
   <div class="row form-wrapper overflow-text">
        <form data-dojo-type="dijit.form.Form" id="ccAvenuPaymentForm" class="form-horizontal">
            <div class="col-md-3"></div>
            <div class="col-md-6" id="ccAvenuePage">
                <div class="col-md-12"></div>
                <div class="col-md-12 field-box control-group" id="ccAvenuePaymentAmount"> 
                ...
                <div class="col-md-12 field-box control-group" id="ccAvenuePaymentOption"> 
                ...
                <div class="col-md-12 field-box control-group" id="ccAvenuePaymentBank"> 
            ...
            <div class="col-md-3">
                <div class="col-md-12"></div>
                <div class="col-md-12"></div>
                <div class="col-md-12"> <span  class="validation" style="margin-left: 0px;" id="cardExceptionMsg"><g:message code="common.pleaseChooseCard"/></span></div>
            </div>
        </form>
   </div>   
  </div>
