  ...
  <body class="fog-classic">
    ...
    <div class="loader" id="loader">
      <div class="loader-cont">
        ...
        <div>
          <p class="col-md-2" style="text-align: center">Loading Please wait..</p>
        </div>         
      </div>
    </div>
    <div class="row">
...
<div data-dojo-type="dijit.Dialog" id="paymentDialog" title="Make a payment" class="col-md-5">  
<div class="new-user"> 
...
<div data-dojo-type="dijit.Dialog" id="paymentLoader" 
  ...
  <div class="row" id="processPaymentMessage" style="display: block">
    ...
    <p class="message col-md-10">Processing Payment</p>
    </div>
