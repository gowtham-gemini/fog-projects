...
<div class="col-md-12" id="diskOfferingPage">
    ...
    <div class="row infobox_widget non_updatable" id="diskListCollection">
  ...
  <div class="row" id="diskOfferContent">
   <form id="diskOfferContentForm" data-dojo-type="dijit.form.Form" class="form-horizontal"> 
    ...
    <div class="control-group customDisk horizontalcontent col-md-4">
    ...
    <div class="row" id="secondRowWidgets">
      <div class="control-group col-md-4 horizontalcontent" id="diskSizeHide">
...
<!--           <span  class ="highlight">GB</span> -->
      ...
      <div class="control-group col-md-4 horizontalcontent diskCustomSize">
        <label for="diskSize" class="control-label">
     ...
     <div class="row">
       <div id="diskZoneInfo" class="zoneInfo col-md-12 zoneCostHeading"
         ...
         <div id="currentDiskZoneInfo" class="row">
           <div id="diskZoneCost" class="col-md-8 offset2"></div>
         </div>
       </div>
     </div>
