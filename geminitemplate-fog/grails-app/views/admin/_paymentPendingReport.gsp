...
<div class="row" id="paymentPendingReportActionButtonDiv" style="display: none">
...
<div class="row">
  <iframe class="col-md-12" height="1000px" id="paymentPendingReportIframe" name="paymentPendingFrame" frameBorder="0">
  </iframe>
</div>