...
<div class="row" style="background:#F7F7F7;padding:8px;width:auto;border:1px solid #DAE1E8;">
    <div class="col-md-12">
        <form class="form-horizontal" id="reportFilterForm" data-dojo-type="dijit.form.Form">
            ...
            <div class="col-md-12 field-box" style="display: none" id="accountListDiv">
...
<div class="row" id="actionButtonDiv" style="display: none">
    <div class="col-md-2 offset10">
...
<div class="row">
    <iframe class="col-md-12" height="1000px" id="currentReport" name="cuurrentInvoiceFrame" frameBorder="0">
    </iframe>
</div>
