...
<div class="row"> 
  <!--<div class="row">-->
    <div class="col-md-8" id="systemConfigPage">
  ...
  <div data-dojo-type="dijit.Dialog" id="configLoader" 
      class="col-md-6">
    <div class="row" id="processMessage">
    ...
    <div class="row hide_lable" id="failMessage">
    ...
    <div class="row" id="messageAction" style="display: none">
