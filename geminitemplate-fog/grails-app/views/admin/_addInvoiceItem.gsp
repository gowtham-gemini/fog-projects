...
<div class="new-user">
  ...
  <div class="row form-wrapper">
    <!-- left column -->
    <div class="col-md-9 with-sidebar" id="updateRecurringItemPage">
      <div class="container">
          <form class="form-horizontal" data-dojo-type="dijit.form.Form" id="addInvoiceItemForm">
            <div class="col-md-6 field-box control-group">
              ...
              <div class="col-md-12 field-box control-group" id="accountListDiv" style="display: none">
...
<!--              <div class="col-md-6 field-box control-group"> 
              ...
              <div class="col-md-6 field-box control-group" id="recurringItemTaxPercentageDiv" style="display: none">
            ...
            <div class="col-md-6 field-box control-group" id="recurringItemBillingCyclesDiv" style="display: none">
