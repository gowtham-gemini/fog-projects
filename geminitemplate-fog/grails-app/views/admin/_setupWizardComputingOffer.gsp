...
<div class="col-md-12" id="wizardComputingOfferPage">
 
  <div  class="row wizhead_title">
  ...
  <div class="row infobox_widget non_updatable" id="serviceListItems">
  ...
  <div id="computingOfferContent">
    ...
    <div class="row">
      ...
      <div class="control-group customDisk col-md-4">
        <label for="serviceStorageTag" class="control-label">
          Storage Tag: 
        </label>
        <div class="controls updatable elements">
          <div id="computingOfferStorageTagList" class="col-md-4 selectOption"></div>
        </div>
    ...
    <div class="row">           
      ...
      <div class="row">          
        ...
        <div class="row">
          <div class="control-group spacing col-md-4 customDisk">
          ...
          <div class="control-group col-md-4 spacing customDisk" id="computingOfferHA">
    ...
    <div class="row">
      <div id="computingZoneInfo" class="zoneCostHeading" data-dojo-type="dijit.TitlePane"
        ...
        <div class="row">
			<div class="col-md-4"><h5>Zone:  <span  id="computingZoneName"></span>   </h5></div>
			<div class="col-md-4"><h5>Pod:  <span  id="computingPodName"></span>   </h5></div>
			<div class="col-md-4"><h5>Cluster:  <span  id="computingClusterName"></span>   </h5></div>
                   
        </div>
        
        <div id="currentComputingZoneInfo" class="row">
          <div id="currentZoneCost" class="col-md-12"></div>
        </div>
      </div>
    </div>
