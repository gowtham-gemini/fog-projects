...
<div class="row" id="paymentReportActionButtonDiv" style="display: none">
...
<div class="row">
  <iframe class="col-md-12" height="1000px" id="paymentReportIframe" name="cuurrentInvoiceFrame" frameBorder="0">
  </iframe>
</div>