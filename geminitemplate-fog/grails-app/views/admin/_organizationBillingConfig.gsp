            ...
            <div class="container" id="organizationBillSettingsPage">
                <form class="form-horizontal" data-dojo-type="dijit.form.Form" id="organizationDetailForm">
                    ...
                    <div class="col-md-12 field-box control-group">
                        ...
                        <div class="controls">
                            ...
                            <div class="col-md-3">
                                ...
                                accept: '',regExp: '[0-9-+ ]{4,20}'" id="organizationPhoneNumber1"  class="col-md-4">
                            </div>
                            <div class="col-md-3">
                                <input type="text" data-dojo-type="dijit.form.ValidationTextBox" 
                                ...
                                invalidMessage:'<g:message code="common.invalidMessage.pnoneNumber"/>', placeHolder: '<g:message code="common.promptMessage.pnoneNumber"/>',
                                regExp: '[0-9-+ ]{4,20}'" id="organizationPhoneNumber2"  class="col-md-4">
                            </div>
                            <div class="col-md-3">
                                <input type="text" data-dojo-type="dijit.form.ValidationTextBox" 
                                data-dojo-props="promptMessage: '<g:message code="common.promptMessage.pnoneNumber"/>', missingMessage: '<g:message code="common.promptMessage.pnoneNumber"/>',
                                invalidMessage:'<g:message code="common.invalidMessage.pnoneNumber"/>', placeHolder: '<g:message code="common.promptMessage.pnoneNumber"/>',
                                accept: '',regExp: '[0-9-+ ]{4,20}'" id="organizationPhoneNumber3"  class="col-md-4">
                            </div>
                            <!--</div>-->
                        </div>
                    </div>
                    <div class="col-md-12 field-box  control-group">
                        ...
                        <div class="controls">
                            ...
                            <div class="col-md-3">
                                ...
                                accept: '',regExp: '[0-9-+ ]{4,20}'" id="organizationFaxNumber1" class="col-md-4">
                            </div>
                            <div class="col-md-3">
                                <input type="text" data-dojo-type="dijit.form.ValidationTextBox"                    
                                ...
                                invalidMessage:'<g:message code="common.invalidMessage.fax"/>', placeHolder: '<g:message code="common.promptMessage.fax"/>',
                                accept: '',regExp: '[0-9-+ ]{4,20}'" id="organizationFaxNumber2" class="col-md-4">
                            </div>
                            <div class="col-md-3">
                                <input type="text" data-dojo-type="dijit.form.ValidationTextBox" 
                                data-dojo-props="promptMessage: '<g:message code="common.promptMessage.fax"/>',missingMessage: '<g:message code="common.promptMessage.fax"/>',
                                invalidMessage:'<g:message code="common.invalidMessage.fax"/>', placeHolder: '<g:message code="common.promptMessage.fax"/>',
                                accept: '',regExp: '[0-9-+ ]{4,20}'" id="organizationFaxNumber3" class="col-md-4">
                            </div>
                            <!--</div>-->
                        </div>
                    </div>           
                    ...
                    <div class="col-md-12 field-box control-group">
                        ...
                        <div class="controls">
                            <input data-dojo-type="dijit.form.ValidationTextBox" 
                            data-dojo-props="required:'true', promptMessage:'<g:message code="common.promptMessage.signature"/>', 
                    ...
                    <div class="col-md-12 field-box control-group">
                        ...
                        <div class="controls">
                            <div data-dojo-type="dijit.Editor" id="organizationTermsCondition" class="col-md-10"></div>
                        </div>
                    </div>
