            ...
            <div id="flavorContent">
                <div class="row">
                    ...
                    <div class="row">     
                        ...
                        <div>
                            <div id="volumeTypePriceHeadLabel">
                                <div class="row">
                                    ...
                                    <div class="col-md-2"><h5><g:message code="common.volumeType.runningCostByMonth"/></h5></div>
                                    <div class="col-md-2"><h5><g:message code="common.volumeType.runningCostByHr"/></h5></div>                                    
                                </div>
                            </div> 
                        </div></br>
                        <div class="row">
                        ...
                        <div class="row hide_text" id="volumeTypeZoneLoader">
                ...
                <div class="row" style="margin-top: 10px">
                    ...
                    <div class="col-md-3">
                        ...
                        <div id="volueTypeCancelButtonDiv" class="col-md-4 pull-right">
                            <button id="volueTypeCancelButton"  data-dojo-type="dijit.form.Button" onclick="AddVolumeTypeInfo.cancel()" class="cancelbtn">
                                <g:message code="common.cancel"/>
                            </button>
                        </div>
                        <div id="volueTypeAddButtonDiv" class="col-md-3 pull-right" style="display: block;" >
                        ...
                        <div id="volueTypeUpdateButtonDiv" class="col-md-4 pull-right">
...
<div data-dojo-type="dijit.Dialog" class="full_loader" id="pullVolumeTypePlanLoader" class="col-md-6">
    <div class="row">
...
<div data-dojo-type="dijit.Dialog" id="volumeTypeUpdateConformationDialog" title="" class="col-md-4">
...
<div data-dojo-type="dijit.Dialog" id="volumeTypeAddConformationDialog" title="" class="col-md-4">
    <!--<p><g:message code="admin.updateItem"/></p>--> 
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="addVolumeTypeLoader">
    <div class="row">
        <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
        <div class="col-md-9">
            <div class="col-md-12"><p><g:message code='common.addVolumeTypeInfoOne' /></p></div>
            <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.addVolumeTypeInfoTwo' /></p></div>              
        </div>          
    </div>
    <div class="row">        
