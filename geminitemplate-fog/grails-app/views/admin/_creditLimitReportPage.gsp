...
<div class="row" id="creditLimitReportActionButtonDiv" style="display: none">
...
<div class="row">
  <iframe class="col-md-12" height="1000px" id="creditLimitReportIframe" name="creditLimitFrame" frameBorder="0">
  </iframe>
</div>