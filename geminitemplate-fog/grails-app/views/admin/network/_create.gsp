...
<div class="row">
    <div class="col-md-12" id="">
        <div class="row header">
            <h3 id="adminNetworkPagehead"></h3>   <div class="col-md-2 value_dollar pull-right" style="display: none;"><g:message code="default.valueIn"/>   <span  id="addNetworkCurrencyValue"></span></div>
        </div>
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="adminCreateNetworkLoader">
    <div class="row">
