...
<div class="row" style="display: block;">
    <form id="adminNetworkListForm" data-dojo-type="dijit.form.Form">
        <div class="table-wrapper products-table">       
            ...
            <div class="row filter-block" id="adminNetworkListDiv" style="display: block;margin-top: 0px;">
...
<div data-dojo-type="dijit.Dialog" id="adminNetworkEditFormDialog" title="<g:message code="common.user.editNetwork"/>"  class="customDialgue">
    <div class="col-md-5 dijitDialogueBackground">
        <div class="row">
            <div class="col-md-2"><a class="index_title_icons_network" style="padding: 1px 0px 50px 42px;"></a></div>
            <div class="col-md-10">
...
<div data-dojo-type="dijit.Dialog" id="adminDeleteNetworkDialog" title="<g:message code="user.network.deleteConfirm"/>" class="col-md-4">
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="adminNetworkLoader">
  <div class="row">
        <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
        <div class="col-md-9">
            <div class="col-md-12"><p><g:message code='common.deleteNetworkInfo1' /></p></div>
            <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.deleteNetworkInfo2' /></p></div>              
        </div>          
    </div>
    <div class="row">        
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="adminNetworkUpdateLoader">
  <div class="row">
        <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
        <div class="col-md-9">
            <div class="col-md-12"><p><g:message code='common.updateNetworkInfo1' /></p></div>
            <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.updateNetworkInfo2' /></p></div>              
        </div>          
    </div>
    <div class="row">        
        <a class="btn-flat default" onclick="NetworkInfo.closeLoader()"><g:message code='common.clickHereToClose' /></a>
