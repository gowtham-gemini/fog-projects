                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div id="adminSubnetNetworkCancelButtonDiv" class="col-md-4 pull-right">
                                <button id="adminSubnetNetworkCancelButton"  data-dojo-type="dijit.form.Button" onclick="SubnetInfo.cancel()" class="cancelbtn">
                                    <g:message code="common.cancel"/>
                                </button>
                            </div>
                            <div id="adminSubnetNetworkAddButtonDiv" class="col-md-2 pull-right" style="display: block;" >
                            ...
                            <div id="adminSubnetNetworkUpdateButtonDiv" style="display: none;" class="col-md-3 pull-right">
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="adminCreateSubnetLoader">
    <div class="row">
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="adminUpdateSubnetLoader">
    <div class="row">
        <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
        <div class="col-md-9">
            <div class="col-md-12"><p><g:message code='common.updateSubnetInfoOne' /></p></div>
            <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.updateSubnetInfoTwo' /></p></div>              
        </div>          
    </div>
    <div class="row">        
        <a onclick = "SubnetInfo.gotoList()" class="btn-flat default" ><g:message code='common.gotoSubnetList' /></a>
