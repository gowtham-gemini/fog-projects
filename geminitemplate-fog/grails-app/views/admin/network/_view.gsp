...
<div class="row">
    <div data-dojo-type="dijit/layout/TabContainer" id="adminNetworkTabContainer" class="col-md-12" style="overflow: visible;" tabStrip="true">
        ...
        <div data-dojo-type="dijit/layout/ContentPane" id="adminSubnetContentPane" title="<g:message code="menu.user.network.subnets"/>" onshow="SubnetInfo.populateValues()">
            ...
            <div data-dojo-type="dijit.Dialog" id="adminDeleteSubnetDialog" title="<g:message code="user.subnet.deleteConfirm"/>" class="col-md-4">
            ...
            <div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="adminDeleteSubnetLoader">
                <div class="row">
                  <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
                  <div class="col-md-9">
                      <div class="col-md-12"><p><g:message code='common.deleteSubnetInfo1' /></p></div>
                      <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.deleteSubnetInfo2' /></p></div>              
                  </div>          
                </div>
                <div class="row">        
         ...
         <div data-dojo-type="dijit/layout/ContentPane" id="adminPortContentPane" title="<g:message code="menu.user.network.ports"/>" onshow="PortInfo.populateValues()">
            ...
            <div data-dojo-type="dijit.Dialog" id="adminDeletePortDialog" title="<g:message code="admin.port.deleteConfirm"/>" class="col-md-4">
            ...
            <div data-dojo-type="dijit.Dialog" id="adminPortEditFormDialog" title="<g:message code="common.user.editPort"/>"  class="customDialgue">
                <div class="col-md-5 dijitDialogueBackground">
                    <div class="row">
                        <input type="hidden" id="adminCurrentPortId">
                        <div class="col-md-10">
            ...
            <div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="adminPortLoader">
                <div class="row">
                  <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
                  <div class="col-md-9">
                      <div class="col-md-12"><p><g:message code='common.portInfo1' /></p></div>
                      <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.portInfo2' /></p></div>              
                  </div>          
                </div>
                <div class="row">        
