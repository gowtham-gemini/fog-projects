...
<div class="row">
    <div class="col-md-12" id="">
        <div class="row header">
            <h3 id="adminNetworkPorthead"></h3>   <div class="col-md-2 value_dollar pull-right" style="display: none;"><g:message code="default.valueIn"/>   <span  id="addNetworkCurrencyValue"></span></div>
        </div>
...
<div data-dojo-type="dijit.Dialog" class="customDialgue col-md-6" id="adminCreatePortLoader">
    <div class="row">
        <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
        <div class="col-md-9">
            <div class="col-md-12"><p><g:message code='common.createPortInfoOne' /></p></div>
            <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.createPortInfoTwo' /></p></div>              
        </div>          
    </div>
    <div class="row">        
