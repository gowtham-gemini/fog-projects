...
<div class="row"> 
    <div class="col-md-8" id="dashboardSystemConfigPage">
...
<div class="buttonGroup" id="dashboardButtonCollection" style="display: none">
  ...
  <div data-dojo-type="dijit.Dialog" id="dashboardConfigLoader" 
      class="col-md-6">
    <div class="row" id="dashboardProcessMessage">
    <img src="images/configLoader.gif" class="col-md-1 spacing"/>
    <p class="message col-md-10">Fog panel verifying your cloud stack connectivity</p>
    </div>
    <div class="row" id="dashboardSuccessMessage">
    ...
    <div class="row" id="dashboardFailMessage">
    <img src="images/errorMessage.jpg" class="col-md-1 spacing"/>
    <p class="message col-md-9 error">Error! Fogpanel and cloudstack is not integrated, 
      so please verify your config</p>
    </div>
    <div class="row" id="dashboardMessageAction" style="display: none">
