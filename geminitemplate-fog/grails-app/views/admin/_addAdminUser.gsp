        ...
        <div class="col-md-5">
            <div class="new_user_form inline-input">
                ...
                <div class="col-md-12 field-box" id ="fixedDayContainer">
                    ...
                    <div id="password_strength" style="display: none; margin-top: 5px;" class="col-md-6">
...
<div data-dojo-type="dijit.Dialog" class="full_loader" id="addAccountProcessLoader" class="col-md-8">
  ...
  <!--    <div class="row hide_lable" id="successMessage">
      ...
      <p class="message col-md-9 success">Success! Fogpanel and openstack has integrated</p>
      </div>-->
</div>