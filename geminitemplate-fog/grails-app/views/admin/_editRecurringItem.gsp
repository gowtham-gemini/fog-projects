...
<div id="" class="new-user">
  ...
  <div class="row form-wrapper">
    <!-- left column -->
    <div class="col-md-9" id="updateRecurringItemPage">
      <div class="container">
...
<div data-dojo-type="dijit.Dialog" id="recItemEditConformationDialog" title="<g:message code="default.button.update.common"/>" class="col-md-4">
