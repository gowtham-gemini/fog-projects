...
<div class="row" id="billableItemActionButtonDiv" style="display: none">
...
<div class="row">
  <iframe class="col-md-12" height="1000px" id="billableItemIframe" name="cuurrentInvoiceFrame" frameBorder="0">
  </iframe>
</div>