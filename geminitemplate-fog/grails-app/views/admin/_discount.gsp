...
<div class="row">
  <div class="col-md-8">
    <form class="form-horizontal" id="discountForm" data-dojo-type="dijit.form.Form">
        ...
        <div class="row" id="discountApplyToDiv">
          <div class="control-group col-md-4"> 
        ...
        <div class="row" id="discountPlanList">
          <div class="control-group col-md-6"> 
        ...
        <div class="row" id="discountUserList">
          <div class="control-group col-md-6"> 
  ...
  <div class="col-md-4" id="discountListCollection">
