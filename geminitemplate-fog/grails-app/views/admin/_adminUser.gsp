...
<div data-dojo-type="dijit.Dialog" class="full_loader" id="addAccountProcessLoader2" class="col-md-8">
...
<div data-dojo-type="dijit.Dialog" id="showAPIKeyDialog" title="<g:message code="admin.showApiKey"/>" class="col-md-5">
    <input type="hidden" id="userId">
    <div class="new-user"> 
        <div class="row form-wrapper"> 
            <div class="col-md-6"> 
...
<div data-dojo-type="dijit.Dialog" id="showResetKeysDialog" title="<g:message code="admin.resetApiKey"/>" class="col-md-3">
    <input type="hidden" id="userId">
    <div class="row form-wrapper"> 
...
<div data-dojo-type="dijit.Dialog" id="showRevokeAPIAccessDialog" title="<g:message code="admin.revokeApiKey"/>" class="col-md-3">
    <input type="hidden" id="userId">
    <div class="row form-wrapper"> 
        <div class="col-md-5 field-box control-group">
...
<div data-dojo-type="dijit.Dialog" id="showGrantAPIAccessDialog" title="<g:message code="admin.grantApiKey"/>" class="col-md-3">
    <input type="hidden" id="userId">
    <div class="row form-wrapper"> 
        <div class="col-md-5 field-box control-group">
