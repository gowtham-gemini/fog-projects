<div id="pad-wrapper" class="new-user">
  ...
  <div class="row form-wrapper" id="paymentSettingPage">
         left column 
        <div class="col-md-9 with-sidebar">
            <div class="container">
                <form class="new_user_form inline-input" data-dojo-type="dijit.form.Form" id="billingConfigForm">
                  ...
                  <div class="col-md-12 field-box" id="fixedDayDiv">
                  ...
                  <div class="col-md-12 field-box" id="billingPeriodDaysDiv" style="display: none">
        ...
        <div class="col-md-3 form-sidebar pull-right">
          <div class="col-md-12"> <span  id="isFixedDescription"></span></div>
          <div class="col-md-12"> <span  id="fixedDayDescription"></span></div>
          <div class="col-md-12" style="display: none" id="billingPeriodDaysDescriptionContainer">
             <span  id="billingPeriodDaysDescription"></span>
          </div>
          <div class="col-md-12"> <span  id="paymentDueDaysDescription"></span></div>
          <div class="col-md-12"> <span  id="creditLimitNotificationLevel1Description"></span></div>
          <div class="col-md-12"> <span  id="creditLimitNotificationLevel2Description"></span></div>
          <div class="col-md-12"> <span  id="creditLimitNotificationLevel3Description"></span></div>
        </div>
    </div>
</div>
