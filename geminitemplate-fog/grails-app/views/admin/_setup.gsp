<!--div id="pad-wrapper"-->
  <div class="row">
    <div class="col-md-10 welcome_wiz" data-dojo-type="FogPanel.Wizard" data-dojo-props="attrib:{steps:{'1' : 'Welcome', '2': 'Cloudstack Config','3' : 'Zones', '4': 'Computation', '5': 'Storage', '6': 'Miscellaneous'}, rotatorId:'rotator'}" data-dojo-id="setupWizard" id="setupWizard">
