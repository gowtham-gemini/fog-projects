...
<div class="new-user">
    ...
    <div class="row form-wrapper" id="discountAddPage">
      <!-- left column -->
        <div class="col-md-7 with-sidebar">
            <div class="container">
                <form class="new_user_form form-horizontal" data-dojo-type="dijit.form.Form" id="discountForm">
                    ...
                    <div class="col-md-12 field-box control-group">
                        <label for="discountName" class="control-label settings_lable">
                            ...
                            <g:message code="common.discountName"/>
                        </label>
                        <div class="controls">
                    ...
                    <div class="col-md-12 field-box control-group" style="display: none">
                        <label class="control-label settings_lable">
                             <span  class="require">*</span>
                            <g:message code="common.subType"/>
                        </label>
                        <div class="controls">
                    ...
                    <div class="col-md-12 field-box control-group">
                        <label for="discountValue" class="control-label settings_lable">
                             <span  class="require">*</span>
                            <g:message code="common.discountValue"/>
                        </label>
                        <div class="controls">
                    ...
                    <div class="col-md-12 field-box control-group" id="discountStartDateDiv" style="display: none;">
                    ...
                    <div class="col-md-12 field-box control-group" id="discountEndDateDiv" style="display: none;">
                    ...
                    <div class="col-md-12 field-box control-group">
                        <label for="billingCycles" class="control-label settings_lable">
                             <span  class="require">*</span> 
                            <g:message code="common.discountBillingCycle"/>
                        </label>
                        <div class="controls">
                            <input type="text" data-dojo-type="dijit.form.NumberTextBox"
                            data-dojo-props="required:'true', constraints:{max: 100, pattern:'#'}, placeHolder: '<g:message code="common.value"/>',
                    ...
                    <div class="col-md-12 field-box control-group" id="discountApplyToDiv">
                        <label for="discountApplyTo" class="control-label settings_lable">
                             <span  class="require">*</span>
                             <span  id="applyToLable"><g:message code="common.applyToUser"/>:</span>
                        </label>
                        <div class="controls">
                    ...
                    <div class="col-md-12 field-box control-group" id="isAllPlanDiv">
                        <label for="isAllPlan" class="control-label settings_lable">
                             <span  class="require">*</span>
                            <g:message code="common.forAllPlan"/>:
                        </label>
                        <div class="controls">
                    ...
                    <div class="col-md-12 field-box control-group" id="discountUserList">
                        <label for="discountUsers" class="control-label settings_lable">
                             <span  class="require">*</span>
                            <g:message code="common.user"/>:
                        </label>
                        <div class="controls">
