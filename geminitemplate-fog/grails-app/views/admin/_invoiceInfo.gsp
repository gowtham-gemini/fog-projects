...
<div id="" class="new-user">
    ...
    <div class="row form-wrapper">
      <!-- left column -->
        <div class="col-md-6 with-sidebar" id="invoiceInfoPage">
            <div class="container">
                <form class="new_user_form form-horizontal" data-dojo-type="dijit.form.Form" id="invoiceForm">
                    ...
                    <div class="col-md-12 field-box control-group" id="fixedDayDiv">
                    ...
                    <div class="col-md-12 field-box control-group" id="billingPeriodDaysDiv" style="display: none">
  ...
  <!--                    <input type="reset" value="Cancel" class="reset" onclick="InvoiceInfo.cancel()">
        ...
        <div class="col-md-6">
            <div class="new_user_form inline-input">
                ...
                <div class="col-md-12 field-box" id="billingPeriodDaysDescriptionContainer" style="display: none">
