                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-6 pull-right">
                            <div id="userAddButtonDiv" class="col-md-2" style="display: block;" >
                                <button   id="userAddButton"  data-dojo-type="dijit.form.Button" onclick="AddUser.add()" class="okbtn">
                                    <g:message code="common.ok"/>
                                </button>
                            </div>        
                            <div id="userUpdateButtonDiv" style="display: none;" class="col-md-3">
                            ...
                            <div id="userCancelButtonDiv" class="col-md-3">
