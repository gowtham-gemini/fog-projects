<div class="row">
    <div class="col-md-12 breadcrumbs">
      <ul>
        ...
        <li>/</li>
        <li><a href="#/admin/infrastructure/volumes"><g:message code="menu.volumes"/></a></li>
        <li>/</li>
...
<!--        <div class="pull-right col-md-8">
            <a class="btn-flat danger spacing" onclick="VolumeInfo.getDeleteConformation()">
                <g:message code='common.delete' />
            </a>
            <button class="cancelbtn" style= "margin-left: 10px" data-dojo-type="dijit.form.Button" onclick="VolumeInfo.gotoList()">
...
<div data-dojo-type="dijit.Dialog" id="adminPageVolumeDeleteDialog" title="<g:message code='admin.volume.deleteVm.title' />" class="customDialgue" style="display: none;color: black; width: 350px;">
    <div class="row">
        <div class="col-md-2"><img src='images/popup-icons/vm_delete_icon.png'/></div>
        <div class="col-md-10">
            <div class="col-md-12"><g:message code='volume.deleteVolume.confirm' />  </div>            
        </div>        
        <div class="row">
...
<div data-dojo-type="dijit.Dialog" style="display: none" class="customDialgue col-md-6" id="adminVolumePageActionLoader" >
    <div class="row">
        <div class="col-md-3"><img src='images/popup-icons/new_vm_launch.gif'/></div>
        <div class="col-md-9">
            <div class="col-md-12"><p><g:message code='common.volumeInfoInfoOne' /></p></div>
            <div class="col-md-12" style="margin-left: 0"><p><g:message code='common.volumeInfoInfoTwo' /></p></div>              
        </div>          
    </div>
    <div class="row">        
