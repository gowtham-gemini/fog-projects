<div class="row"> 
    <div class="col-md-12 breadcrumbs">
        <ul>
            ...
            <li>/</li>
            <li><g:message code="common.regionConfig"/></li>   
        </ul>
    </div>
</div>
<!--<div class="row" id="regionDiv" style="margin-top: 25px;">   
    <div class="well well-large col-md-8">
        <div class="row">
            <div class="col-md-12"> 
                <input type="hidden" id="regionId"/>
                <form class="form-horizontal" id="addRegionForm" data-dojo-type="dijit.form.Form">
                    <div class="row" id="regionsPage">
    ...
    <div class="col-md-4">
        <section class="well well-small">
            <g:message code="admin.regionConfigInfo"/>
            <ul>
                <li><g:message code="admin.regionNameInfo"/></li>
            </ul>
        </section>
    </div>
</div>-->
<div class="row">
    <form id="regionListForm" data-dojo-type="dijit.form.Form">
...
<!--                            <button type="button" data-dojo-type= "dijit.form.Button" class="cancelbtn" onclick="RegionConfig.confirmPullAlert()" id="pullRegionButton">
                                <g:message code="common.pullRegionsFromOpenstack"/>
                                <img id="pullRegionLoaderImage" style="display: none; margin: 0px;"  src="${resource(dir: 'images')}/ajaxloader.gif"  height="15" width="15">
                            </button>-->
                            <button class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="RegionConfig.populateValues()">
...
<div data-dojo-type="dijit.Dialog" id="pullRegionConfirm" class="col-md-4" style="display:none;">
        <div class="row">
        ...
        <div class="row">
            <button  type="button" class="primarybtn" data-dojo-type="dijit.form.Button" onclick="RegionConfig.pull()"><g:message code="common.ok"/></button>
            <button  type="button" class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="RegionConfig.cancelPull()"><g:message code="common.cancel"/></button>
        </div>
</div>
<!--<div class="row form-wrapper" style="margin-top: 50px;">
    <div id="regionListGrid"></div>
</div>-->
<div data-dojo-type="dijit.Dialog" id="showDeleteRegionDialog" title="<g:message code="common.region.delete"/>" class="col-md-3">
    <input type="hidden" id="regionId">
