<div class="row">
    <div class="new-user"> 
        <form data-dojo-type="dijit.form.Form" id="adminMiscNetworkSnapshotForm" class="form-horizontal col-md-12">
            <div class="row">
                <div class="value_dollar pull-right"><g:message code="default.valueIn" /> <span  id="networkCurrencyValue"></span></div>  
            </div>
            <div class="row" id="networkSnapshotPriceLabelContainer">
                <div class="col-md-2 offset1"><h5><g:message code="common.name"/></h5></div>
                <div class="col-md-2 offset2"><h5><g:message code="common.networkPerMonth"/></h5></div>                                        
                <div class="col-md-3 offset1"><h5><g:message code="common.billingCostPerNwPerHr"/></h5></div>                                              
            </div>
            <div class="row">              
                <div class="col-md-9 offset1">
                    <div id="networkMiscSnapshotCostInfo" class="col-md-12"></div>          
                </div>                                    
            </div>  
            <div class="row" id="networkSnapUpdateActionButton">
            ...
            <div class="row">
                <div class="col-md-12 hide_text" id="networkSnapshotZoneLoader">
...
<div data-dojo-type="dijit.Dialog" id="networkSnapshotEditConformationDialog" title="<g:message code="default.button.update.common" />" class="col-md-4">
