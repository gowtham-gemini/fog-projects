...
<div class="new-user">
    ...
    <div class="row form-wrapper">    
        <div class="col-md-6 with-sidebar" id="loginSecurityPage">
            <div class="container">
                <form class="new_user_form inline-input form-horizontal" data-dojo-type="dijit.form.Form" id="loginSecurityForm">          
                    <div class="col-md-12 field-box control-group">
                        ...
                        <div class="controls">
                            ...
                            data-dojo-props="invalidMessage: '<g:message code="common.invalidMessage.linkActiveTime"/>',
                    ...
                    <div style="display: none;" class="col-md-12 field-box control-group">
