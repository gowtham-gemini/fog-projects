...
<div class="col-md-8" id="tempPage">
  ...
  <div class="control-group">
    ...
    <div class="control">
      <div class="col-md-6" data-dojo-type="dijit.form.ValidationTextBox" id="dashboardAppTempDescription"
...
<div class="col-md-4" id = "dashboardAppTempCollection">
