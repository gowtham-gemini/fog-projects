...
<div  class="row">
<div class="col-md-3" id ="miscellaneousListContainer">
  <div id="misceList"></div>
</div>
<div class="col-md-9" id ="misscellaneousPage">
  <div class="row">
  <div id="miscelCostInfo">
    <div id="miscelZoneCostInfo" class="zoneCostHeading" data-dojo-type="dijit.TitlePane" 
      ...
      <div class="control-group col-md-4 horizontalcontent">
        ...
        <div class="control-group col-md-4 horizontalcontent" style="display: none">
      ...
      <div id="currentMisceZoneCostList" class="row">
          <div id="misceZoneCost" class="col-md-12"></div>
        </div>
