...
<div class="row" style="display: block;">
    <form id="adminVolumeListForm" data-dojo-type="dijit.form.Form">
        <div class="table-wrapper products-table">       
            ...
            <div class="row filter-block" id="adminVolumePullDiv" style="display: block;margin-top: 0px;">
...
<div data-dojo-type="dijit.Dialog" style="display: none" class="customDialgue col-md-6" id="adminVolumeActionLoader" >
    <div class="row">
