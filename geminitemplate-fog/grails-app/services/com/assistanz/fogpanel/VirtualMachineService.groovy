        ...
        try { 
            ...
            for (Server vm : vms) {
                ...
                if(instance) {                    
                    ...
                    item.put("monitoringDevice", monitoringDevice)   
                    ...
                    item.put("flavors", instance.flavor);
...
//                System.out.println("getId" + vm.getId());
//                System.out.println("getProgress" + vm.getProgress());
//                System.out.println("getUuid" + vm.getUuid());
//                System.out.println("getAddresses" + vm.getAddresses());
//                System.out.println("getHypervisorHostname" + vm.getHypervisorHostname());
//                System.out.println("getHost" + vm.getHost());
//                System.out.println("getAccessIPv4" + vm.getAccessIPv4());
//                System.out.println("getAccessIPv6" + vm.getAccessIPv6());
//                System.out.println("getPowerState" + vm.getPowerState());
//                System.out.println("getVmState" + vm.getVmState());
//                System.out.println("getTaskState" + vm.getTaskState());
//                System.out.println("getInstanceName" + vm.getInstanceName());
                
                
            }
//            def oldVMList = VirtualMachine.findAllWhere(deleted: false); 
//            
//            println("openStackVMList"+openStackVMList)
//            for(def oldVM : oldVMList) { 
//
//                boolean blnExists = openStackVMList.containsKey(oldVM.referenceId);
//               println("blnExists"+blnExists)
//                if(blnExists == false) {
//                   oldVM.deleted = true; 
//                   oldVM.deletedAt = new Date(); 
//                   oldVM.save(flush: true); 
//                }
//            }
        }
        return VMList
