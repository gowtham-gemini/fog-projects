...
//            }
    ...
    def deviceEnabledStatus(requestData) {
        try {
            ...
            String deviceStatus = getZenossFacade().jobStatus(requestData.jobId);
            ...
            if((deviceStatus == "SUCCESS") || (deviceStatus == "STARTED")) {
                ...
                if(getZenossFacade().checkComponentsAvailable(device)) {
...
//                    }
                ...
                getZenossFacade().overWriteDefaultTemplates(device);
