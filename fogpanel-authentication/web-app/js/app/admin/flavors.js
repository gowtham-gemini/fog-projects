    ...
    populateValues: function() {
        ...
        var dataLayout = [[
                {'name': translator.common.name, 'field': 'name', 'width': '200px', 'datatype': 'string', 'autoComplete': 'true', 'formatter': function(data) {
                        var viewTag = "<a href='#/admin/flavors/view/"+data.id+"' title='"+translator.common.edit+"'>"+data.name+"</a>";
                        return viewTag;
                }},
                {'name': translator.common.vcpu, 'field': 'vcpu', 'width': '100px', 'datatype': 'string', 'autoComplete': 'true'},
                {'name': translator.common.ram, 'field': 'memory', 'width': '100px', 'datatype': 'string', 'autoComplete': 'true',},
                {'name': translator.common.rootDisk, 'field': 'rootgb', 'width': '100px', 'datatype': 'string', 'autoComplete': 'true',},
                ...
                {'name': translator.common.action, 'field': 'action',
                    'formatter': function(data) {
                        ...
                        if(data.isDisabled === true || data.isDisabled === "true") {                            
                             html = "<a class='offset1' title='"+translator.common.enable+"' onclick='ListFlavors.changeFlavorDialog(\"" + data.id + "\", \"enable\")'><i class='icon-eye-open'></i></a></li>"                                    
                         } else if(data.isDisabled === false || data.isDisabled === "false") {
                            
                             html = "<a class='offset1' title='"+translator.common.disable+"' onclick='ListFlavors.changeFlavorDialog(\"" + data.id + "\", \"disable\")'><i class='icon-eye-close'></i></a></li>"                                    
                        }
                        return html;   
