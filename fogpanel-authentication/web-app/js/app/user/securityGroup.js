...
var SecurityGroup = {
    ...
    securityGroupDefault: function() {
        var isSecurityGroupListEmptyRest = new JsonRest({
            target: core.getContextPath() + "/api/securityGroup/isSecurityGroupEmpty"
        });  
        
        isSecurityGroupListEmptyRest.query().then(function(data) {
