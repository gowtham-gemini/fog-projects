...
//        dojo.byId("networkPagehead").innerHTML = translator.common.head.createNetwork;
        ...
        miscRestStore.query().then(function (miscData) {
            dojo.forEach(miscData, function (misc) {
                if(misc.id === 3) {
                    dojo.byId("networkCost").innerHTML = misc.cost + "   /   " + translator.common.nwPerHr;
                    dojo.byId("networkMonthCost").innerHTML = (misc.cost * 720).toFixed(2) + "   /   " + translator.common.nwPerMonth;                                        
                } else if(misc.id === 4) {
                    dojo.byId("bandwidthRead").innerHTML = misc.cost + "   /   " + translator.common.gb;
                } else if(misc.id === 5) {
                    dojo.byId("bandwidthWrite").innerHTML = misc.cost + "   /   " + translator.common.gb;
                }
            });
        });           
