...
environments {
    development {
        grails.config.locations = [ "classpath:${appName}-config.properties",
                ...
                "file:/etc/fogpanel/faas-config.groovy"
        ]
    }
    production {
        grails.config.locations = [ "classpath:${appName}-config.properties",
...
//LDAP plugin : configurations, configured with (open ldap )
//TODO need to chage based on the environment.
grails.plugin.springsecurity.ldap.context.managerDn =  'cn=admin,dc=fogpanel,dc=com'
grails.plugin.springsecurity.ldap.context.managerPassword = 'l3tm3in' 
grails.plugin.springsecurity.ldap.context.server = 'ldap://96.31.86.211:389' 
grails.plugin.springsecurity.ldap.authorities.ignorePartialResultException = true
grails.plugin.springsecurity.ldap.search.base = 'ou=users,dc=fogpanel,dc=com' 
grails.plugin.springsecurity.ldap.authorities.groupSearchBase= 'ou=users,dc=fogpanel,dc=com' 
grails.plugin.springsecurity.ldap.search.filter = "uid={0}"
grails.plugin.springsecurity.ldap.search.searchSubtree = true 
grails.plugin.springsecurity.ldap.auth.hideUserNotFoundExceptions = false 
grails.plugin.springsecurity.ldap.search.attributesToReturn = ['uid','cn','givenName'] // extra attributes you want returned
