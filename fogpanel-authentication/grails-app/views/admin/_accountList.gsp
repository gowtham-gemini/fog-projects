<div class="row-fluid">
  <div class="span12 breadcrumbs">
    <ul>
      ...
      <li>/</li>
      <li><g:message code="menu.admin.users"/></li>
      <li>/</li>
...
<div class="alert alert-info hide" id="noClientMessageBox" style="display: none">
    <g:message code="menu.admin.noUsers"/>
</div>
...
<div data-dojo-type="dijit.Dialog" class="full_loader" id="accountProcessLoader" class="span8">
