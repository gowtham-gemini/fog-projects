<div class="row-fluid">
    <div class="span12 breadcrumbs">
        <ul>
            ...
            <li>/</li>
            <li><g:message code="menu.ldap.users"/></li>    
        </ul>
    </div>
</div>
...
<!--                    <button type="button" data-dojo-type= "dijit.form.Button" class="cancelbtn" onclick="ListFlavors.conformPull()" id="pullPlanButton">
                    ...
                    <button class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="ListAppUsers.populateValues()">
...
<div data-dojo-type="dijit.Dialog" id="pullPlanConform" class="span4">
    ...
    <div class="row-fluid">
        <button  type="button" class="primarybtn" data-dojo-type="dijit.form.Button" onclick="ListAppUsers.pullPlan()"><g:message code="common.ok"/></button>
