    ...
    <div class="span12" id="">
        ...
        <!--             <div class="control-group span4 horizontalcontent">
                       ...
                       <span id="regionNameLabel" class="hide_lable"></span>
                        ...
                        <div class="control-group span4 horizontalcontent" id="flavorDecsDiv">
                    ...
                    <div class="row-fluid">     
                        ...
                        <div id="currentFlavorZoneInfo" class="row-fluid">
                ...
                <div class="row-fluid" style="margin-top: 10px">
                    ...
                    <div class="span3">
                        ...
                        <div id="flavorCancelButtonDiv" class="span4 pull-right">
                            <button id="flavorCancelButton"  data-dojo-type="dijit.form.Button" onclick="AddFlavorInfo.cancel()" class="cancelbtn">
                                <g:message code="common.cancel"/>
                            </button>
                        </div>
                        <div id="flavorAddButtonDiv" class="span3 pull-right" style="display: block;" >
                        ...
                        <div id="flavorUpdateButtonDiv" style="display: none;" class="span4 pull-right">
