                ...
                <div class="row-fluid">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span3">
                            ...
                            <div id="subnetNetworkCancelButtonDiv" class="span4 pull-right">
                                <button id="subnetNetworkCancelButton"  data-dojo-type="dijit.form.Button" onclick="SubnetInfo.cancel()" class="cancelbtn">
                                    <g:message code="common.cancel"/>
                                </button>
                            </div>
                            <div id="subnetNetworkAddButtonDiv" class="span2 pull-right" style="display: block;" >
                            ...
                            <div id="subnetNetworkUpdateButtonDiv" style="display: none;" class="span3 pull-right">
...
<div data-dojo-type="dijit.Dialog" class="customDialgue span6" id="pullSubnetLoader">
    <div class="row-fluid">
