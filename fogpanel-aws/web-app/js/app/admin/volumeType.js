...
//            if(data[0] === "OK") {
//                dojo.byId("openStackNotConfiguredMsgVolumeType").style.display = "inline";
//                dijit.byId("pullImageButtonVolumeType").set("disabled", true);
//            } else if(data[0] === "FALSE") {
//                dojo.byId("openStackNotConfiguredMsgVolumeType").style.display = "none";
//                dijit.byId("pullImageButtonVolumeType").set("disabled", false);
//            }
//        });   
...
//                        return editTag;
                ...
                {
                    'name': translator.common.sizeMin + " (GB)", 'field': 'minSize', 'width': '10%', 'datatype':'string',  'autoComplete': 'true'
                },
                {
                    'name': translator.common.sizeMax + " (GB)", 'field': 'maxSize', 'width': '10%', 'datatype':'string',  'autoComplete': 'true'
                },
                {
                    'name': translator.common.iopsMin, 'field': 'minIops', 'width': '10%', 'datatype':'string',  'autoComplete': 'true'
                },
                {
                    'name': translator.common.iopsMax, 'field': 'maxIops', 'width': '10%', 'datatype':'string',  'autoComplete': 'true'
                },
    ...
    //                    dojo.byId("adminDisabledFlavor").innerHTML = 0;
                        ...
                        dojo.byId("adminTotalVolumeType").innerHTML = data.length
                        dojo.byId("noVolumeTypeMessageBox").style.display = "none";
                        dojo.forEach(data, function(resultData) {                 
                            dataList.newItem({                                
                                name:resultData.name,
                                minSize:resultData.sizeMin,                                
                                maxSize:resultData.sizeMax,                                
                                minIops:(resultData.iopsMin) == null ? "N/A" : resultData.iopsMin,                                
                                maxIops:(resultData.iopsMax) == null ? "N/A" : resultData.iopsMax,                                
                                action: resultData
                            });
                        });                                    
                        dojo.byId("adminVolumeTypeList").innerHTML = "";
                    ...
                    dojo.byId("adminVolumeTypeList").innerHTML = "";
                    dojo.byId("errorId").innerHTML = status
                }); 
            }
    };
