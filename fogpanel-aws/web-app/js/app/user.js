...
var Dashboard = {
    ...
    _snapCountRestStore: "",
    _getAccountDetailsStore: "",
    _setupVerificationRestStore: "",
    _virtualMachineCount : "",
    init: function(currentRegionId) {     
        
        if(!currentRegionId) {
            currentRegionId = dojo.byId("selectedRegionID").value ? dojo.byId("selectedRegionID").value : null;
        }
        
        this._getAccountDetailsStore = new JsonRest({
            target: core.getContextPath()+"/api/account/details"
        });
        
        var currentAccountStore = new JsonRest({
               target:core.getContextPath()+"/api/account/getRegion"
        })
        
        currentAccountStore.query({id:currentRegionId}).then(function(data){
            
            dojo.forEach(data,function(resultData){
                dojo.byId("vmCount").innerHTML = resultData.instances
                dojo.byId("vpcCount").innerHTML = resultData.vpcs
                dojo.byId("subnetCount").innerHTML = resultData.subnets
                dojo.byId("securityGroupCount").innerHTML = resultData.securityGroups
                dojo.byId("imagesCount").innerHTML = resultData.images
                dojo.byId("internetGatewayCount").innerHTML = resultData.internetGateways
            })
        })
...
//        dojo.byId("projectInfoDiv").innerHTML = ""
        this._getAccountDetailsStore.query().then(function(data){
            dojo.forEach(data,function(user){
                dojo.byId("currentUserName").innerHTML = user.name
                dojo.byId("projectName").innerHTML = user.awsUserName
                dojo.byId("projectOwnerName").innerHTML = user.awsUserName
                dojo.byId("billingOwnerName").innerHTML = user.awsUserName
            })
        })
...
//        
//        var i = 1;
//        this._virtualMachineCount.query().then(function(data) {
//
//            TODO://Total (Temporary) VM limit
//            var vmLimit = 10;
//            //variables of stopped instances pie-chart
//            var stoppedVmCount = 0;
//            var balancedStoppedCount = 0;
//            //variables of running instances pie-chart
//            var runningVmCount = 0;
//            var balancedRunningCount = 0;
//            //variables of total instances pie-chart
//            var totalVMCount = 0;
//            var balancedTotalCount = 0;
//            
//            dojo.forEach(data, function(el) {
//                if (el.status === "SHUTOFF") {
//                    stoppedVmCount++;
//                }
//                if (el.status === "ACTIVE") {
//                    runningVmCount++;
...
//            })
//
//            totalVMCount = data.length;
//            balancedTotalCount = vmLimit - totalVMCount;
//
//            if (stoppedVmCount !== 0) {
//                balancedStoppedCount = vmLimit - stoppedVmCount;
//            }
//
//            if (runningVmCount !== 0) {
//                balancedRunningCount = vmLimit - runningVmCount;
//            }
//            
//            var runningChartData = [{
//                    y: runningVmCount,
//                    fill: "#00FF00"
//                }, {
//                    y: balancedRunningCount,
//                    fill: "white"
//                }, ];
//            var runningPieChart = new Chart("pieChart1");
//            runningPieChart.setTheme(theme).addPlot("default", {
//                type: "Pie",
...
//                htmlLabels: false,
//                startAngle: -90,
//            }).addSeries("Major", runningChartData);
//            var runningChart = new dojox.charting.action2d.MoveSlice(runningPieChart, "default");
//            runningPieChart.render();
//            
//            var stoppedChartData = [{
//                    y: stoppedVmCount,
//                    fill: "#FF4500"
//                }, {
//                    y: balancedStoppedCount,
//                    fill: "white"
//                }, ];
//            var stoppedPieChart = new Chart("pieChart2");
//            stoppedPieChart.setTheme(theme).addPlot("default", {
//                type: "Pie",
//                font: "normal normal 10pt Tahoma",
//                fontColor: "#1c3923",
//                labelWiring: "#1c3923",
...
//                htmlLabels: false,
//                startAngle: -90,
//            }).addSeries("Major", stoppedChartData);
//            var stoppedChart = new dojox.charting.action2d.MoveSlice(stoppedPieChart, "default");
//            stoppedPieChart.render();
//                        
//            var totalChartData = [{
//                    y: totalVMCount,
//                    fill: "#1E90FF"
//                }, {
//                    y: balancedTotalCount,
//                    fill: "white"
//                }, ];
//            var totalPieChart = new Chart("pieChart3");
//            totalPieChart.setTheme(theme).addPlot("default", {
//                type: "Pie",
//                font: "normal normal 10pt Tahoma",
//                fontColor: "#1c3923",
//                labelWiring: "#1c3923",
...
//                htmlLabels: false,
//                startAngle: -90,
//            }).addSeries("Major", totalChartData);
//            var totalChart = new dojox.charting.action2d.MoveSlice(totalPieChart, "default");
//            totalPieChart.render();
//
//            //set running instance count
//            var runningCountSpan = dojo.byId("runningInstanceSpan");
//            if(runningCountSpan) {
//                runningCountSpan.innerHTML = runningVmCount;
//                if(runningVmCount === 0) {
////                    dojo.byId("noRunningInstanceSpan").innerHTML = "No Running Instances"
//                    dojo.byId("noRunningInstanceSpan").style.display = "block";
//                }
//            }            
//            //set stopped instance count
//            var stoppedCountSpan = dojo.byId("stoppedInstanceSpan");
//            if(stoppedCountSpan) {
//                stoppedCountSpan.innerHTML = stoppedVmCount;
//                if(stoppedVmCount === 0) {
////                    dojo.byId("noStoppedInstanceSpan").innerHTML = "No Stopped Instances"
//                    dojo.byId("noStoppedInstanceSpan").style.display = "block";
//                }
//            }            
//            //set total instance count
//            var totalCountSpan = dojo.byId("totalInstanceSpan");
//            if(totalCountSpan) {
//                totalCountSpan.innerHTML = totalVMCount;
//            }
//            
//        });
//        
...
var RegionConfigForMenu = {
    init : function () {      
    },    
    populateServiceMenu : function () {  
        ...
        dojo.forEach(serviceMenuList, function (el) {
            ...
            if(el.id == "serviceMenuIPManager" || el.id == "serviceMenuPortForwarding" || el.id == "serviceMenuSSHKey"
                    || el.id == "serviceMenuFirewall"|| el.id == "serviceMenuLoadBalancer" || el.id == "serviceMenuVPN" 
                    || el.id === "serviceMenuEC2" || el.id === "serviceMenuVPC") {               
                    ...
                    dojo.byId("serviceMenuEC2").href = " #/user/ec2/dashboard";                                                                                       
    ...
    populateValue : function () {             
        ...
        dojo.query("#userRegionList .item").forEach(dojo.destroy); 
        ...
        setTimeout(function () {RegionConfigForMenu.populateServiceMenu();},1000);
        ...
        regionListStore.query().then(function(data) {                             
            ...
            if(data === "undefined" || data.length === 0 || data === "" || data === undefined) {
                ...
                dojo.query("#userRegionList .item").forEach(dojo.destroy); 
                //first region
                var regionId = data[0].id;
                var regionName = data[0].aliasName;
                
                dojo.forEach(data, function(el) {    
                    if(currentRegionId && currentRegionId == el.id) {
                        regionId = el.id;
                        regionName = el.aliasName;
                    }
                    regionSelectorWidget = new FogPanel.ZoneSelector({                        
                        ...
                        onZoneItemClick : function () {                            
                            ...
                            RegionConfigForMenu.loadInfoBasedOnRegion();                            
                        },
                        additionalProperties : {
                            zoneId: el.id,
                            networkType : el.aliasName,
                            name : el.aliasName
                        }                        
                ...
                dojo.byId("selectedRegionID").value = regionId;
                dojo.byId("currentRegionName").innerHTML = regionName;
            }                                                                                                                     
        });
        ...
        if(currentUrl ===  "#/user/vpc/dashboard" || currentUrl ===  "#/user/vpc" || currentUrl === "#/user/vpc/help" || currentUrl === "#/user/vpc/topology" || currentUrl ===  "#/user/vpc/vpcContainer" || currentUrl === "#/user/vpc/list" || currentUrl ===  "#/user/vpc/vpcContainer" || currentUrl ===  "#/user/tier/list" || currentUrl ===  "#/user/tier/instance" || currentUrl ===  "#/user/tier/publicLB" ||currentUrl  ===   "#/user/tier/internalLB" ||
            ...
            VPCMenuInfo.populateVPCMenus(currentVPC);    
            
        } 
//        else if (currentUrl === "#/user/server" || currentUrl === "#/user/image/list" || currentUrl === "#/user/volume/list" || currentUrl === "#/user/cloud/sshKey" || currentUrl === "#/user/snapshot/list" || currentUrl === "#/user/securityGroup/list"
//                || currentUrl === "#/user/server/add" || currentUrl === "#/user/server/list"){
//            
...
//        }
            ...
            var VerticalMenuBar = new FogPanel.VerticalMenuBar({
                ...
                onServiceMenuItemClick : function () {
                    RegionConfigForMenu.showServiceMenuItems(this)               
                },
                onOtherMenuItemClick : function () {
                    RegionConfigForMenu.hideToolTip();
                }
    ...
    loadInfoBasedOnRegion : function () {      
       ...
       if(currentUrl ===  "#/user/vpc/dashboard" || currentUrl ===  "#/user/vpc" || currentUrl === "#/user/vpc/help" || currentUrl === "#/user/vpc/topology" || currentUrl ===  "#/user/vpc/vpcContainer" || currentUrl === "#/user/vpc/list" || currentUrl ===  "#/user/vpc/vpcContainer" || currentUrl ===  "#/user/tier/list" || currentUrl ===  "#/user/tier/instance" || currentUrl ===  "#/user/tier/publicLB" ||currentUrl  ===   "#/user/tier/internalLB" ||
            ...
            var currentRegionId = dojo.byId("selectedRegionID").value ? dojo.byId("selectedRegionID").value : null;
            VPCMenuInfo.populateVPCStatInfo(currentRegionId)
            
        } 
        
        
//        else if (currentUrl === "#/user/ec2/dashboard" ||  currentUrl === "#/user/server" || currentUrl === "#/user/image/list" || currentUrl === "#/user/volume/list" || currentUrl === "#/user/cloud/sshKey" || currentUrl === "#/user/snapshot/list" 
//                || currentUrl === "#/user/securityGroup/list" || currentUrl === "#/user/server/add" || currentUrl === "#/user/server/list" || (urlList[2] === "server" && urlList[3] === "viewServer" && urlList[4]) || (urlList[2] === "server" && urlList[3] === "viewServer" && urlList[4])){
//            
//            core.router.go("#/user/home");
//        } 
        else if(currentUrl === "#/user/home") {
            var currentRegionId = dojo.byId("selectedRegionID").value ? dojo.byId("selectedRegionID").value : null;
            Dashboard.init(currentRegionId)
        }else {
            core.router.go("#/user/home");
        }
    }
...
window.RegionConfigForMenu = RegionConfigForMenu;
