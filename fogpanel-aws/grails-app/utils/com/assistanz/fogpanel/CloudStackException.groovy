 ...
 * @author nandhini
 */
class CloudStackException extends FogPanelException {
    ...
    protected CloudStackException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
