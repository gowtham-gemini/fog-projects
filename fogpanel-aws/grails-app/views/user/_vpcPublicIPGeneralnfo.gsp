...
<div class="row-fluid filter-block">
    <div class="row-fluid">
        <div class="alert alert-danger" style="display: none;" id="vpcIPListRachedLimitMsg"><i class="icon-exclamation-sign"></i><g:message code="common.reachedLimit"/></div> 
    </div>
    <div class="pull-right" id="publicIPListActionButtonCollection">
        ...
        <a class="btn-flat success new-product" id="vpcAddIPButton" onclick="ListAllPublicIPInfo.acquireIPShow()"><g:message code="common.acquireIP"/></a>          
    </div>
