...
<html lang="${lang}">
    ...
    <body class="fog-classic">
      ...
      <div class="navbar navbar-inverse">
        ...
        <div data-dojo-type="dijit.form.DropDownButton" data-dojo-props="showLabel:true" class="notification-dropdown hidden-phone dashboardContent" title="<g:message code="common.regionInfo"/>">            
              <a href="#" class="trigger">   
        ...
        <div class="row-fluid">                        
            <div class="span12">
                ...
                <div class="srv-sub-menu">
                    <ul>
                        <li id="compute-network"><g:message code="common.network"/>
                            <div class="srv-sub-menu-sub" id="compute-network-sub">
                                <div class="cont-pointer"></div>
                                <ul>
                                    <li style="display: none">
                                        <div class="srv-submenu-title-ec2"></div><a id="serviceMenuEC2"><h4><g:message code="menu.user.services.ec2"/></h4></a>
                                        <p><g:message code="common.ec2.desc"/></p>
                                    </li>
                                   <li style="display: none">
                                    ...
                                    <li>
                                        <div class="srv-submenu-title-vpc"></div><a id="serviceMenuVPC" onclick=""><h4><g:message code="menu.user.services.vpc"/></h4></a>
                       ...
                       <li id="cdn-service" style="display: none"><g:message code="common.cdnService"/>
                        ...
                        <li id="netscalar" style="display: none"><g:message code="common.netscalar"/>
                        ...
                        <li id="other-service" style="display: none">
