   ...
   <div class="row-fluid accquireip-form-boxcont" style="margin-top: 5px;">
    ...
    <div class="row-fluid">                
        <div class="row-fluid accquireip-form-boxcont" style="margin-top: 5px;">
            <div class="span12">
                <div class="span8" style="padding: 16px;">
                    <b><g:message code="common.import.vpc"/></b>
                </div>
                    <div class="span2 pull-right" style="margin-top: 10px;">
                        <button type="button" data-dojo-type= "dijit.form.Button" id="pullVpcButton" class="cancelbtn" onclick="ImportDataFromAws.ConfirmPullVpc()" id="">
                                <g:message code="common.import"/>
                        ...
                        <button type="button" data-dojo-type= "dijit.form.Button" class="cancelbtn" onclick="ImportDataFromAws.checkDataImportVpcStatus()">
                            <g:message code="common.check"/>
                        </button>
                </div>
            </div> 
    ...
    <div data-dojo-type="dijit.Dialog" id="pullVpcConfirm" class="span4" style="display:none;">
        <div class="row-fluid">
            <!--<div class="span2"><img src='images/popup-icons/ip_icon.png'/></div>-->
            <div class="span10">
                <div class="span12"><p><g:message code='common.aws.pullVpcMessage' /></p></div>
                <div class="span12"><p class="alert alert-info"><g:message code='common.aws.pullVpcMessageNote' /></p></div>
            </div>                                    
        </div>
        <div class="row-fluid">
            <button  type="button" class="primarybtn" data-dojo-type="dijit.form.Button" onclick="ImportDataFromAws.pullVpc()"><g:message code="common.ok"/></button>
            <button  type="button" class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="ImportDataFromAws.cancelPullVpc()"><g:message code="common.cancel"/></button>
        </div>
    </div> 
<!--    <button type="button" data-dojo-type= "dijit.form.Button" class="cancelbtn" onclick="ImportDataFromAws.importInstance()">
                            <g:message code="common.check"/>
                        </button>-->
</div>
