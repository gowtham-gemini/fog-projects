...
<!--                    <button type="button" data-dojo-type= "dijit.form.Button" id="pullImageButton" class="cancelbtn" onclick="ListImages.confirmPull()" id="">
                    ...
                    <button class="cancelbtn" data-dojo-type="dijit.form.Button" onclick="ListImages.populateValues();ListImages.count()">
            ...
            <div class="row-fluid">
                ...
                <div class="alert alert-info hide text_gray" id="noImagesMessageBox" style="display: none">
                    ...
                    <g:message code="common.admin.noImages"/><a href="#/admin/settings/importData"> Click here to Pull Images from AWS</a>
                </div>
            </div>
        </div>
    </form>
