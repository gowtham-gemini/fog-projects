...
class SecurityGroupResource {
    ...
    def listSecurityGroup(@QueryParam("currentRegionId") String currentRegionId) {
        
        securityGroupService.listSecurityGroup(currentRegionId) as JSON
    }
    ...
    @Path("/list")
    @Produces(MediaType.APPLICATION_JSON)
    String getSecurityGroupList(@QueryParam("currentRegionId") String currentRegionId, 
                         @QueryParam("vpcId") String vpcId) {
        try {
           securityGroupService.getSecurityGroupListByRegionAndVPC(currentRegionId, vpcId) as JSON
        } catch (Exception ex) {
            [ex] as JSON
        }
